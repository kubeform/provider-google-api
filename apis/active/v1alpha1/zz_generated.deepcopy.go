...
func (in *DirectoryDomainSpec) DeepCopyInto(out *DirectoryDomainSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(DirectoryDomainSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DirectoryDomainSpecResource) DeepCopyInto(out *DirectoryDomainSpecResource) {
	*out = *in
	if in.Timeouts != nil {
...
func (in *DirectoryDomainSpecResource) DeepCopy() *DirectoryDomainSpecResource {
	if in == nil {
		return nil
	}
	out := new(DirectoryDomainSpecResource)
...
func (in *DirectoryDomainTrustSpec) DeepCopyInto(out *DirectoryDomainTrustSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DirectoryDomainTrustSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DirectoryDomainTrustSpecResource) DeepCopyInto(out *DirectoryDomainTrustSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *DirectoryDomainTrustSpecResource) DeepCopy() *DirectoryDomainTrustSpecResource {
	if in == nil {
		return nil
	}
	out := new(DirectoryDomainTrustSpecResource)
