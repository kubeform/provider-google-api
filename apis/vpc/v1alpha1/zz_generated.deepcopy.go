...
func (in *AccessConnectorSpec) DeepCopyInto(out *AccessConnectorSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(AccessConnectorSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AccessConnectorSpecResource) DeepCopyInto(out *AccessConnectorSpecResource) {
	*out = *in
	if in.Timeouts != nil {
...
func (in *AccessConnectorSpecResource) DeepCopy() *AccessConnectorSpecResource {
	if in == nil {
		return nil
	}
	out := new(AccessConnectorSpecResource)
