...
func (in *AccountIamBindingSpec) DeepCopyInto(out *AccountIamBindingSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(AccountIamBindingSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *AccountIamMemberSpec) DeepCopyInto(out *AccountIamMemberSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(AccountIamMemberSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *AccountIamPolicySpec) DeepCopyInto(out *AccountIamPolicySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(AccountIamPolicySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *AccountKeySpec) DeepCopyInto(out *AccountKeySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(AccountKeySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *NetworkingConnectionSpec) DeepCopyInto(out *NetworkingConnectionSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(NetworkingConnectionSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
