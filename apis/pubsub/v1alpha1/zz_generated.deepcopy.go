...
func (in *LiteSubscriptionSpec) DeepCopyInto(out *LiteSubscriptionSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(LiteSubscriptionSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *SubscriptionIamBindingSpec) DeepCopyInto(out *SubscriptionIamBindingSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(SubscriptionIamBindingSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *SubscriptionIamMemberSpec) DeepCopyInto(out *SubscriptionIamMemberSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(SubscriptionIamMemberSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *SubscriptionIamPolicySpec) DeepCopyInto(out *SubscriptionIamPolicySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(SubscriptionIamPolicySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *TopicIamBindingSpec) DeepCopyInto(out *TopicIamBindingSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(TopicIamBindingSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *TopicIamMemberSpec) DeepCopyInto(out *TopicIamMemberSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(TopicIamMemberSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *TopicIamPolicySpec) DeepCopyInto(out *TopicIamPolicySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(TopicIamPolicySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *TopicSpecResource) DeepCopyInto(out *TopicSpecResource) {
	*out = *in
	...
	if in.SchemaSettings != nil {
		...
		*out = new(TopicSpecSchemaSettings)
		(*in).DeepCopyInto(*out)
	}
	return
}
