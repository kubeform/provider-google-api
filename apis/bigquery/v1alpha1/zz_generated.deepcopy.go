...
func (in *DataTransferConfigSpec) DeepCopyInto(out *DataTransferConfigSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(DataTransferConfigSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataTransferConfigSpecResource) DeepCopyInto(out *DataTransferConfigSpecResource) {
	*out = *in
	if in.Timeouts != nil {
...
func (in *DataTransferConfigSpecResource) DeepCopy() *DataTransferConfigSpecResource {
	if in == nil {
		return nil
	}
	out := new(DataTransferConfigSpecResource)
...
func (in *DatasetAccessSpec) DeepCopyInto(out *DatasetAccessSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DatasetAccessSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatasetAccessSpecResource) DeepCopyInto(out *DatasetAccessSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *DatasetAccessSpecResource) DeepCopy() *DatasetAccessSpecResource {
	if in == nil {
		return nil
	}
	out := new(DatasetAccessSpecResource)
