...
func (in *ServicesGameServerClusterSpec) DeepCopyInto(out *ServicesGameServerClusterSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(ServicesGameServerClusterSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *ServicesGameServerConfigSpec) DeepCopyInto(out *ServicesGameServerConfigSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ServicesGameServerConfigSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *ServicesGameServerDeploymentRolloutSpec) DeepCopyInto(out *ServicesGameServerDeploymentRolloutSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ServicesGameServerDeploymentRolloutSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *ServicesGameServerDeploymentSpec) DeepCopyInto(out *ServicesGameServerDeploymentSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ServicesGameServerDeploymentSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *ServicesRealmSpec) DeepCopyInto(out *ServicesRealmSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ServicesRealmSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
