	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ComputeV1alpha1().Autoscalers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ComputeV1alpha1().Autoscalers(namespace).Watch(context.TODO(), options)
			},
		},
		&computev1alpha1.Autoscaler{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *autoscalerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&computev1alpha1.Autoscaler{}, f.defaultInformer)
}

func (f *autoscalerInformer) Lister() v1alpha1.AutoscalerLister {
	return v1alpha1.NewAutoscalerLister(f.Informer().GetIndexer())
}
