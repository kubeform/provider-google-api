	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ComputeV1alpha1().ServiceAttachments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ComputeV1alpha1().ServiceAttachments(namespace).Watch(context.TODO(), options)
			},
		},
		&computev1alpha1.ServiceAttachment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceAttachmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&computev1alpha1.ServiceAttachment{}, f.defaultInformer)
}
