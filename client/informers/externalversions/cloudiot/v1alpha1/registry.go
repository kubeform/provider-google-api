...
import (
	...
	v1alpha1 "kubeform.dev/provider-google-api/client/listers/cloudiot/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudiotV1alpha1().Registries(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudiotV1alpha1().Registries(namespace).Watch(context.TODO(), options)
			},
		},
		&cloudiotv1alpha1.Registry{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *registryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudiotv1alpha1.Registry{}, f.defaultInformer)
}
