	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NotebooksV1alpha1().Locations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NotebooksV1alpha1().Locations(namespace).Watch(context.TODO(), options)
			},
		},
		&notebooksv1alpha1.Location{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *locationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&notebooksv1alpha1.Location{}, f.defaultInformer)
}
