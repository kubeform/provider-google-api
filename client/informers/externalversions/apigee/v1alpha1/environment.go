	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApigeeV1alpha1().Environments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApigeeV1alpha1().Environments(namespace).Watch(context.TODO(), options)
			},
		},
		&apigeev1alpha1.Environment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *environmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apigeev1alpha1.Environment{}, f.defaultInformer)
}
