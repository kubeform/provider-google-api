...
import (
	...
	v1alpha1 "kubeform.dev/provider-google-api/client/listers/datastore/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DatastoreV1alpha1().Indexes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatastoreV1alpha1().Indexes(namespace).Watch(context.TODO(), options)
			},
		},
		&datastorev1alpha1.Index{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *indexInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&datastorev1alpha1.Index{}, f.defaultInformer)
}
