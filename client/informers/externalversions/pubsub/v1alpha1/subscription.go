	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PubsubV1alpha1().Subscriptions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PubsubV1alpha1().Subscriptions(namespace).Watch(context.TODO(), options)
			},
		},
		&pubsubv1alpha1.Subscription{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *subscriptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pubsubv1alpha1.Subscription{}, f.defaultInformer)
}
