	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppengineV1alpha1().DomainMappings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppengineV1alpha1().DomainMappings(namespace).Watch(context.TODO(), options)
			},
		},
		&appenginev1alpha1.DomainMapping{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *domainMappingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appenginev1alpha1.DomainMapping{}, f.defaultInformer)
}

func (f *domainMappingInformer) Lister() v1alpha1.DomainMappingLister {
	return v1alpha1.NewDomainMappingLister(f.Informer().GetIndexer())
}
