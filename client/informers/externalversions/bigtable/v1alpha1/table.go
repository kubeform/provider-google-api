	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BigtableV1alpha1().Tables(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BigtableV1alpha1().Tables(namespace).Watch(context.TODO(), options)
			},
		},
		&bigtablev1alpha1.Table{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tableInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bigtablev1alpha1.Table{}, f.defaultInformer)
}
