...
import (
	...
	v1alpha1 "kubeform.dev/provider-google-api/client/listers/cloudbuild/v1alpha1"
...
type WorkerPoolInformer interface {
	...
	Lister() v1alpha1.WorkerPoolLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudbuildV1alpha1().WorkerPools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudbuildV1alpha1().WorkerPools(namespace).Watch(context.TODO(), options)
			},
		},
		&cloudbuildv1alpha1.WorkerPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workerPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudbuildv1alpha1.WorkerPool{}, f.defaultInformer)
}

func (f *workerPoolInformer) Lister() v1alpha1.WorkerPoolLister {
	return v1alpha1.NewWorkerPoolLister(f.Informer().GetIndexer())
}
