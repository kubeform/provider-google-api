	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BigqueryV1alpha1().Reservations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BigqueryV1alpha1().Reservations(namespace).Watch(context.TODO(), options)
			},
		},
		&bigqueryv1alpha1.Reservation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *reservationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bigqueryv1alpha1.Reservation{}, f.defaultInformer)
}
