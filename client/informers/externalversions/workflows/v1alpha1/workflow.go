...
import (
	...
	v1alpha1 "kubeform.dev/provider-google-api/client/listers/workflows/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WorkflowsV1alpha1().Workflows(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkflowsV1alpha1().Workflows(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *workflowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&workflowsv1alpha1.Workflow{}, f.defaultInformer)
}
