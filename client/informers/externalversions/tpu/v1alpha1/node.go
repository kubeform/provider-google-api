...
import (
	...
	v1alpha1 "kubeform.dev/provider-google-api/client/listers/tpu/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TpuV1alpha1().Nodes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TpuV1alpha1().Nodes(namespace).Watch(context.TODO(), options)
			},
		},
		&tpuv1alpha1.Node{},
		resyncPeriod,
...
func (f *nodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tpuv1alpha1.Node{}, f.defaultInformer)
}
