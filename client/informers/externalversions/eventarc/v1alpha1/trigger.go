...
import (
	...
	v1alpha1 "kubeform.dev/provider-google-api/client/listers/eventarc/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventarcV1alpha1().Triggers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventarcV1alpha1().Triggers(namespace).Watch(context.TODO(), options)
			},
		},
		&eventarcv1alpha1.Trigger{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *triggerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventarcv1alpha1.Trigger{}, f.defaultInformer)
}
