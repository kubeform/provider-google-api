	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FirestoreV1alpha1().Indexes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FirestoreV1alpha1().Indexes(namespace).Watch(context.TODO(), options)
			},
		},
		&firestorev1alpha1.Index{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *indexInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&firestorev1alpha1.Index{}, f.defaultInformer)
}
