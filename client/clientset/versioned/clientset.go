...
type Interface interface {
	...
	MemcacheV1alpha1() memcachev1alpha1.MemcacheV1alpha1Interface
	...
	VertexV1alpha1() vertexv1alpha1.VertexV1alpha1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	memcacheV1alpha1               *memcachev1alpha1.MemcacheV1alpha1Client
	...
	vertexV1alpha1                 *vertexv1alpha1.VertexV1alpha1Client
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	cs.memcacheV1alpha1, err = memcachev1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
	...
	cs.vertexV1alpha1, err = vertexv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	cs.memcacheV1alpha1 = memcachev1alpha1.NewForConfigOrDie(c)
	...
	cs.vertexV1alpha1 = vertexv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	...
	cs.memcacheV1alpha1 = memcachev1alpha1.New(c)
	...
	cs.vertexV1alpha1 = vertexv1alpha1.New(c)
