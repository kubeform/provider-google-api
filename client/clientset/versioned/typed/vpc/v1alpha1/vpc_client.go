...
type VpcV1alpha1Interface interface {
	...
	AccessConnectorsGetter
}

// VpcV1alpha1Client is used to interact with features provided by the vpc.google.kubeform.com group.
type VpcV1alpha1Client struct {
	restClient rest.Interface
}

func (c *VpcV1alpha1Client) AccessConnectors(namespace string) AccessConnectorInterface {
	return newAccessConnectors(c, namespace)
}
