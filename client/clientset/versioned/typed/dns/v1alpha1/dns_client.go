...
// DnsV1alpha1Client is used to interact with features provided by the dns.google.kubeform.com group.
type DnsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DnsV1alpha1Client) ManagedZones(namespace string) ManagedZoneInterface {
	return newManagedZones(c, namespace)
}

func (c *DnsV1alpha1Client) Policies(namespace string) PolicyInterface {
	return newPolicies(c, namespace)
}

func (c *DnsV1alpha1Client) RecordSets(namespace string) RecordSetInterface {
