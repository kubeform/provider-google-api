...
func newClients(c *IapV1alpha1Client, namespace string) *clients {
	return &clients{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *clients) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Client, err error) {
...
func (c *clients) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClientList, err error) {
...
func (c *clients) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clients) Create(ctx context.Context, client *v1alpha1.Client, opts v1.CreateOptions) (result *v1alpha1.Client, err error) {
	result = &v1alpha1.Client{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clients").
...
func (c *clients) Update(ctx context.Context, client *v1alpha1.Client, opts v1.UpdateOptions) (result *v1alpha1.Client, err error) {
	result = &v1alpha1.Client{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clients").
...
func (c *clients) UpdateStatus(ctx context.Context, client *v1alpha1.Client, opts v1.UpdateOptions) (result *v1alpha1.Client, err error) {
	result = &v1alpha1.Client{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clients").
...
func (c *clients) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clients) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clients) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Client, err error) {
	result = &v1alpha1.Client{}
