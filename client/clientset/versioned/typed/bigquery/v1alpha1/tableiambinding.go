...
// TableIamBindingsGetter has a method to return a TableIamBindingInterface.
...
// tableIamBindings implements TableIamBindingInterface
type tableIamBindings struct {
	client rest.Interface
	ns     string
}

// newTableIamBindings returns a TableIamBindings
func newTableIamBindings(c *BigqueryV1alpha1Client, namespace string) *tableIamBindings {
	return &tableIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *tableIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TableIamBinding, err error) {
	result = &v1alpha1.TableIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tableIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TableIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TableIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tableiambindings").
...
func (c *tableIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tableIamBindings) Create(ctx context.Context, tableIamBinding *v1alpha1.TableIamBinding, opts v1.CreateOptions) (result *v1alpha1.TableIamBinding, err error) {
	result = &v1alpha1.TableIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tableiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tableIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *tableIamBindings) Update(ctx context.Context, tableIamBinding *v1alpha1.TableIamBinding, opts v1.UpdateOptions) (result *v1alpha1.TableIamBinding, err error) {
	result = &v1alpha1.TableIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tableiambindings").
		Name(tableIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tableIamBinding).
		Do(ctx).
		Into(result)
...
func (c *tableIamBindings) UpdateStatus(ctx context.Context, tableIamBinding *v1alpha1.TableIamBinding, opts v1.UpdateOptions) (result *v1alpha1.TableIamBinding, err error) {
	result = &v1alpha1.TableIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tableiambindings").
...
func (c *tableIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tableIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tableIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TableIamBinding, err error) {
	result = &v1alpha1.TableIamBinding{}
