...
func newTables(c *BigqueryV1alpha1Client, namespace string) *tables {
	return &tables{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tables) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Table, err error) {
	result = &v1alpha1.Table{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tables").
		Name(name).
...
func (c *tables) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TableList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TableList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tables").
...
func (c *tables) Create(ctx context.Context, table *v1alpha1.Table, opts v1.CreateOptions) (result *v1alpha1.Table, err error) {
	result = &v1alpha1.Table{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tables").
...
func (c *tables) Update(ctx context.Context, table *v1alpha1.Table, opts v1.UpdateOptions) (result *v1alpha1.Table, err error) {
	result = &v1alpha1.Table{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tables").
...
func (c *tables) UpdateStatus(ctx context.Context, table *v1alpha1.Table, opts v1.UpdateOptions) (result *v1alpha1.Table, err error) {
	result = &v1alpha1.Table{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tables").
...
func (c *tables) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Table, err error) {
	result = &v1alpha1.Table{}
