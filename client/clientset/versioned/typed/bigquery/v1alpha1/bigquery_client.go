...
type BigqueryV1alpha1Interface interface {
	RESTClient() rest.Interface
	DataTransferConfigsGetter
	DatasetsGetter
	DatasetAccessesGetter
...
func (c *BigqueryV1alpha1Client) DataTransferConfigs(namespace string) DataTransferConfigInterface {
	return newDataTransferConfigs(c, namespace)
}
...
func (c *BigqueryV1alpha1Client) DatasetAccesses(namespace string) DatasetAccessInterface {
	return newDatasetAccesses(c, namespace)
}
...
func (c *BigqueryV1alpha1Client) Routines(namespace string) RoutineInterface {
	return newRoutines(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*BigqueryV1alpha1Client, error) {
	...
	return &BigqueryV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new BigqueryV1alpha1Client for the given config and
...
func New(c rest.Interface) *BigqueryV1alpha1Client {
	return &BigqueryV1alpha1Client{c}
}
