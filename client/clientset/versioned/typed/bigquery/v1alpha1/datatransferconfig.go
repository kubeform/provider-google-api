...
// DataTransferConfigsGetter has a method to return a DataTransferConfigInterface.
...
// dataTransferConfigs implements DataTransferConfigInterface
type dataTransferConfigs struct {
	client rest.Interface
	ns     string
}

// newDataTransferConfigs returns a DataTransferConfigs
func newDataTransferConfigs(c *BigqueryV1alpha1Client, namespace string) *dataTransferConfigs {
...
func (c *dataTransferConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataTransferConfig, err error) {
	result = &v1alpha1.DataTransferConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dataTransferConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataTransferConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DataTransferConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("datatransferconfigs").
...
func (c *dataTransferConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataTransferConfigs) Create(ctx context.Context, dataTransferConfig *v1alpha1.DataTransferConfig, opts v1.CreateOptions) (result *v1alpha1.DataTransferConfig, err error) {
	result = &v1alpha1.DataTransferConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datatransferconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dataTransferConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dataTransferConfigs) Update(ctx context.Context, dataTransferConfig *v1alpha1.DataTransferConfig, opts v1.UpdateOptions) (result *v1alpha1.DataTransferConfig, err error) {
	result = &v1alpha1.DataTransferConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datatransferconfigs").
		Name(dataTransferConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dataTransferConfig).
		Do(ctx).
		Into(result)
...
func (c *dataTransferConfigs) UpdateStatus(ctx context.Context, dataTransferConfig *v1alpha1.DataTransferConfig, opts v1.UpdateOptions) (result *v1alpha1.DataTransferConfig, err error) {
	result = &v1alpha1.DataTransferConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datatransferconfigs").
...
func (c *dataTransferConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataTransferConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataTransferConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataTransferConfig, err error) {
	result = &v1alpha1.DataTransferConfig{}
