...
// RedisV1alpha1Client is used to interact with features provided by the redis.google.kubeform.com group.
type RedisV1alpha1Client struct {
	restClient rest.Interface
}

func (c *RedisV1alpha1Client) Instances(namespace string) InstanceInterface {
