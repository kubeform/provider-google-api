...
// EntityTypesGetter has a method to return a EntityTypeInterface.
...
// entityTypes implements EntityTypeInterface
type entityTypes struct {
	client rest.Interface
	ns     string
}

// newEntityTypes returns a EntityTypes
func newEntityTypes(c *DialogflowV1alpha1Client, namespace string) *entityTypes {
	return &entityTypes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *entityTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EntityType, err error) {
	result = &v1alpha1.EntityType{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *entityTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EntityTypeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EntityTypeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("entitytypes").
...
func (c *entityTypes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *entityTypes) Create(ctx context.Context, entityType *v1alpha1.EntityType, opts v1.CreateOptions) (result *v1alpha1.EntityType, err error) {
	result = &v1alpha1.EntityType{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("entitytypes").
...
func (c *entityTypes) Update(ctx context.Context, entityType *v1alpha1.EntityType, opts v1.UpdateOptions) (result *v1alpha1.EntityType, err error) {
	result = &v1alpha1.EntityType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("entitytypes").
...
func (c *entityTypes) UpdateStatus(ctx context.Context, entityType *v1alpha1.EntityType, opts v1.UpdateOptions) (result *v1alpha1.EntityType, err error) {
	result = &v1alpha1.EntityType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("entitytypes").
...
func (c *entityTypes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *entityTypes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *entityTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EntityType, err error) {
	result = &v1alpha1.EntityType{}
