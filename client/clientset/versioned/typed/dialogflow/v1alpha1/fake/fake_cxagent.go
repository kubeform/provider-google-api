...
var cxagentsResource = schema.GroupVersionResource{Group: "dialogflow.google.kubeform.com", Version: "v1alpha1", Resource: "cxagents"}

var cxagentsKind = schema.GroupVersionKind{Group: "dialogflow.google.kubeform.com", Version: "v1alpha1", Kind: "CxAgent"}
...
func (c *FakeCxAgents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CxAgent, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(cxagentsResource, c.ns, name), &v1alpha1.CxAgent{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CxAgent), err
}
...
func (c *FakeCxAgents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CxAgentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(cxagentsResource, cxagentsKind, c.ns, opts), &v1alpha1.CxAgentList{})
	...
	list := &v1alpha1.CxAgentList{ListMeta: obj.(*v1alpha1.CxAgentList).ListMeta}
	for _, item := range obj.(*v1alpha1.CxAgentList).Items {
...
func (c *FakeCxAgents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(cxagentsResource, c.ns, opts))
...
func (c *FakeCxAgents) Create(ctx context.Context, cxAgent *v1alpha1.CxAgent, opts v1.CreateOptions) (result *v1alpha1.CxAgent, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(cxagentsResource, c.ns, cxAgent), &v1alpha1.CxAgent{})
...
func (c *FakeCxAgents) Update(ctx context.Context, cxAgent *v1alpha1.CxAgent, opts v1.UpdateOptions) (result *v1alpha1.CxAgent, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(cxagentsResource, c.ns, cxAgent), &v1alpha1.CxAgent{})
...
func (c *FakeCxAgents) UpdateStatus(ctx context.Context, cxAgent *v1alpha1.CxAgent, opts v1.UpdateOptions) (*v1alpha1.CxAgent, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(cxagentsResource, "status", c.ns, cxAgent), &v1alpha1.CxAgent{})
...
func (c *FakeCxAgents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(cxagentsResource, c.ns, name), &v1alpha1.CxAgent{})
...
func (c *FakeCxAgents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(cxagentsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.CxAgentList{})
	return err
}
...
func (c *FakeCxAgents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CxAgent, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(cxagentsResource, c.ns, name, pt, data, subresources...), &v1alpha1.CxAgent{})
