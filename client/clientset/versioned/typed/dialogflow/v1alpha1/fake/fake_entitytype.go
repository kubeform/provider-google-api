...
var entitytypesResource = schema.GroupVersionResource{Group: "dialogflow.google.kubeform.com", Version: "v1alpha1", Resource: "entitytypes"}

var entitytypesKind = schema.GroupVersionKind{Group: "dialogflow.google.kubeform.com", Version: "v1alpha1", Kind: "EntityType"}
...
func (c *FakeEntityTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EntityType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(entitytypesResource, c.ns, name), &v1alpha1.EntityType{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EntityType), err
}
...
func (c *FakeEntityTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EntityTypeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(entitytypesResource, entitytypesKind, c.ns, opts), &v1alpha1.EntityTypeList{})
	...
	list := &v1alpha1.EntityTypeList{ListMeta: obj.(*v1alpha1.EntityTypeList).ListMeta}
	for _, item := range obj.(*v1alpha1.EntityTypeList).Items {
...
func (c *FakeEntityTypes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(entitytypesResource, c.ns, opts))
...
func (c *FakeEntityTypes) Create(ctx context.Context, entityType *v1alpha1.EntityType, opts v1.CreateOptions) (result *v1alpha1.EntityType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(entitytypesResource, c.ns, entityType), &v1alpha1.EntityType{})
...
func (c *FakeEntityTypes) Update(ctx context.Context, entityType *v1alpha1.EntityType, opts v1.UpdateOptions) (result *v1alpha1.EntityType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(entitytypesResource, c.ns, entityType), &v1alpha1.EntityType{})
...
func (c *FakeEntityTypes) UpdateStatus(ctx context.Context, entityType *v1alpha1.EntityType, opts v1.UpdateOptions) (*v1alpha1.EntityType, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(entitytypesResource, "status", c.ns, entityType), &v1alpha1.EntityType{})
...
func (c *FakeEntityTypes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(entitytypesResource, c.ns, name), &v1alpha1.EntityType{})
...
func (c *FakeEntityTypes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(entitytypesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.EntityTypeList{})
	return err
}
...
func (c *FakeEntityTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EntityType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(entitytypesResource, c.ns, name, pt, data, subresources...), &v1alpha1.EntityType{})
