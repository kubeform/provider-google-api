...
func newAgents(c *DialogflowV1alpha1Client, namespace string) *agents {
	return &agents{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *agents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AgentList, err error) {
