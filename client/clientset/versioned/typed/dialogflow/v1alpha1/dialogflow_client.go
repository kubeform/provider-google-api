...
func NewForConfig(c *rest.Config) (*DialogflowV1alpha1Client, error) {
	...
	return &DialogflowV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DialogflowV1alpha1Client for the given config and
...
func New(c rest.Interface) *DialogflowV1alpha1Client {
	return &DialogflowV1alpha1Client{c}
}
