...
// FulfillmentsGetter has a method to return a FulfillmentInterface.
...
// fulfillments implements FulfillmentInterface
type fulfillments struct {
	client rest.Interface
	ns     string
}

// newFulfillments returns a Fulfillments
func newFulfillments(c *DialogflowV1alpha1Client, namespace string) *fulfillments {
	return &fulfillments{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *fulfillments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Fulfillment, err error) {
	result = &v1alpha1.Fulfillment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *fulfillments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FulfillmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FulfillmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("fulfillments").
...
func (c *fulfillments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *fulfillments) Create(ctx context.Context, fulfillment *v1alpha1.Fulfillment, opts v1.CreateOptions) (result *v1alpha1.Fulfillment, err error) {
	result = &v1alpha1.Fulfillment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("fulfillments").
...
func (c *fulfillments) Update(ctx context.Context, fulfillment *v1alpha1.Fulfillment, opts v1.UpdateOptions) (result *v1alpha1.Fulfillment, err error) {
	result = &v1alpha1.Fulfillment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fulfillments").
...
func (c *fulfillments) UpdateStatus(ctx context.Context, fulfillment *v1alpha1.Fulfillment, opts v1.UpdateOptions) (result *v1alpha1.Fulfillment, err error) {
	result = &v1alpha1.Fulfillment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fulfillments").
...
func (c *fulfillments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *fulfillments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *fulfillments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Fulfillment, err error) {
	result = &v1alpha1.Fulfillment{}
