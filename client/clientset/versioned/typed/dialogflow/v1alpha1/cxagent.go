...
// CxAgentsGetter has a method to return a CxAgentInterface.
...
// cxAgents implements CxAgentInterface
type cxAgents struct {
	client rest.Interface
	ns     string
}

// newCxAgents returns a CxAgents
func newCxAgents(c *DialogflowV1alpha1Client, namespace string) *cxAgents {
	return &cxAgents{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cxAgents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CxAgent, err error) {
	result = &v1alpha1.CxAgent{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cxagents").
		Name(name).
...
func (c *cxAgents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CxAgentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CxAgentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cxagents").
...
func (c *cxAgents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cxAgents) Create(ctx context.Context, cxAgent *v1alpha1.CxAgent, opts v1.CreateOptions) (result *v1alpha1.CxAgent, err error) {
	result = &v1alpha1.CxAgent{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cxagents").
...
func (c *cxAgents) Update(ctx context.Context, cxAgent *v1alpha1.CxAgent, opts v1.UpdateOptions) (result *v1alpha1.CxAgent, err error) {
	result = &v1alpha1.CxAgent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxagents").
...
func (c *cxAgents) UpdateStatus(ctx context.Context, cxAgent *v1alpha1.CxAgent, opts v1.UpdateOptions) (result *v1alpha1.CxAgent, err error) {
	result = &v1alpha1.CxAgent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxagents").
...
func (c *cxAgents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cxAgents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cxAgents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CxAgent, err error) {
	result = &v1alpha1.CxAgent{}
