...
// SubscriptionIamMembersGetter has a method to return a SubscriptionIamMemberInterface.
...
// subscriptionIamMembers implements SubscriptionIamMemberInterface
type subscriptionIamMembers struct {
	client rest.Interface
	ns     string
}

// newSubscriptionIamMembers returns a SubscriptionIamMembers
func newSubscriptionIamMembers(c *PubsubV1alpha1Client, namespace string) *subscriptionIamMembers {
	return &subscriptionIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *subscriptionIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SubscriptionIamMember, err error) {
	result = &v1alpha1.SubscriptionIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *subscriptionIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SubscriptionIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SubscriptionIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("subscriptioniammembers").
...
func (c *subscriptionIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *subscriptionIamMembers) Create(ctx context.Context, subscriptionIamMember *v1alpha1.SubscriptionIamMember, opts v1.CreateOptions) (result *v1alpha1.SubscriptionIamMember, err error) {
	result = &v1alpha1.SubscriptionIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("subscriptioniammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(subscriptionIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *subscriptionIamMembers) Update(ctx context.Context, subscriptionIamMember *v1alpha1.SubscriptionIamMember, opts v1.UpdateOptions) (result *v1alpha1.SubscriptionIamMember, err error) {
	result = &v1alpha1.SubscriptionIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subscriptioniammembers").
		Name(subscriptionIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(subscriptionIamMember).
		Do(ctx).
		Into(result)
...
func (c *subscriptionIamMembers) UpdateStatus(ctx context.Context, subscriptionIamMember *v1alpha1.SubscriptionIamMember, opts v1.UpdateOptions) (result *v1alpha1.SubscriptionIamMember, err error) {
	result = &v1alpha1.SubscriptionIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subscriptioniammembers").
...
func (c *subscriptionIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *subscriptionIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *subscriptionIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SubscriptionIamMember, err error) {
	result = &v1alpha1.SubscriptionIamMember{}
