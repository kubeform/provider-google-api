...
// TopicIamPoliciesGetter has a method to return a TopicIamPolicyInterface.
...
// topicIamPolicies implements TopicIamPolicyInterface
type topicIamPolicies struct {
	client rest.Interface
	ns     string
}

// newTopicIamPolicies returns a TopicIamPolicies
func newTopicIamPolicies(c *PubsubV1alpha1Client, namespace string) *topicIamPolicies {
	return &topicIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *topicIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TopicIamPolicy, err error) {
	result = &v1alpha1.TopicIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *topicIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TopicIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TopicIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("topiciampolicies").
...
func (c *topicIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *topicIamPolicies) Create(ctx context.Context, topicIamPolicy *v1alpha1.TopicIamPolicy, opts v1.CreateOptions) (result *v1alpha1.TopicIamPolicy, err error) {
	result = &v1alpha1.TopicIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("topiciampolicies").
...
func (c *topicIamPolicies) Update(ctx context.Context, topicIamPolicy *v1alpha1.TopicIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.TopicIamPolicy, err error) {
	result = &v1alpha1.TopicIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("topiciampolicies").
		Name(topicIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(topicIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *topicIamPolicies) UpdateStatus(ctx context.Context, topicIamPolicy *v1alpha1.TopicIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.TopicIamPolicy, err error) {
	result = &v1alpha1.TopicIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("topiciampolicies").
...
func (c *topicIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *topicIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *topicIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TopicIamPolicy, err error) {
	result = &v1alpha1.TopicIamPolicy{}
