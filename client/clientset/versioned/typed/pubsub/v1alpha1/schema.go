...
func newSchemas(c *PubsubV1alpha1Client, namespace string) *schemas {
	return &schemas{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *schemas) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Schema, err error) {
	result = &v1alpha1.Schema{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("schemas").
		Name(name).
...
func (c *schemas) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SchemaList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SchemaList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("schemas").
...
func (c *schemas) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *schemas) Create(ctx context.Context, schema *v1alpha1.Schema, opts v1.CreateOptions) (result *v1alpha1.Schema, err error) {
	result = &v1alpha1.Schema{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("schemas").
...
func (c *schemas) Update(ctx context.Context, schema *v1alpha1.Schema, opts v1.UpdateOptions) (result *v1alpha1.Schema, err error) {
	result = &v1alpha1.Schema{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("schemas").
...
func (c *schemas) UpdateStatus(ctx context.Context, schema *v1alpha1.Schema, opts v1.UpdateOptions) (result *v1alpha1.Schema, err error) {
	result = &v1alpha1.Schema{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("schemas").
...
func (c *schemas) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *schemas) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *schemas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Schema, err error) {
	result = &v1alpha1.Schema{}
