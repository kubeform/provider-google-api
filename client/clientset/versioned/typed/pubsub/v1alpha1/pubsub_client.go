...
type PubsubV1alpha1Interface interface {
	...
	SchemasGetter
	SubscriptionsGetter
	SubscriptionIamBindingsGetter
	SubscriptionIamMembersGetter
	SubscriptionIamPoliciesGetter
	TopicsGetter
	TopicIamBindingsGetter
	TopicIamMembersGetter
	TopicIamPoliciesGetter
}
