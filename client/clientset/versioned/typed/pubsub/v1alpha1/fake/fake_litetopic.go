...
var litetopicsResource = schema.GroupVersionResource{Group: "pubsub.google.kubeform.com", Version: "v1alpha1", Resource: "litetopics"}

var litetopicsKind = schema.GroupVersionKind{Group: "pubsub.google.kubeform.com", Version: "v1alpha1", Kind: "LiteTopic"}
...
func (c *FakeLiteTopics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LiteTopic, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(litetopicsResource, c.ns, name), &v1alpha1.LiteTopic{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.LiteTopic), err
}
...
func (c *FakeLiteTopics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LiteTopicList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(litetopicsResource, litetopicsKind, c.ns, opts), &v1alpha1.LiteTopicList{})
	...
	list := &v1alpha1.LiteTopicList{ListMeta: obj.(*v1alpha1.LiteTopicList).ListMeta}
	for _, item := range obj.(*v1alpha1.LiteTopicList).Items {
...
func (c *FakeLiteTopics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(litetopicsResource, c.ns, opts))
...
func (c *FakeLiteTopics) Create(ctx context.Context, liteTopic *v1alpha1.LiteTopic, opts v1.CreateOptions) (result *v1alpha1.LiteTopic, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(litetopicsResource, c.ns, liteTopic), &v1alpha1.LiteTopic{})
...
func (c *FakeLiteTopics) Update(ctx context.Context, liteTopic *v1alpha1.LiteTopic, opts v1.UpdateOptions) (result *v1alpha1.LiteTopic, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(litetopicsResource, c.ns, liteTopic), &v1alpha1.LiteTopic{})
...
func (c *FakeLiteTopics) UpdateStatus(ctx context.Context, liteTopic *v1alpha1.LiteTopic, opts v1.UpdateOptions) (*v1alpha1.LiteTopic, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(litetopicsResource, "status", c.ns, liteTopic), &v1alpha1.LiteTopic{})
...
func (c *FakeLiteTopics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(litetopicsResource, c.ns, name), &v1alpha1.LiteTopic{})
...
func (c *FakeLiteTopics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(litetopicsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.LiteTopicList{})
	return err
}
...
func (c *FakeLiteTopics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LiteTopic, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(litetopicsResource, c.ns, name, pt, data, subresources...), &v1alpha1.LiteTopic{})
