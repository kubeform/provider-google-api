...
// LiteSubscriptionsGetter has a method to return a LiteSubscriptionInterface.
...
// liteSubscriptions implements LiteSubscriptionInterface
type liteSubscriptions struct {
	client rest.Interface
	ns     string
}

// newLiteSubscriptions returns a LiteSubscriptions
func newLiteSubscriptions(c *PubsubV1alpha1Client, namespace string) *liteSubscriptions {
	return &liteSubscriptions{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *liteSubscriptions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LiteSubscription, err error) {
	result = &v1alpha1.LiteSubscription{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *liteSubscriptions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LiteSubscriptionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LiteSubscriptionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("litesubscriptions").
...
func (c *liteSubscriptions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *liteSubscriptions) Create(ctx context.Context, liteSubscription *v1alpha1.LiteSubscription, opts v1.CreateOptions) (result *v1alpha1.LiteSubscription, err error) {
	result = &v1alpha1.LiteSubscription{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("litesubscriptions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(liteSubscription).
		Do(ctx).
		Into(result)
	return
}
...
func (c *liteSubscriptions) Update(ctx context.Context, liteSubscription *v1alpha1.LiteSubscription, opts v1.UpdateOptions) (result *v1alpha1.LiteSubscription, err error) {
	result = &v1alpha1.LiteSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("litesubscriptions").
		Name(liteSubscription.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(liteSubscription).
		Do(ctx).
		Into(result)
...
func (c *liteSubscriptions) UpdateStatus(ctx context.Context, liteSubscription *v1alpha1.LiteSubscription, opts v1.UpdateOptions) (result *v1alpha1.LiteSubscription, err error) {
	result = &v1alpha1.LiteSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("litesubscriptions").
...
func (c *liteSubscriptions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *liteSubscriptions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *liteSubscriptions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LiteSubscription, err error) {
	result = &v1alpha1.LiteSubscription{}
