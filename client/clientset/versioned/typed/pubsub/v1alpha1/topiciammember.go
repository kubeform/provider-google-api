...
// TopicIamMembersGetter has a method to return a TopicIamMemberInterface.
...
// topicIamMembers implements TopicIamMemberInterface
type topicIamMembers struct {
	client rest.Interface
	ns     string
}

// newTopicIamMembers returns a TopicIamMembers
func newTopicIamMembers(c *PubsubV1alpha1Client, namespace string) *topicIamMembers {
	return &topicIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *topicIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TopicIamMember, err error) {
	result = &v1alpha1.TopicIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *topicIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TopicIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TopicIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("topiciammembers").
...
func (c *topicIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *topicIamMembers) Create(ctx context.Context, topicIamMember *v1alpha1.TopicIamMember, opts v1.CreateOptions) (result *v1alpha1.TopicIamMember, err error) {
	result = &v1alpha1.TopicIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("topiciammembers").
...
func (c *topicIamMembers) Update(ctx context.Context, topicIamMember *v1alpha1.TopicIamMember, opts v1.UpdateOptions) (result *v1alpha1.TopicIamMember, err error) {
	result = &v1alpha1.TopicIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("topiciammembers").
		Name(topicIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(topicIamMember).
		Do(ctx).
		Into(result)
...
func (c *topicIamMembers) UpdateStatus(ctx context.Context, topicIamMember *v1alpha1.TopicIamMember, opts v1.UpdateOptions) (result *v1alpha1.TopicIamMember, err error) {
	result = &v1alpha1.TopicIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("topiciammembers").
...
func (c *topicIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *topicIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *topicIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TopicIamMember, err error) {
	result = &v1alpha1.TopicIamMember{}
