...
// DatastoreV1alpha1Client is used to interact with features provided by the datastore.google.kubeform.com group.
type DatastoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DatastoreV1alpha1Client) Indexes(namespace string) IndexInterface {
