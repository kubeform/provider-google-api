...
// CatalogTagTemplateIamBindingsGetter has a method to return a CatalogTagTemplateIamBindingInterface.
...
// catalogTagTemplateIamBindings implements CatalogTagTemplateIamBindingInterface
type catalogTagTemplateIamBindings struct {
	client rest.Interface
	ns     string
}

// newCatalogTagTemplateIamBindings returns a CatalogTagTemplateIamBindings
func newCatalogTagTemplateIamBindings(c *DataV1alpha1Client, namespace string) *catalogTagTemplateIamBindings {
	return &catalogTagTemplateIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *catalogTagTemplateIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CatalogTagTemplateIamBinding, err error) {
	result = &v1alpha1.CatalogTagTemplateIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *catalogTagTemplateIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CatalogTagTemplateIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CatalogTagTemplateIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("catalogtagtemplateiambindings").
...
func (c *catalogTagTemplateIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *catalogTagTemplateIamBindings) Create(ctx context.Context, catalogTagTemplateIamBinding *v1alpha1.CatalogTagTemplateIamBinding, opts v1.CreateOptions) (result *v1alpha1.CatalogTagTemplateIamBinding, err error) {
	result = &v1alpha1.CatalogTagTemplateIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("catalogtagtemplateiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(catalogTagTemplateIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *catalogTagTemplateIamBindings) Update(ctx context.Context, catalogTagTemplateIamBinding *v1alpha1.CatalogTagTemplateIamBinding, opts v1.UpdateOptions) (result *v1alpha1.CatalogTagTemplateIamBinding, err error) {
	result = &v1alpha1.CatalogTagTemplateIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("catalogtagtemplateiambindings").
		Name(catalogTagTemplateIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(catalogTagTemplateIamBinding).
		Do(ctx).
		Into(result)
...
func (c *catalogTagTemplateIamBindings) UpdateStatus(ctx context.Context, catalogTagTemplateIamBinding *v1alpha1.CatalogTagTemplateIamBinding, opts v1.UpdateOptions) (result *v1alpha1.CatalogTagTemplateIamBinding, err error) {
	result = &v1alpha1.CatalogTagTemplateIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("catalogtagtemplateiambindings").
...
func (c *catalogTagTemplateIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *catalogTagTemplateIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *catalogTagTemplateIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CatalogTagTemplateIamBinding, err error) {
	result = &v1alpha1.CatalogTagTemplateIamBinding{}
