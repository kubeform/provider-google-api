...
// CatalogEntryGroupsGetter has a method to return a CatalogEntryGroupInterface.
...
// catalogEntryGroups implements CatalogEntryGroupInterface
type catalogEntryGroups struct {
	client rest.Interface
	ns     string
}

// newCatalogEntryGroups returns a CatalogEntryGroups
func newCatalogEntryGroups(c *DataV1alpha1Client, namespace string) *catalogEntryGroups {
	return &catalogEntryGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *catalogEntryGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CatalogEntryGroup, err error) {
	result = &v1alpha1.CatalogEntryGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *catalogEntryGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CatalogEntryGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CatalogEntryGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("catalogentrygroups").
...
func (c *catalogEntryGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *catalogEntryGroups) Create(ctx context.Context, catalogEntryGroup *v1alpha1.CatalogEntryGroup, opts v1.CreateOptions) (result *v1alpha1.CatalogEntryGroup, err error) {
	result = &v1alpha1.CatalogEntryGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("catalogentrygroups").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(catalogEntryGroup).
		Do(ctx).
		Into(result)
	return
}
...
func (c *catalogEntryGroups) Update(ctx context.Context, catalogEntryGroup *v1alpha1.CatalogEntryGroup, opts v1.UpdateOptions) (result *v1alpha1.CatalogEntryGroup, err error) {
	result = &v1alpha1.CatalogEntryGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("catalogentrygroups").
		Name(catalogEntryGroup.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(catalogEntryGroup).
		Do(ctx).
		Into(result)
...
func (c *catalogEntryGroups) UpdateStatus(ctx context.Context, catalogEntryGroup *v1alpha1.CatalogEntryGroup, opts v1.UpdateOptions) (result *v1alpha1.CatalogEntryGroup, err error) {
	result = &v1alpha1.CatalogEntryGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("catalogentrygroups").
...
func (c *catalogEntryGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *catalogEntryGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *catalogEntryGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CatalogEntryGroup, err error) {
	result = &v1alpha1.CatalogEntryGroup{}
