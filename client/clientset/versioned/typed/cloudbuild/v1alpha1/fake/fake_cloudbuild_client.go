...
import (
	v1alpha1 "kubeform.dev/provider-google-api/client/clientset/versioned/typed/cloudbuild/v1alpha1"
...
func (c *FakeCloudbuildV1alpha1) Triggers(namespace string) v1alpha1.TriggerInterface {
