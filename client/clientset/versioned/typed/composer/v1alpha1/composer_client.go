...
func NewForConfig(c *rest.Config) (*ComposerV1alpha1Client, error) {
	...
	return &ComposerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ComposerV1alpha1Client for the given config and
...
func New(c rest.Interface) *ComposerV1alpha1Client {
	return &ComposerV1alpha1Client{c}
}
