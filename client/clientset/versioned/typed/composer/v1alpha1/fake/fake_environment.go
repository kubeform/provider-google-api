...
type FakeEnvironments struct {
	Fake *FakeComposerV1alpha1
	ns   string
}

var environmentsResource = schema.GroupVersionResource{Group: "composer.google.kubeform.com", Version: "v1alpha1", Resource: "environments"}

var environmentsKind = schema.GroupVersionKind{Group: "composer.google.kubeform.com", Version: "v1alpha1", Kind: "Environment"}
