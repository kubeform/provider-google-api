...
// DatasetIamPoliciesGetter has a method to return a DatasetIamPolicyInterface.
...
// datasetIamPolicies implements DatasetIamPolicyInterface
type datasetIamPolicies struct {
	client rest.Interface
	ns     string
}

// newDatasetIamPolicies returns a DatasetIamPolicies
func newDatasetIamPolicies(c *HealthcareV1alpha1Client, namespace string) *datasetIamPolicies {
	return &datasetIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *datasetIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatasetIamPolicy, err error) {
	result = &v1alpha1.DatasetIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *datasetIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatasetIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DatasetIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("datasetiampolicies").
...
func (c *datasetIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *datasetIamPolicies) Create(ctx context.Context, datasetIamPolicy *v1alpha1.DatasetIamPolicy, opts v1.CreateOptions) (result *v1alpha1.DatasetIamPolicy, err error) {
	result = &v1alpha1.DatasetIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datasetiampolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(datasetIamPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *datasetIamPolicies) Update(ctx context.Context, datasetIamPolicy *v1alpha1.DatasetIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.DatasetIamPolicy, err error) {
	result = &v1alpha1.DatasetIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datasetiampolicies").
		Name(datasetIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(datasetIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *datasetIamPolicies) UpdateStatus(ctx context.Context, datasetIamPolicy *v1alpha1.DatasetIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.DatasetIamPolicy, err error) {
	result = &v1alpha1.DatasetIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datasetiampolicies").
...
func (c *datasetIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *datasetIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *datasetIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatasetIamPolicy, err error) {
	result = &v1alpha1.DatasetIamPolicy{}
