...
// DatasetIamMembersGetter has a method to return a DatasetIamMemberInterface.
...
// datasetIamMembers implements DatasetIamMemberInterface
type datasetIamMembers struct {
	client rest.Interface
	ns     string
}

// newDatasetIamMembers returns a DatasetIamMembers
func newDatasetIamMembers(c *HealthcareV1alpha1Client, namespace string) *datasetIamMembers {
	return &datasetIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *datasetIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatasetIamMember, err error) {
	result = &v1alpha1.DatasetIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *datasetIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatasetIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DatasetIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("datasetiammembers").
...
func (c *datasetIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *datasetIamMembers) Create(ctx context.Context, datasetIamMember *v1alpha1.DatasetIamMember, opts v1.CreateOptions) (result *v1alpha1.DatasetIamMember, err error) {
	result = &v1alpha1.DatasetIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datasetiammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(datasetIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *datasetIamMembers) Update(ctx context.Context, datasetIamMember *v1alpha1.DatasetIamMember, opts v1.UpdateOptions) (result *v1alpha1.DatasetIamMember, err error) {
	result = &v1alpha1.DatasetIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datasetiammembers").
		Name(datasetIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(datasetIamMember).
		Do(ctx).
		Into(result)
...
func (c *datasetIamMembers) UpdateStatus(ctx context.Context, datasetIamMember *v1alpha1.DatasetIamMember, opts v1.UpdateOptions) (result *v1alpha1.DatasetIamMember, err error) {
	result = &v1alpha1.DatasetIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datasetiammembers").
...
func (c *datasetIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *datasetIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *datasetIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatasetIamMember, err error) {
	result = &v1alpha1.DatasetIamMember{}
