...
// ConsentStoresGetter has a method to return a ConsentStoreInterface.
...
// consentStores implements ConsentStoreInterface
type consentStores struct {
	client rest.Interface
	ns     string
}

// newConsentStores returns a ConsentStores
func newConsentStores(c *HealthcareV1alpha1Client, namespace string) *consentStores {
...
func (c *consentStores) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ConsentStore, err error) {
	result = &v1alpha1.ConsentStore{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *consentStores) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ConsentStoreList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ConsentStoreList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("consentstores").
...
func (c *consentStores) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *consentStores) Create(ctx context.Context, consentStore *v1alpha1.ConsentStore, opts v1.CreateOptions) (result *v1alpha1.ConsentStore, err error) {
	result = &v1alpha1.ConsentStore{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("consentstores").
...
func (c *consentStores) Update(ctx context.Context, consentStore *v1alpha1.ConsentStore, opts v1.UpdateOptions) (result *v1alpha1.ConsentStore, err error) {
	result = &v1alpha1.ConsentStore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("consentstores").
		Name(consentStore.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(consentStore).
		Do(ctx).
		Into(result)
...
func (c *consentStores) UpdateStatus(ctx context.Context, consentStore *v1alpha1.ConsentStore, opts v1.UpdateOptions) (result *v1alpha1.ConsentStore, err error) {
	result = &v1alpha1.ConsentStore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("consentstores").
...
func (c *consentStores) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *consentStores) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *consentStores) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ConsentStore, err error) {
	result = &v1alpha1.ConsentStore{}
