...
func (c *CloudfunctionsfunctionV1alpha1Client) IamBindings(namespace string) IamBindingInterface {
	return newIamBindings(c, namespace)
}

func (c *CloudfunctionsfunctionV1alpha1Client) IamMembers(namespace string) IamMemberInterface {
	return newIamMembers(c, namespace)
}

func (c *CloudfunctionsfunctionV1alpha1Client) IamPolicies(namespace string) IamPolicyInterface {
	return newIamPolicies(c, namespace)
}

// NewForConfig creates a new CloudfunctionsfunctionV1alpha1Client for the given config.
func NewForConfig(c *rest.Config) (*CloudfunctionsfunctionV1alpha1Client, error) {
	config := *c
	...
	return &CloudfunctionsfunctionV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CloudfunctionsfunctionV1alpha1Client for the given config and
...
func New(c rest.Interface) *CloudfunctionsfunctionV1alpha1Client {
	return &CloudfunctionsfunctionV1alpha1Client{c}
}
...
func (c *CloudfunctionsfunctionV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
