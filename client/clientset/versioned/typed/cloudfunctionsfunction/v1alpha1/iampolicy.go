...
func newIamPolicies(c *CloudfunctionsfunctionV1alpha1Client, namespace string) *iamPolicies {
	return &iamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *iamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamPolicy, err error) {
...
func (c *iamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamPolicyList, err error) {
...
func (c *iamPolicies) Create(ctx context.Context, iamPolicy *v1alpha1.IamPolicy, opts v1.CreateOptions) (result *v1alpha1.IamPolicy, err error) {
	result = &v1alpha1.IamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iampolicies").
...
func (c *iamPolicies) Update(ctx context.Context, iamPolicy *v1alpha1.IamPolicy, opts v1.UpdateOptions) (result *v1alpha1.IamPolicy, err error) {
	result = &v1alpha1.IamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iampolicies").
...
func (c *iamPolicies) UpdateStatus(ctx context.Context, iamPolicy *v1alpha1.IamPolicy, opts v1.UpdateOptions) (result *v1alpha1.IamPolicy, err error) {
	result = &v1alpha1.IamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iampolicies").
...
func (c *iamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamPolicy, err error) {
	result = &v1alpha1.IamPolicy{}
