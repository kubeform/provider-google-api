...
// IamMembersGetter has a method to return a IamMemberInterface.
...
// iamMembers implements IamMemberInterface
type iamMembers struct {
	client rest.Interface
	ns     string
}

// newIamMembers returns a IamMembers
func newIamMembers(c *CloudfunctionsfunctionV1alpha1Client, namespace string) *iamMembers {
	return &iamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *iamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamMember, err error) {
	result = &v1alpha1.IamMember{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iammembers").
		Name(name).
...
func (c *iamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iammembers").
...
func (c *iamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamMembers) Create(ctx context.Context, iamMember *v1alpha1.IamMember, opts v1.CreateOptions) (result *v1alpha1.IamMember, err error) {
	result = &v1alpha1.IamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iammembers").
...
func (c *iamMembers) Update(ctx context.Context, iamMember *v1alpha1.IamMember, opts v1.UpdateOptions) (result *v1alpha1.IamMember, err error) {
	result = &v1alpha1.IamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iammembers").
...
func (c *iamMembers) UpdateStatus(ctx context.Context, iamMember *v1alpha1.IamMember, opts v1.UpdateOptions) (result *v1alpha1.IamMember, err error) {
	result = &v1alpha1.IamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iammembers").
...
func (c *iamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamMember, err error) {
	result = &v1alpha1.IamMember{}
