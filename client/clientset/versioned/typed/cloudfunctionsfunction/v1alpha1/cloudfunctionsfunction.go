...
func newCloudfunctionsFunctions(c *CloudfunctionsfunctionV1alpha1Client, namespace string) *cloudfunctionsFunctions {
...
func (c *cloudfunctionsFunctions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudfunctionsFunction, err error) {
...
func (c *cloudfunctionsFunctions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudfunctionsFunctionList, err error) {
...
func (c *cloudfunctionsFunctions) Create(ctx context.Context, cloudfunctionsFunction *v1alpha1.CloudfunctionsFunction, opts v1.CreateOptions) (result *v1alpha1.CloudfunctionsFunction, err error) {
	result = &v1alpha1.CloudfunctionsFunction{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudfunctionsfunctions").
...
func (c *cloudfunctionsFunctions) Update(ctx context.Context, cloudfunctionsFunction *v1alpha1.CloudfunctionsFunction, opts v1.UpdateOptions) (result *v1alpha1.CloudfunctionsFunction, err error) {
	result = &v1alpha1.CloudfunctionsFunction{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudfunctionsfunctions").
...
func (c *cloudfunctionsFunctions) UpdateStatus(ctx context.Context, cloudfunctionsFunction *v1alpha1.CloudfunctionsFunction, opts v1.UpdateOptions) (result *v1alpha1.CloudfunctionsFunction, err error) {
	result = &v1alpha1.CloudfunctionsFunction{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudfunctionsfunctions").
...
func (c *cloudfunctionsFunctions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudfunctionsFunction, err error) {
	result = &v1alpha1.CloudfunctionsFunction{}
