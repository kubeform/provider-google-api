...
// MlV1alpha1Client is used to interact with features provided by the ml.google.kubeform.com group.
type MlV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MlV1alpha1Client) EngineModels(namespace string) EngineModelInterface {
	return newEngineModels(c, namespace)
}
