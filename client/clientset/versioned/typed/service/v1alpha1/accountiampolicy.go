...
// AccountIamPoliciesGetter has a method to return a AccountIamPolicyInterface.
...
// accountIamPolicies implements AccountIamPolicyInterface
type accountIamPolicies struct {
	client rest.Interface
	ns     string
}

// newAccountIamPolicies returns a AccountIamPolicies
func newAccountIamPolicies(c *ServiceV1alpha1Client, namespace string) *accountIamPolicies {
	return &accountIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *accountIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccountIamPolicy, err error) {
	result = &v1alpha1.AccountIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accountIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccountIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccountIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accountiampolicies").
...
func (c *accountIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accountIamPolicies) Create(ctx context.Context, accountIamPolicy *v1alpha1.AccountIamPolicy, opts v1.CreateOptions) (result *v1alpha1.AccountIamPolicy, err error) {
	result = &v1alpha1.AccountIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accountiampolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountIamPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *accountIamPolicies) Update(ctx context.Context, accountIamPolicy *v1alpha1.AccountIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.AccountIamPolicy, err error) {
	result = &v1alpha1.AccountIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountiampolicies").
		Name(accountIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *accountIamPolicies) UpdateStatus(ctx context.Context, accountIamPolicy *v1alpha1.AccountIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.AccountIamPolicy, err error) {
	result = &v1alpha1.AccountIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountiampolicies").
...
func (c *accountIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accountIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accountIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccountIamPolicy, err error) {
	result = &v1alpha1.AccountIamPolicy{}
