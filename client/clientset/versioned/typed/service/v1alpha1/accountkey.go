...
// AccountKeysGetter has a method to return a AccountKeyInterface.
...
// accountKeys implements AccountKeyInterface
type accountKeys struct {
	client rest.Interface
	ns     string
}

// newAccountKeys returns a AccountKeys
func newAccountKeys(c *ServiceV1alpha1Client, namespace string) *accountKeys {
	return &accountKeys{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *accountKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccountKey, err error) {
	result = &v1alpha1.AccountKey{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accountKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccountKeyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccountKeyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accountkeys").
...
func (c *accountKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accountKeys) Create(ctx context.Context, accountKey *v1alpha1.AccountKey, opts v1.CreateOptions) (result *v1alpha1.AccountKey, err error) {
	result = &v1alpha1.AccountKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accountkeys").
...
func (c *accountKeys) Update(ctx context.Context, accountKey *v1alpha1.AccountKey, opts v1.UpdateOptions) (result *v1alpha1.AccountKey, err error) {
	result = &v1alpha1.AccountKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountkeys").
...
func (c *accountKeys) UpdateStatus(ctx context.Context, accountKey *v1alpha1.AccountKey, opts v1.UpdateOptions) (result *v1alpha1.AccountKey, err error) {
	result = &v1alpha1.AccountKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountkeys").
...
func (c *accountKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accountKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accountKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccountKey, err error) {
	result = &v1alpha1.AccountKey{}
