...
// AccountIamBindingsGetter has a method to return a AccountIamBindingInterface.
...
// accountIamBindings implements AccountIamBindingInterface
type accountIamBindings struct {
	client rest.Interface
	ns     string
}

// newAccountIamBindings returns a AccountIamBindings
func newAccountIamBindings(c *ServiceV1alpha1Client, namespace string) *accountIamBindings {
	return &accountIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *accountIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccountIamBinding, err error) {
	result = &v1alpha1.AccountIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accountIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccountIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccountIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accountiambindings").
...
func (c *accountIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accountIamBindings) Create(ctx context.Context, accountIamBinding *v1alpha1.AccountIamBinding, opts v1.CreateOptions) (result *v1alpha1.AccountIamBinding, err error) {
	result = &v1alpha1.AccountIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accountiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *accountIamBindings) Update(ctx context.Context, accountIamBinding *v1alpha1.AccountIamBinding, opts v1.UpdateOptions) (result *v1alpha1.AccountIamBinding, err error) {
	result = &v1alpha1.AccountIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountiambindings").
		Name(accountIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountIamBinding).
		Do(ctx).
		Into(result)
...
func (c *accountIamBindings) UpdateStatus(ctx context.Context, accountIamBinding *v1alpha1.AccountIamBinding, opts v1.UpdateOptions) (result *v1alpha1.AccountIamBinding, err error) {
	result = &v1alpha1.AccountIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountiambindings").
...
func (c *accountIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accountIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accountIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccountIamBinding, err error) {
	result = &v1alpha1.AccountIamBinding{}
