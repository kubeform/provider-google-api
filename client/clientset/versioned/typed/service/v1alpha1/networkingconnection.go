...
// NetworkingConnectionsGetter has a method to return a NetworkingConnectionInterface.
...
// networkingConnections implements NetworkingConnectionInterface
type networkingConnections struct {
	client rest.Interface
	ns     string
}

// newNetworkingConnections returns a NetworkingConnections
func newNetworkingConnections(c *ServiceV1alpha1Client, namespace string) *networkingConnections {
	return &networkingConnections{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *networkingConnections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkingConnection, err error) {
	result = &v1alpha1.NetworkingConnection{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkingConnections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkingConnectionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NetworkingConnectionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkingconnections").
...
func (c *networkingConnections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkingConnections) Create(ctx context.Context, networkingConnection *v1alpha1.NetworkingConnection, opts v1.CreateOptions) (result *v1alpha1.NetworkingConnection, err error) {
	result = &v1alpha1.NetworkingConnection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkingconnections").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkingConnection).
		Do(ctx).
		Into(result)
	return
}
...
func (c *networkingConnections) Update(ctx context.Context, networkingConnection *v1alpha1.NetworkingConnection, opts v1.UpdateOptions) (result *v1alpha1.NetworkingConnection, err error) {
	result = &v1alpha1.NetworkingConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkingconnections").
		Name(networkingConnection.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkingConnection).
		Do(ctx).
		Into(result)
...
func (c *networkingConnections) UpdateStatus(ctx context.Context, networkingConnection *v1alpha1.NetworkingConnection, opts v1.UpdateOptions) (result *v1alpha1.NetworkingConnection, err error) {
	result = &v1alpha1.NetworkingConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkingconnections").
...
func (c *networkingConnections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkingConnections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkingConnections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkingConnection, err error) {
	result = &v1alpha1.NetworkingConnection{}
