...
type ContainerV1alpha1Interface interface {
...
func (c *ContainerV1alpha1Client) AnalysisNotes(namespace string) AnalysisNoteInterface {
	return newAnalysisNotes(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ContainerV1alpha1Client, error) {
	...
	return &ContainerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ContainerV1alpha1Client for the given config and
...
func New(c rest.Interface) *ContainerV1alpha1Client {
	return &ContainerV1alpha1Client{c}
}
