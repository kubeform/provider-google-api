...
// TagValueIamMembersGetter has a method to return a TagValueIamMemberInterface.
...
// tagValueIamMembers implements TagValueIamMemberInterface
type tagValueIamMembers struct {
	client rest.Interface
	ns     string
}

// newTagValueIamMembers returns a TagValueIamMembers
func newTagValueIamMembers(c *TagsV1alpha1Client, namespace string) *tagValueIamMembers {
	return &tagValueIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *tagValueIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TagValueIamMember, err error) {
	result = &v1alpha1.TagValueIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tagValueIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TagValueIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TagValueIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tagvalueiammembers").
...
func (c *tagValueIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tagValueIamMembers) Create(ctx context.Context, tagValueIamMember *v1alpha1.TagValueIamMember, opts v1.CreateOptions) (result *v1alpha1.TagValueIamMember, err error) {
	result = &v1alpha1.TagValueIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tagvalueiammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tagValueIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *tagValueIamMembers) Update(ctx context.Context, tagValueIamMember *v1alpha1.TagValueIamMember, opts v1.UpdateOptions) (result *v1alpha1.TagValueIamMember, err error) {
	result = &v1alpha1.TagValueIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagvalueiammembers").
		Name(tagValueIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tagValueIamMember).
		Do(ctx).
		Into(result)
...
func (c *tagValueIamMembers) UpdateStatus(ctx context.Context, tagValueIamMember *v1alpha1.TagValueIamMember, opts v1.UpdateOptions) (result *v1alpha1.TagValueIamMember, err error) {
	result = &v1alpha1.TagValueIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagvalueiammembers").
...
func (c *tagValueIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tagValueIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tagValueIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TagValueIamMember, err error) {
	result = &v1alpha1.TagValueIamMember{}
