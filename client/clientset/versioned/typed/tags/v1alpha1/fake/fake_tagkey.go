...
var tagkeysResource = schema.GroupVersionResource{Group: "tags.google.kubeform.com", Version: "v1alpha1", Resource: "tagkeys"}

var tagkeysKind = schema.GroupVersionKind{Group: "tags.google.kubeform.com", Version: "v1alpha1", Kind: "TagKey"}
...
func (c *FakeTagKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TagKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(tagkeysResource, c.ns, name), &v1alpha1.TagKey{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TagKey), err
}
...
func (c *FakeTagKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TagKeyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(tagkeysResource, tagkeysKind, c.ns, opts), &v1alpha1.TagKeyList{})
	...
	list := &v1alpha1.TagKeyList{ListMeta: obj.(*v1alpha1.TagKeyList).ListMeta}
	for _, item := range obj.(*v1alpha1.TagKeyList).Items {
...
func (c *FakeTagKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(tagkeysResource, c.ns, opts))
...
func (c *FakeTagKeys) Create(ctx context.Context, tagKey *v1alpha1.TagKey, opts v1.CreateOptions) (result *v1alpha1.TagKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(tagkeysResource, c.ns, tagKey), &v1alpha1.TagKey{})
...
func (c *FakeTagKeys) Update(ctx context.Context, tagKey *v1alpha1.TagKey, opts v1.UpdateOptions) (result *v1alpha1.TagKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(tagkeysResource, c.ns, tagKey), &v1alpha1.TagKey{})
...
func (c *FakeTagKeys) UpdateStatus(ctx context.Context, tagKey *v1alpha1.TagKey, opts v1.UpdateOptions) (*v1alpha1.TagKey, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(tagkeysResource, "status", c.ns, tagKey), &v1alpha1.TagKey{})
...
func (c *FakeTagKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(tagkeysResource, c.ns, name), &v1alpha1.TagKey{})
...
func (c *FakeTagKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(tagkeysResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TagKeyList{})
	return err
}
...
func (c *FakeTagKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TagKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tagkeysResource, c.ns, name, pt, data, subresources...), &v1alpha1.TagKey{})
