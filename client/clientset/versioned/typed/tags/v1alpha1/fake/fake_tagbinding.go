...
var tagbindingsResource = schema.GroupVersionResource{Group: "tags.google.kubeform.com", Version: "v1alpha1", Resource: "tagbindings"}

var tagbindingsKind = schema.GroupVersionKind{Group: "tags.google.kubeform.com", Version: "v1alpha1", Kind: "TagBinding"}
...
func (c *FakeTagBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TagBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(tagbindingsResource, c.ns, name), &v1alpha1.TagBinding{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TagBinding), err
}
...
func (c *FakeTagBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TagBindingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(tagbindingsResource, tagbindingsKind, c.ns, opts), &v1alpha1.TagBindingList{})
	...
	list := &v1alpha1.TagBindingList{ListMeta: obj.(*v1alpha1.TagBindingList).ListMeta}
	for _, item := range obj.(*v1alpha1.TagBindingList).Items {
...
func (c *FakeTagBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(tagbindingsResource, c.ns, opts))
...
func (c *FakeTagBindings) Create(ctx context.Context, tagBinding *v1alpha1.TagBinding, opts v1.CreateOptions) (result *v1alpha1.TagBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(tagbindingsResource, c.ns, tagBinding), &v1alpha1.TagBinding{})
...
func (c *FakeTagBindings) Update(ctx context.Context, tagBinding *v1alpha1.TagBinding, opts v1.UpdateOptions) (result *v1alpha1.TagBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(tagbindingsResource, c.ns, tagBinding), &v1alpha1.TagBinding{})
...
func (c *FakeTagBindings) UpdateStatus(ctx context.Context, tagBinding *v1alpha1.TagBinding, opts v1.UpdateOptions) (*v1alpha1.TagBinding, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(tagbindingsResource, "status", c.ns, tagBinding), &v1alpha1.TagBinding{})
...
func (c *FakeTagBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(tagbindingsResource, c.ns, name), &v1alpha1.TagBinding{})
...
func (c *FakeTagBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(tagbindingsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TagBindingList{})
	return err
}
...
func (c *FakeTagBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TagBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tagbindingsResource, c.ns, name, pt, data, subresources...), &v1alpha1.TagBinding{})
