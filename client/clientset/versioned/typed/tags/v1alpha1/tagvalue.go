...
// TagValuesGetter has a method to return a TagValueInterface.
...
// tagValues implements TagValueInterface
type tagValues struct {
	client rest.Interface
	ns     string
}

// newTagValues returns a TagValues
func newTagValues(c *TagsV1alpha1Client, namespace string) *tagValues {
	return &tagValues{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tagValues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TagValue, err error) {
	result = &v1alpha1.TagValue{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tagvalues").
		Name(name).
...
func (c *tagValues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TagValueList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TagValueList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tagvalues").
...
func (c *tagValues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tagValues) Create(ctx context.Context, tagValue *v1alpha1.TagValue, opts v1.CreateOptions) (result *v1alpha1.TagValue, err error) {
	result = &v1alpha1.TagValue{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tagvalues").
...
func (c *tagValues) Update(ctx context.Context, tagValue *v1alpha1.TagValue, opts v1.UpdateOptions) (result *v1alpha1.TagValue, err error) {
	result = &v1alpha1.TagValue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagvalues").
...
func (c *tagValues) UpdateStatus(ctx context.Context, tagValue *v1alpha1.TagValue, opts v1.UpdateOptions) (result *v1alpha1.TagValue, err error) {
	result = &v1alpha1.TagValue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagvalues").
...
func (c *tagValues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tagValues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tagValues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TagValue, err error) {
	result = &v1alpha1.TagValue{}
