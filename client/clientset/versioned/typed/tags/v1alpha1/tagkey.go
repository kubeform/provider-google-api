...
// TagKeysGetter has a method to return a TagKeyInterface.
...
// tagKeys implements TagKeyInterface
type tagKeys struct {
	client rest.Interface
	ns     string
}

// newTagKeys returns a TagKeys
func newTagKeys(c *TagsV1alpha1Client, namespace string) *tagKeys {
	return &tagKeys{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tagKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TagKey, err error) {
	result = &v1alpha1.TagKey{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tagkeys").
		Name(name).
...
func (c *tagKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TagKeyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TagKeyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tagkeys").
...
func (c *tagKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tagKeys) Create(ctx context.Context, tagKey *v1alpha1.TagKey, opts v1.CreateOptions) (result *v1alpha1.TagKey, err error) {
	result = &v1alpha1.TagKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tagkeys").
...
func (c *tagKeys) Update(ctx context.Context, tagKey *v1alpha1.TagKey, opts v1.UpdateOptions) (result *v1alpha1.TagKey, err error) {
	result = &v1alpha1.TagKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagkeys").
...
func (c *tagKeys) UpdateStatus(ctx context.Context, tagKey *v1alpha1.TagKey, opts v1.UpdateOptions) (result *v1alpha1.TagKey, err error) {
	result = &v1alpha1.TagKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagkeys").
...
func (c *tagKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tagKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tagKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TagKey, err error) {
	result = &v1alpha1.TagKey{}
