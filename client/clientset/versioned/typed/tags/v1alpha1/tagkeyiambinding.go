...
// TagKeyIamBindingsGetter has a method to return a TagKeyIamBindingInterface.
...
// tagKeyIamBindings implements TagKeyIamBindingInterface
type tagKeyIamBindings struct {
	client rest.Interface
	ns     string
}

// newTagKeyIamBindings returns a TagKeyIamBindings
func newTagKeyIamBindings(c *TagsV1alpha1Client, namespace string) *tagKeyIamBindings {
	return &tagKeyIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *tagKeyIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TagKeyIamBinding, err error) {
	result = &v1alpha1.TagKeyIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tagKeyIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TagKeyIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TagKeyIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tagkeyiambindings").
...
func (c *tagKeyIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tagKeyIamBindings) Create(ctx context.Context, tagKeyIamBinding *v1alpha1.TagKeyIamBinding, opts v1.CreateOptions) (result *v1alpha1.TagKeyIamBinding, err error) {
	result = &v1alpha1.TagKeyIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tagkeyiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tagKeyIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *tagKeyIamBindings) Update(ctx context.Context, tagKeyIamBinding *v1alpha1.TagKeyIamBinding, opts v1.UpdateOptions) (result *v1alpha1.TagKeyIamBinding, err error) {
	result = &v1alpha1.TagKeyIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagkeyiambindings").
		Name(tagKeyIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tagKeyIamBinding).
		Do(ctx).
		Into(result)
...
func (c *tagKeyIamBindings) UpdateStatus(ctx context.Context, tagKeyIamBinding *v1alpha1.TagKeyIamBinding, opts v1.UpdateOptions) (result *v1alpha1.TagKeyIamBinding, err error) {
	result = &v1alpha1.TagKeyIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagkeyiambindings").
...
func (c *tagKeyIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tagKeyIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tagKeyIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TagKeyIamBinding, err error) {
	result = &v1alpha1.TagKeyIamBinding{}
