...
// TagValueIamBindingsGetter has a method to return a TagValueIamBindingInterface.
...
// tagValueIamBindings implements TagValueIamBindingInterface
type tagValueIamBindings struct {
	client rest.Interface
	ns     string
}

// newTagValueIamBindings returns a TagValueIamBindings
func newTagValueIamBindings(c *TagsV1alpha1Client, namespace string) *tagValueIamBindings {
	return &tagValueIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *tagValueIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TagValueIamBinding, err error) {
	result = &v1alpha1.TagValueIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tagValueIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TagValueIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TagValueIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tagvalueiambindings").
...
func (c *tagValueIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tagValueIamBindings) Create(ctx context.Context, tagValueIamBinding *v1alpha1.TagValueIamBinding, opts v1.CreateOptions) (result *v1alpha1.TagValueIamBinding, err error) {
	result = &v1alpha1.TagValueIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tagvalueiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tagValueIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *tagValueIamBindings) Update(ctx context.Context, tagValueIamBinding *v1alpha1.TagValueIamBinding, opts v1.UpdateOptions) (result *v1alpha1.TagValueIamBinding, err error) {
	result = &v1alpha1.TagValueIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagvalueiambindings").
		Name(tagValueIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tagValueIamBinding).
		Do(ctx).
		Into(result)
...
func (c *tagValueIamBindings) UpdateStatus(ctx context.Context, tagValueIamBinding *v1alpha1.TagValueIamBinding, opts v1.UpdateOptions) (result *v1alpha1.TagValueIamBinding, err error) {
	result = &v1alpha1.TagValueIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagvalueiambindings").
...
func (c *tagValueIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tagValueIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tagValueIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TagValueIamBinding, err error) {
	result = &v1alpha1.TagValueIamBinding{}
