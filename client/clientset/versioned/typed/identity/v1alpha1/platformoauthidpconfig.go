...
// PlatformOauthIdpConfigsGetter has a method to return a PlatformOauthIdpConfigInterface.
...
// platformOauthIdpConfigs implements PlatformOauthIdpConfigInterface
type platformOauthIdpConfigs struct {
	client rest.Interface
	ns     string
}

// newPlatformOauthIdpConfigs returns a PlatformOauthIdpConfigs
func newPlatformOauthIdpConfigs(c *IdentityV1alpha1Client, namespace string) *platformOauthIdpConfigs {
	return &platformOauthIdpConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *platformOauthIdpConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PlatformOauthIdpConfig, err error) {
	result = &v1alpha1.PlatformOauthIdpConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *platformOauthIdpConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PlatformOauthIdpConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PlatformOauthIdpConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("platformoauthidpconfigs").
...
func (c *platformOauthIdpConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *platformOauthIdpConfigs) Create(ctx context.Context, platformOauthIdpConfig *v1alpha1.PlatformOauthIdpConfig, opts v1.CreateOptions) (result *v1alpha1.PlatformOauthIdpConfig, err error) {
	result = &v1alpha1.PlatformOauthIdpConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("platformoauthidpconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(platformOauthIdpConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *platformOauthIdpConfigs) Update(ctx context.Context, platformOauthIdpConfig *v1alpha1.PlatformOauthIdpConfig, opts v1.UpdateOptions) (result *v1alpha1.PlatformOauthIdpConfig, err error) {
	result = &v1alpha1.PlatformOauthIdpConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("platformoauthidpconfigs").
		Name(platformOauthIdpConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(platformOauthIdpConfig).
		Do(ctx).
		Into(result)
...
func (c *platformOauthIdpConfigs) UpdateStatus(ctx context.Context, platformOauthIdpConfig *v1alpha1.PlatformOauthIdpConfig, opts v1.UpdateOptions) (result *v1alpha1.PlatformOauthIdpConfig, err error) {
	result = &v1alpha1.PlatformOauthIdpConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("platformoauthidpconfigs").
...
func (c *platformOauthIdpConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *platformOauthIdpConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *platformOauthIdpConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PlatformOauthIdpConfig, err error) {
	result = &v1alpha1.PlatformOauthIdpConfig{}
