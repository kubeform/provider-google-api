...
var platformtenantoauthidpconfigsResource = schema.GroupVersionResource{Group: "identity.google.kubeform.com", Version: "v1alpha1", Resource: "platformtenantoauthidpconfigs"}

var platformtenantoauthidpconfigsKind = schema.GroupVersionKind{Group: "identity.google.kubeform.com", Version: "v1alpha1", Kind: "PlatformTenantOauthIdpConfig"}
...
func (c *FakePlatformTenantOauthIdpConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PlatformTenantOauthIdpConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(platformtenantoauthidpconfigsResource, c.ns, name), &v1alpha1.PlatformTenantOauthIdpConfig{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.PlatformTenantOauthIdpConfig), err
}
...
func (c *FakePlatformTenantOauthIdpConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PlatformTenantOauthIdpConfigList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(platformtenantoauthidpconfigsResource, platformtenantoauthidpconfigsKind, c.ns, opts), &v1alpha1.PlatformTenantOauthIdpConfigList{})
	...
	list := &v1alpha1.PlatformTenantOauthIdpConfigList{ListMeta: obj.(*v1alpha1.PlatformTenantOauthIdpConfigList).ListMeta}
	for _, item := range obj.(*v1alpha1.PlatformTenantOauthIdpConfigList).Items {
...
func (c *FakePlatformTenantOauthIdpConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(platformtenantoauthidpconfigsResource, c.ns, opts))
...
func (c *FakePlatformTenantOauthIdpConfigs) Create(ctx context.Context, platformTenantOauthIdpConfig *v1alpha1.PlatformTenantOauthIdpConfig, opts v1.CreateOptions) (result *v1alpha1.PlatformTenantOauthIdpConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(platformtenantoauthidpconfigsResource, c.ns, platformTenantOauthIdpConfig), &v1alpha1.PlatformTenantOauthIdpConfig{})
...
func (c *FakePlatformTenantOauthIdpConfigs) Update(ctx context.Context, platformTenantOauthIdpConfig *v1alpha1.PlatformTenantOauthIdpConfig, opts v1.UpdateOptions) (result *v1alpha1.PlatformTenantOauthIdpConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(platformtenantoauthidpconfigsResource, c.ns, platformTenantOauthIdpConfig), &v1alpha1.PlatformTenantOauthIdpConfig{})
...
func (c *FakePlatformTenantOauthIdpConfigs) UpdateStatus(ctx context.Context, platformTenantOauthIdpConfig *v1alpha1.PlatformTenantOauthIdpConfig, opts v1.UpdateOptions) (*v1alpha1.PlatformTenantOauthIdpConfig, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(platformtenantoauthidpconfigsResource, "status", c.ns, platformTenantOauthIdpConfig), &v1alpha1.PlatformTenantOauthIdpConfig{})
...
func (c *FakePlatformTenantOauthIdpConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(platformtenantoauthidpconfigsResource, c.ns, name), &v1alpha1.PlatformTenantOauthIdpConfig{})
...
func (c *FakePlatformTenantOauthIdpConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(platformtenantoauthidpconfigsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.PlatformTenantOauthIdpConfigList{})
	return err
}
...
func (c *FakePlatformTenantOauthIdpConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PlatformTenantOauthIdpConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(platformtenantoauthidpconfigsResource, c.ns, name, pt, data, subresources...), &v1alpha1.PlatformTenantOauthIdpConfig{})
