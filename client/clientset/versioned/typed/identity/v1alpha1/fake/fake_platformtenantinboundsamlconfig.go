...
var platformtenantinboundsamlconfigsResource = schema.GroupVersionResource{Group: "identity.google.kubeform.com", Version: "v1alpha1", Resource: "platformtenantinboundsamlconfigs"}

var platformtenantinboundsamlconfigsKind = schema.GroupVersionKind{Group: "identity.google.kubeform.com", Version: "v1alpha1", Kind: "PlatformTenantInboundSamlConfig"}
...
func (c *FakePlatformTenantInboundSamlConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PlatformTenantInboundSamlConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(platformtenantinboundsamlconfigsResource, c.ns, name), &v1alpha1.PlatformTenantInboundSamlConfig{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.PlatformTenantInboundSamlConfig), err
}
...
func (c *FakePlatformTenantInboundSamlConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PlatformTenantInboundSamlConfigList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(platformtenantinboundsamlconfigsResource, platformtenantinboundsamlconfigsKind, c.ns, opts), &v1alpha1.PlatformTenantInboundSamlConfigList{})
	...
	list := &v1alpha1.PlatformTenantInboundSamlConfigList{ListMeta: obj.(*v1alpha1.PlatformTenantInboundSamlConfigList).ListMeta}
	for _, item := range obj.(*v1alpha1.PlatformTenantInboundSamlConfigList).Items {
...
func (c *FakePlatformTenantInboundSamlConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(platformtenantinboundsamlconfigsResource, c.ns, opts))
...
func (c *FakePlatformTenantInboundSamlConfigs) Create(ctx context.Context, platformTenantInboundSamlConfig *v1alpha1.PlatformTenantInboundSamlConfig, opts v1.CreateOptions) (result *v1alpha1.PlatformTenantInboundSamlConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(platformtenantinboundsamlconfigsResource, c.ns, platformTenantInboundSamlConfig), &v1alpha1.PlatformTenantInboundSamlConfig{})
...
func (c *FakePlatformTenantInboundSamlConfigs) Update(ctx context.Context, platformTenantInboundSamlConfig *v1alpha1.PlatformTenantInboundSamlConfig, opts v1.UpdateOptions) (result *v1alpha1.PlatformTenantInboundSamlConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(platformtenantinboundsamlconfigsResource, c.ns, platformTenantInboundSamlConfig), &v1alpha1.PlatformTenantInboundSamlConfig{})
...
func (c *FakePlatformTenantInboundSamlConfigs) UpdateStatus(ctx context.Context, platformTenantInboundSamlConfig *v1alpha1.PlatformTenantInboundSamlConfig, opts v1.UpdateOptions) (*v1alpha1.PlatformTenantInboundSamlConfig, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(platformtenantinboundsamlconfigsResource, "status", c.ns, platformTenantInboundSamlConfig), &v1alpha1.PlatformTenantInboundSamlConfig{})
...
func (c *FakePlatformTenantInboundSamlConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(platformtenantinboundsamlconfigsResource, c.ns, name), &v1alpha1.PlatformTenantInboundSamlConfig{})
...
func (c *FakePlatformTenantInboundSamlConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(platformtenantinboundsamlconfigsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.PlatformTenantInboundSamlConfigList{})
	return err
}
...
func (c *FakePlatformTenantInboundSamlConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PlatformTenantInboundSamlConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(platformtenantinboundsamlconfigsResource, c.ns, name, pt, data, subresources...), &v1alpha1.PlatformTenantInboundSamlConfig{})
