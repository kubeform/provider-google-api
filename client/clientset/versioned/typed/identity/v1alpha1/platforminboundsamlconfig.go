...
// PlatformInboundSamlConfigsGetter has a method to return a PlatformInboundSamlConfigInterface.
...
// platformInboundSamlConfigs implements PlatformInboundSamlConfigInterface
type platformInboundSamlConfigs struct {
	client rest.Interface
	ns     string
}

// newPlatformInboundSamlConfigs returns a PlatformInboundSamlConfigs
func newPlatformInboundSamlConfigs(c *IdentityV1alpha1Client, namespace string) *platformInboundSamlConfigs {
	return &platformInboundSamlConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *platformInboundSamlConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PlatformInboundSamlConfig, err error) {
	result = &v1alpha1.PlatformInboundSamlConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *platformInboundSamlConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PlatformInboundSamlConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PlatformInboundSamlConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("platforminboundsamlconfigs").
...
func (c *platformInboundSamlConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *platformInboundSamlConfigs) Create(ctx context.Context, platformInboundSamlConfig *v1alpha1.PlatformInboundSamlConfig, opts v1.CreateOptions) (result *v1alpha1.PlatformInboundSamlConfig, err error) {
	result = &v1alpha1.PlatformInboundSamlConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("platforminboundsamlconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(platformInboundSamlConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *platformInboundSamlConfigs) Update(ctx context.Context, platformInboundSamlConfig *v1alpha1.PlatformInboundSamlConfig, opts v1.UpdateOptions) (result *v1alpha1.PlatformInboundSamlConfig, err error) {
	result = &v1alpha1.PlatformInboundSamlConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("platforminboundsamlconfigs").
		Name(platformInboundSamlConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(platformInboundSamlConfig).
		Do(ctx).
		Into(result)
...
func (c *platformInboundSamlConfigs) UpdateStatus(ctx context.Context, platformInboundSamlConfig *v1alpha1.PlatformInboundSamlConfig, opts v1.UpdateOptions) (result *v1alpha1.PlatformInboundSamlConfig, err error) {
	result = &v1alpha1.PlatformInboundSamlConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("platforminboundsamlconfigs").
...
func (c *platformInboundSamlConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *platformInboundSamlConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *platformInboundSamlConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PlatformInboundSamlConfig, err error) {
	result = &v1alpha1.PlatformInboundSamlConfig{}
