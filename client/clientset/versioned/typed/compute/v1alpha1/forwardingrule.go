...
// ForwardingRulesGetter has a method to return a ForwardingRuleInterface.
...
// forwardingRules implements ForwardingRuleInterface
type forwardingRules struct {
	client rest.Interface
	ns     string
}

// newForwardingRules returns a ForwardingRules
func newForwardingRules(c *ComputeV1alpha1Client, namespace string) *forwardingRules {
...
func (c *forwardingRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ForwardingRule, err error) {
	result = &v1alpha1.ForwardingRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *forwardingRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ForwardingRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ForwardingRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("forwardingrules").
...
func (c *forwardingRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *forwardingRules) Create(ctx context.Context, forwardingRule *v1alpha1.ForwardingRule, opts v1.CreateOptions) (result *v1alpha1.ForwardingRule, err error) {
	result = &v1alpha1.ForwardingRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("forwardingrules").
...
func (c *forwardingRules) Update(ctx context.Context, forwardingRule *v1alpha1.ForwardingRule, opts v1.UpdateOptions) (result *v1alpha1.ForwardingRule, err error) {
	result = &v1alpha1.ForwardingRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("forwardingrules").
...
func (c *forwardingRules) UpdateStatus(ctx context.Context, forwardingRule *v1alpha1.ForwardingRule, opts v1.UpdateOptions) (result *v1alpha1.ForwardingRule, err error) {
	result = &v1alpha1.ForwardingRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("forwardingrules").
...
func (c *forwardingRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *forwardingRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *forwardingRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ForwardingRule, err error) {
	result = &v1alpha1.ForwardingRule{}
