...
func newNodeTemplates(c *ComputeV1alpha1Client, namespace string) *nodeTemplates {
...
func (c *nodeTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NodeTemplate, err error) {
	result = &v1alpha1.NodeTemplate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *nodeTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NodeTemplateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NodeTemplateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nodetemplates").
...
func (c *nodeTemplates) Create(ctx context.Context, nodeTemplate *v1alpha1.NodeTemplate, opts v1.CreateOptions) (result *v1alpha1.NodeTemplate, err error) {
	result = &v1alpha1.NodeTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("nodetemplates").
...
func (c *nodeTemplates) Update(ctx context.Context, nodeTemplate *v1alpha1.NodeTemplate, opts v1.UpdateOptions) (result *v1alpha1.NodeTemplate, err error) {
	result = &v1alpha1.NodeTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodetemplates").
...
func (c *nodeTemplates) UpdateStatus(ctx context.Context, nodeTemplate *v1alpha1.NodeTemplate, opts v1.UpdateOptions) (result *v1alpha1.NodeTemplate, err error) {
	result = &v1alpha1.NodeTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodetemplates").
...
func (c *nodeTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NodeTemplate, err error) {
	result = &v1alpha1.NodeTemplate{}
