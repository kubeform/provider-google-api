...
func newAddresses(c *ComputeV1alpha1Client, namespace string) *addresses {
	return &addresses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *addresses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Address, err error) {
	result = &v1alpha1.Address{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("addresses").
		Name(name).
...
func (c *addresses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AddressList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AddressList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("addresses").
...
func (c *addresses) Create(ctx context.Context, address *v1alpha1.Address, opts v1.CreateOptions) (result *v1alpha1.Address, err error) {
	result = &v1alpha1.Address{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("addresses").
...
func (c *addresses) Update(ctx context.Context, address *v1alpha1.Address, opts v1.UpdateOptions) (result *v1alpha1.Address, err error) {
	result = &v1alpha1.Address{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("addresses").
...
func (c *addresses) UpdateStatus(ctx context.Context, address *v1alpha1.Address, opts v1.UpdateOptions) (result *v1alpha1.Address, err error) {
	result = &v1alpha1.Address{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("addresses").
...
func (c *addresses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Address, err error) {
	result = &v1alpha1.Address{}
