...
// RegionAutoscalersGetter has a method to return a RegionAutoscalerInterface.
...
// regionAutoscalers implements RegionAutoscalerInterface
type regionAutoscalers struct {
	client rest.Interface
	ns     string
}

// newRegionAutoscalers returns a RegionAutoscalers
func newRegionAutoscalers(c *ComputeV1alpha1Client, namespace string) *regionAutoscalers {
...
func (c *regionAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegionAutoscaler, err error) {
	result = &v1alpha1.RegionAutoscaler{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *regionAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegionAutoscalerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RegionAutoscalerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("regionautoscalers").
...
func (c *regionAutoscalers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *regionAutoscalers) Create(ctx context.Context, regionAutoscaler *v1alpha1.RegionAutoscaler, opts v1.CreateOptions) (result *v1alpha1.RegionAutoscaler, err error) {
	result = &v1alpha1.RegionAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("regionautoscalers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionAutoscaler).
		Do(ctx).
		Into(result)
	return
}
...
func (c *regionAutoscalers) Update(ctx context.Context, regionAutoscaler *v1alpha1.RegionAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.RegionAutoscaler, err error) {
	result = &v1alpha1.RegionAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regionautoscalers").
		Name(regionAutoscaler.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionAutoscaler).
		Do(ctx).
		Into(result)
...
func (c *regionAutoscalers) UpdateStatus(ctx context.Context, regionAutoscaler *v1alpha1.RegionAutoscaler, opts v1.UpdateOptions) (result *v1alpha1.RegionAutoscaler, err error) {
	result = &v1alpha1.RegionAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regionautoscalers").
...
func (c *regionAutoscalers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *regionAutoscalers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *regionAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegionAutoscaler, err error) {
	result = &v1alpha1.RegionAutoscaler{}
