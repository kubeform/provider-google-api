...
// FirewallsGetter has a method to return a FirewallInterface.
...
// firewalls implements FirewallInterface
type firewalls struct {
	client rest.Interface
	ns     string
}

// newFirewalls returns a Firewalls
func newFirewalls(c *ComputeV1alpha1Client, namespace string) *firewalls {
	return &firewalls{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *firewalls) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Firewall, err error) {
	result = &v1alpha1.Firewall{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("firewalls").
		Name(name).
...
func (c *firewalls) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FirewallList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FirewallList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("firewalls").
...
func (c *firewalls) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *firewalls) Create(ctx context.Context, firewall *v1alpha1.Firewall, opts v1.CreateOptions) (result *v1alpha1.Firewall, err error) {
	result = &v1alpha1.Firewall{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("firewalls").
...
func (c *firewalls) Update(ctx context.Context, firewall *v1alpha1.Firewall, opts v1.UpdateOptions) (result *v1alpha1.Firewall, err error) {
	result = &v1alpha1.Firewall{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewalls").
...
func (c *firewalls) UpdateStatus(ctx context.Context, firewall *v1alpha1.Firewall, opts v1.UpdateOptions) (result *v1alpha1.Firewall, err error) {
	result = &v1alpha1.Firewall{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewalls").
...
func (c *firewalls) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *firewalls) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *firewalls) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Firewall, err error) {
	result = &v1alpha1.Firewall{}
