...
// InterconnectAttachmentsGetter has a method to return a InterconnectAttachmentInterface.
...
// interconnectAttachments implements InterconnectAttachmentInterface
type interconnectAttachments struct {
	client rest.Interface
	ns     string
}

// newInterconnectAttachments returns a InterconnectAttachments
func newInterconnectAttachments(c *ComputeV1alpha1Client, namespace string) *interconnectAttachments {
...
func (c *interconnectAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InterconnectAttachment, err error) {
	result = &v1alpha1.InterconnectAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *interconnectAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InterconnectAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InterconnectAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("interconnectattachments").
...
func (c *interconnectAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *interconnectAttachments) Create(ctx context.Context, interconnectAttachment *v1alpha1.InterconnectAttachment, opts v1.CreateOptions) (result *v1alpha1.InterconnectAttachment, err error) {
	result = &v1alpha1.InterconnectAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("interconnectattachments").
...
func (c *interconnectAttachments) Update(ctx context.Context, interconnectAttachment *v1alpha1.InterconnectAttachment, opts v1.UpdateOptions) (result *v1alpha1.InterconnectAttachment, err error) {
	result = &v1alpha1.InterconnectAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("interconnectattachments").
...
func (c *interconnectAttachments) UpdateStatus(ctx context.Context, interconnectAttachment *v1alpha1.InterconnectAttachment, opts v1.UpdateOptions) (result *v1alpha1.InterconnectAttachment, err error) {
	result = &v1alpha1.InterconnectAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("interconnectattachments").
...
func (c *interconnectAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *interconnectAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *interconnectAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InterconnectAttachment, err error) {
	result = &v1alpha1.InterconnectAttachment{}
