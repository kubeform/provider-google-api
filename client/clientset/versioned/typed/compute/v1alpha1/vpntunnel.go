...
func newVpnTunnels(c *ComputeV1alpha1Client, namespace string) *vpnTunnels {
	return &vpnTunnels{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *vpnTunnels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpnTunnel, err error) {
	result = &v1alpha1.VpnTunnel{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vpntunnels").
		Name(name).
...
func (c *vpnTunnels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpnTunnelList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VpnTunnelList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vpntunnels").
...
func (c *vpnTunnels) Create(ctx context.Context, vpnTunnel *v1alpha1.VpnTunnel, opts v1.CreateOptions) (result *v1alpha1.VpnTunnel, err error) {
	result = &v1alpha1.VpnTunnel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpntunnels").
...
func (c *vpnTunnels) Update(ctx context.Context, vpnTunnel *v1alpha1.VpnTunnel, opts v1.UpdateOptions) (result *v1alpha1.VpnTunnel, err error) {
	result = &v1alpha1.VpnTunnel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpntunnels").
...
func (c *vpnTunnels) UpdateStatus(ctx context.Context, vpnTunnel *v1alpha1.VpnTunnel, opts v1.UpdateOptions) (result *v1alpha1.VpnTunnel, err error) {
	result = &v1alpha1.VpnTunnel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpntunnels").
...
func (c *vpnTunnels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpnTunnel, err error) {
	result = &v1alpha1.VpnTunnel{}
