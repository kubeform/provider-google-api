...
// NetworkPeeringsGetter has a method to return a NetworkPeeringInterface.
...
// networkPeerings implements NetworkPeeringInterface
type networkPeerings struct {
	client rest.Interface
	ns     string
}

// newNetworkPeerings returns a NetworkPeerings
func newNetworkPeerings(c *ComputeV1alpha1Client, namespace string) *networkPeerings {
...
func (c *networkPeerings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkPeering, err error) {
	result = &v1alpha1.NetworkPeering{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkPeerings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkPeeringList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NetworkPeeringList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkpeerings").
...
func (c *networkPeerings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkPeerings) Create(ctx context.Context, networkPeering *v1alpha1.NetworkPeering, opts v1.CreateOptions) (result *v1alpha1.NetworkPeering, err error) {
	result = &v1alpha1.NetworkPeering{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkpeerings").
...
func (c *networkPeerings) Update(ctx context.Context, networkPeering *v1alpha1.NetworkPeering, opts v1.UpdateOptions) (result *v1alpha1.NetworkPeering, err error) {
	result = &v1alpha1.NetworkPeering{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkpeerings").
...
func (c *networkPeerings) UpdateStatus(ctx context.Context, networkPeering *v1alpha1.NetworkPeering, opts v1.UpdateOptions) (result *v1alpha1.NetworkPeering, err error) {
	result = &v1alpha1.NetworkPeering{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkpeerings").
...
func (c *networkPeerings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkPeerings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkPeerings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkPeering, err error) {
	result = &v1alpha1.NetworkPeering{}
