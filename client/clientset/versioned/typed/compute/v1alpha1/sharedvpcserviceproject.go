...
// SharedVpcServiceProjectsGetter has a method to return a SharedVpcServiceProjectInterface.
...
// sharedVpcServiceProjects implements SharedVpcServiceProjectInterface
type sharedVpcServiceProjects struct {
	client rest.Interface
	ns     string
}

// newSharedVpcServiceProjects returns a SharedVpcServiceProjects
func newSharedVpcServiceProjects(c *ComputeV1alpha1Client, namespace string) *sharedVpcServiceProjects {
	return &sharedVpcServiceProjects{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *sharedVpcServiceProjects) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SharedVpcServiceProject, err error) {
	result = &v1alpha1.SharedVpcServiceProject{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *sharedVpcServiceProjects) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SharedVpcServiceProjectList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SharedVpcServiceProjectList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sharedvpcserviceprojects").
...
func (c *sharedVpcServiceProjects) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sharedVpcServiceProjects) Create(ctx context.Context, sharedVpcServiceProject *v1alpha1.SharedVpcServiceProject, opts v1.CreateOptions) (result *v1alpha1.SharedVpcServiceProject, err error) {
	result = &v1alpha1.SharedVpcServiceProject{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sharedvpcserviceprojects").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sharedVpcServiceProject).
		Do(ctx).
		Into(result)
	return
}
...
func (c *sharedVpcServiceProjects) Update(ctx context.Context, sharedVpcServiceProject *v1alpha1.SharedVpcServiceProject, opts v1.UpdateOptions) (result *v1alpha1.SharedVpcServiceProject, err error) {
	result = &v1alpha1.SharedVpcServiceProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedvpcserviceprojects").
		Name(sharedVpcServiceProject.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sharedVpcServiceProject).
		Do(ctx).
		Into(result)
...
func (c *sharedVpcServiceProjects) UpdateStatus(ctx context.Context, sharedVpcServiceProject *v1alpha1.SharedVpcServiceProject, opts v1.UpdateOptions) (result *v1alpha1.SharedVpcServiceProject, err error) {
	result = &v1alpha1.SharedVpcServiceProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedvpcserviceprojects").
...
func (c *sharedVpcServiceProjects) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sharedVpcServiceProjects) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sharedVpcServiceProjects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SharedVpcServiceProject, err error) {
	result = &v1alpha1.SharedVpcServiceProject{}
