...
// ProjectMetadatasGetter has a method to return a ProjectMetadataInterface.
...
// projectMetadatas implements ProjectMetadataInterface
type projectMetadatas struct {
	client rest.Interface
	ns     string
}

// newProjectMetadatas returns a ProjectMetadatas
func newProjectMetadatas(c *ComputeV1alpha1Client, namespace string) *projectMetadatas {
...
func (c *projectMetadatas) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProjectMetadata, err error) {
	result = &v1alpha1.ProjectMetadata{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projectmetadatas").
		Name(name).
...
func (c *projectMetadatas) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectMetadataList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProjectMetadataList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projectmetadatas").
...
func (c *projectMetadatas) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectMetadatas) Create(ctx context.Context, projectMetadata *v1alpha1.ProjectMetadata, opts v1.CreateOptions) (result *v1alpha1.ProjectMetadata, err error) {
	result = &v1alpha1.ProjectMetadata{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectmetadatas").
...
func (c *projectMetadatas) Update(ctx context.Context, projectMetadata *v1alpha1.ProjectMetadata, opts v1.UpdateOptions) (result *v1alpha1.ProjectMetadata, err error) {
	result = &v1alpha1.ProjectMetadata{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectmetadatas").
...
func (c *projectMetadatas) UpdateStatus(ctx context.Context, projectMetadata *v1alpha1.ProjectMetadata, opts v1.UpdateOptions) (result *v1alpha1.ProjectMetadata, err error) {
	result = &v1alpha1.ProjectMetadata{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectmetadatas").
...
func (c *projectMetadatas) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *projectMetadatas) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectMetadatas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProjectMetadata, err error) {
	result = &v1alpha1.ProjectMetadata{}
