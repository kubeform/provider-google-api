...
// RegionNetworkEndpointGroupsGetter has a method to return a RegionNetworkEndpointGroupInterface.
...
// regionNetworkEndpointGroups implements RegionNetworkEndpointGroupInterface
type regionNetworkEndpointGroups struct {
	client rest.Interface
	ns     string
}

// newRegionNetworkEndpointGroups returns a RegionNetworkEndpointGroups
func newRegionNetworkEndpointGroups(c *ComputeV1alpha1Client, namespace string) *regionNetworkEndpointGroups {
...
func (c *regionNetworkEndpointGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegionNetworkEndpointGroup, err error) {
	result = &v1alpha1.RegionNetworkEndpointGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *regionNetworkEndpointGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegionNetworkEndpointGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RegionNetworkEndpointGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("regionnetworkendpointgroups").
...
func (c *regionNetworkEndpointGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *regionNetworkEndpointGroups) Create(ctx context.Context, regionNetworkEndpointGroup *v1alpha1.RegionNetworkEndpointGroup, opts v1.CreateOptions) (result *v1alpha1.RegionNetworkEndpointGroup, err error) {
	result = &v1alpha1.RegionNetworkEndpointGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("regionnetworkendpointgroups").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionNetworkEndpointGroup).
		Do(ctx).
		Into(result)
	return
}
...
func (c *regionNetworkEndpointGroups) Update(ctx context.Context, regionNetworkEndpointGroup *v1alpha1.RegionNetworkEndpointGroup, opts v1.UpdateOptions) (result *v1alpha1.RegionNetworkEndpointGroup, err error) {
	result = &v1alpha1.RegionNetworkEndpointGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regionnetworkendpointgroups").
		Name(regionNetworkEndpointGroup.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionNetworkEndpointGroup).
		Do(ctx).
		Into(result)
...
func (c *regionNetworkEndpointGroups) UpdateStatus(ctx context.Context, regionNetworkEndpointGroup *v1alpha1.RegionNetworkEndpointGroup, opts v1.UpdateOptions) (result *v1alpha1.RegionNetworkEndpointGroup, err error) {
	result = &v1alpha1.RegionNetworkEndpointGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regionnetworkendpointgroups").
...
func (c *regionNetworkEndpointGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *regionNetworkEndpointGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *regionNetworkEndpointGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegionNetworkEndpointGroup, err error) {
	result = &v1alpha1.RegionNetworkEndpointGroup{}
