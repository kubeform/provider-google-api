...
// InstanceGroupNamedPortsGetter has a method to return a InstanceGroupNamedPortInterface.
...
// instanceGroupNamedPorts implements InstanceGroupNamedPortInterface
type instanceGroupNamedPorts struct {
	client rest.Interface
	ns     string
}

// newInstanceGroupNamedPorts returns a InstanceGroupNamedPorts
func newInstanceGroupNamedPorts(c *ComputeV1alpha1Client, namespace string) *instanceGroupNamedPorts {
	return &instanceGroupNamedPorts{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *instanceGroupNamedPorts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InstanceGroupNamedPort, err error) {
	result = &v1alpha1.InstanceGroupNamedPort{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *instanceGroupNamedPorts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InstanceGroupNamedPortList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InstanceGroupNamedPortList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("instancegroupnamedports").
...
func (c *instanceGroupNamedPorts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *instanceGroupNamedPorts) Create(ctx context.Context, instanceGroupNamedPort *v1alpha1.InstanceGroupNamedPort, opts v1.CreateOptions) (result *v1alpha1.InstanceGroupNamedPort, err error) {
	result = &v1alpha1.InstanceGroupNamedPort{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancegroupnamedports").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(instanceGroupNamedPort).
		Do(ctx).
		Into(result)
	return
}
...
func (c *instanceGroupNamedPorts) Update(ctx context.Context, instanceGroupNamedPort *v1alpha1.InstanceGroupNamedPort, opts v1.UpdateOptions) (result *v1alpha1.InstanceGroupNamedPort, err error) {
	result = &v1alpha1.InstanceGroupNamedPort{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancegroupnamedports").
		Name(instanceGroupNamedPort.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(instanceGroupNamedPort).
		Do(ctx).
		Into(result)
...
func (c *instanceGroupNamedPorts) UpdateStatus(ctx context.Context, instanceGroupNamedPort *v1alpha1.InstanceGroupNamedPort, opts v1.UpdateOptions) (result *v1alpha1.InstanceGroupNamedPort, err error) {
	result = &v1alpha1.InstanceGroupNamedPort{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancegroupnamedports").
...
func (c *instanceGroupNamedPorts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *instanceGroupNamedPorts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *instanceGroupNamedPorts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InstanceGroupNamedPort, err error) {
	result = &v1alpha1.InstanceGroupNamedPort{}
