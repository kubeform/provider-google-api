...
// RouterNATsGetter has a method to return a RouterNATInterface.
...
// routerNATs implements RouterNATInterface
type routerNATs struct {
	client rest.Interface
	ns     string
}

// newRouterNATs returns a RouterNATs
func newRouterNATs(c *ComputeV1alpha1Client, namespace string) *routerNATs {
	return &routerNATs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *routerNATs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RouterNAT, err error) {
	result = &v1alpha1.RouterNAT{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("routernats").
		Name(name).
...
func (c *routerNATs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RouterNATList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RouterNATList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("routernats").
...
func (c *routerNATs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *routerNATs) Create(ctx context.Context, routerNAT *v1alpha1.RouterNAT, opts v1.CreateOptions) (result *v1alpha1.RouterNAT, err error) {
	result = &v1alpha1.RouterNAT{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("routernats").
...
func (c *routerNATs) Update(ctx context.Context, routerNAT *v1alpha1.RouterNAT, opts v1.UpdateOptions) (result *v1alpha1.RouterNAT, err error) {
	result = &v1alpha1.RouterNAT{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routernats").
...
func (c *routerNATs) UpdateStatus(ctx context.Context, routerNAT *v1alpha1.RouterNAT, opts v1.UpdateOptions) (result *v1alpha1.RouterNAT, err error) {
	result = &v1alpha1.RouterNAT{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routernats").
...
func (c *routerNATs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *routerNATs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *routerNATs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RouterNAT, err error) {
	result = &v1alpha1.RouterNAT{}
