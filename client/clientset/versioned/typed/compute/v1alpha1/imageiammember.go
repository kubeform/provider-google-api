...
// ImageIamMembersGetter has a method to return a ImageIamMemberInterface.
...
// imageIamMembers implements ImageIamMemberInterface
type imageIamMembers struct {
	client rest.Interface
	ns     string
}

// newImageIamMembers returns a ImageIamMembers
func newImageIamMembers(c *ComputeV1alpha1Client, namespace string) *imageIamMembers {
	return &imageIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *imageIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ImageIamMember, err error) {
	result = &v1alpha1.ImageIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *imageIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ImageIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ImageIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("imageiammembers").
...
func (c *imageIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *imageIamMembers) Create(ctx context.Context, imageIamMember *v1alpha1.ImageIamMember, opts v1.CreateOptions) (result *v1alpha1.ImageIamMember, err error) {
	result = &v1alpha1.ImageIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("imageiammembers").
...
func (c *imageIamMembers) Update(ctx context.Context, imageIamMember *v1alpha1.ImageIamMember, opts v1.UpdateOptions) (result *v1alpha1.ImageIamMember, err error) {
	result = &v1alpha1.ImageIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imageiammembers").
		Name(imageIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(imageIamMember).
		Do(ctx).
		Into(result)
...
func (c *imageIamMembers) UpdateStatus(ctx context.Context, imageIamMember *v1alpha1.ImageIamMember, opts v1.UpdateOptions) (result *v1alpha1.ImageIamMember, err error) {
	result = &v1alpha1.ImageIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imageiammembers").
...
func (c *imageIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *imageIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *imageIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ImageIamMember, err error) {
	result = &v1alpha1.ImageIamMember{}
