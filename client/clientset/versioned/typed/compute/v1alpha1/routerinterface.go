...
func newRouterInterfaces(c *ComputeV1alpha1Client, namespace string) *routerInterfaces {
...
func (c *routerInterfaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RouterInterface, err error) {
	result = &v1alpha1.RouterInterface{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *routerInterfaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RouterInterfaceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RouterInterfaceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("routerinterfaces").
...
func (c *routerInterfaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *routerInterfaces) Create(ctx context.Context, routerInterface *v1alpha1.RouterInterface, opts v1.CreateOptions) (result *v1alpha1.RouterInterface, err error) {
	result = &v1alpha1.RouterInterface{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("routerinterfaces").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(routerInterface).
		Do(ctx).
		Into(result)
	return
}
...
func (c *routerInterfaces) Update(ctx context.Context, routerInterface *v1alpha1.RouterInterface, opts v1.UpdateOptions) (result *v1alpha1.RouterInterface, err error) {
	result = &v1alpha1.RouterInterface{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routerinterfaces").
...
func (c *routerInterfaces) UpdateStatus(ctx context.Context, routerInterface *v1alpha1.RouterInterface, opts v1.UpdateOptions) (result *v1alpha1.RouterInterface, err error) {
	result = &v1alpha1.RouterInterface{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routerinterfaces").
...
func (c *routerInterfaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *routerInterfaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *routerInterfaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RouterInterface, err error) {
	result = &v1alpha1.RouterInterface{}
