...
// RegionDiskIamMembersGetter has a method to return a RegionDiskIamMemberInterface.
...
// regionDiskIamMembers implements RegionDiskIamMemberInterface
type regionDiskIamMembers struct {
	client rest.Interface
	ns     string
}

// newRegionDiskIamMembers returns a RegionDiskIamMembers
func newRegionDiskIamMembers(c *ComputeV1alpha1Client, namespace string) *regionDiskIamMembers {
	return &regionDiskIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *regionDiskIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegionDiskIamMember, err error) {
	result = &v1alpha1.RegionDiskIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *regionDiskIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegionDiskIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RegionDiskIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("regiondiskiammembers").
...
func (c *regionDiskIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *regionDiskIamMembers) Create(ctx context.Context, regionDiskIamMember *v1alpha1.RegionDiskIamMember, opts v1.CreateOptions) (result *v1alpha1.RegionDiskIamMember, err error) {
	result = &v1alpha1.RegionDiskIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("regiondiskiammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionDiskIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *regionDiskIamMembers) Update(ctx context.Context, regionDiskIamMember *v1alpha1.RegionDiskIamMember, opts v1.UpdateOptions) (result *v1alpha1.RegionDiskIamMember, err error) {
	result = &v1alpha1.RegionDiskIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regiondiskiammembers").
		Name(regionDiskIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionDiskIamMember).
		Do(ctx).
		Into(result)
...
func (c *regionDiskIamMembers) UpdateStatus(ctx context.Context, regionDiskIamMember *v1alpha1.RegionDiskIamMember, opts v1.UpdateOptions) (result *v1alpha1.RegionDiskIamMember, err error) {
	result = &v1alpha1.RegionDiskIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regiondiskiammembers").
...
func (c *regionDiskIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *regionDiskIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *regionDiskIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegionDiskIamMember, err error) {
	result = &v1alpha1.RegionDiskIamMember{}
