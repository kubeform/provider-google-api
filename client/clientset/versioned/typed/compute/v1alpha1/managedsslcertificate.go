...
// ManagedSslCertificatesGetter has a method to return a ManagedSslCertificateInterface.
...
// managedSslCertificates implements ManagedSslCertificateInterface
type managedSslCertificates struct {
	client rest.Interface
	ns     string
}

// newManagedSslCertificates returns a ManagedSslCertificates
func newManagedSslCertificates(c *ComputeV1alpha1Client, namespace string) *managedSslCertificates {
	return &managedSslCertificates{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *managedSslCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagedSslCertificate, err error) {
	result = &v1alpha1.ManagedSslCertificate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managedSslCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagedSslCertificateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagedSslCertificateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("managedsslcertificates").
...
func (c *managedSslCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managedSslCertificates) Create(ctx context.Context, managedSslCertificate *v1alpha1.ManagedSslCertificate, opts v1.CreateOptions) (result *v1alpha1.ManagedSslCertificate, err error) {
	result = &v1alpha1.ManagedSslCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedsslcertificates").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managedSslCertificate).
		Do(ctx).
		Into(result)
	return
}
...
func (c *managedSslCertificates) Update(ctx context.Context, managedSslCertificate *v1alpha1.ManagedSslCertificate, opts v1.UpdateOptions) (result *v1alpha1.ManagedSslCertificate, err error) {
	result = &v1alpha1.ManagedSslCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedsslcertificates").
		Name(managedSslCertificate.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managedSslCertificate).
		Do(ctx).
		Into(result)
...
func (c *managedSslCertificates) UpdateStatus(ctx context.Context, managedSslCertificate *v1alpha1.ManagedSslCertificate, opts v1.UpdateOptions) (result *v1alpha1.ManagedSslCertificate, err error) {
	result = &v1alpha1.ManagedSslCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedsslcertificates").
...
func (c *managedSslCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managedSslCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managedSslCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagedSslCertificate, err error) {
	result = &v1alpha1.ManagedSslCertificate{}
