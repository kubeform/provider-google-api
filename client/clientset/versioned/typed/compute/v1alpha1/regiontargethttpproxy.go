...
// RegionTargetHTTPProxiesGetter has a method to return a RegionTargetHTTPProxyInterface.
...
// regionTargetHTTPProxies implements RegionTargetHTTPProxyInterface
type regionTargetHTTPProxies struct {
	client rest.Interface
	ns     string
}

// newRegionTargetHTTPProxies returns a RegionTargetHTTPProxies
func newRegionTargetHTTPProxies(c *ComputeV1alpha1Client, namespace string) *regionTargetHTTPProxies {
...
func (c *regionTargetHTTPProxies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegionTargetHTTPProxy, err error) {
	result = &v1alpha1.RegionTargetHTTPProxy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *regionTargetHTTPProxies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegionTargetHTTPProxyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RegionTargetHTTPProxyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("regiontargethttpproxies").
...
func (c *regionTargetHTTPProxies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *regionTargetHTTPProxies) Create(ctx context.Context, regionTargetHTTPProxy *v1alpha1.RegionTargetHTTPProxy, opts v1.CreateOptions) (result *v1alpha1.RegionTargetHTTPProxy, err error) {
	result = &v1alpha1.RegionTargetHTTPProxy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("regiontargethttpproxies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionTargetHTTPProxy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *regionTargetHTTPProxies) Update(ctx context.Context, regionTargetHTTPProxy *v1alpha1.RegionTargetHTTPProxy, opts v1.UpdateOptions) (result *v1alpha1.RegionTargetHTTPProxy, err error) {
	result = &v1alpha1.RegionTargetHTTPProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regiontargethttpproxies").
		Name(regionTargetHTTPProxy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionTargetHTTPProxy).
		Do(ctx).
		Into(result)
...
func (c *regionTargetHTTPProxies) UpdateStatus(ctx context.Context, regionTargetHTTPProxy *v1alpha1.RegionTargetHTTPProxy, opts v1.UpdateOptions) (result *v1alpha1.RegionTargetHTTPProxy, err error) {
	result = &v1alpha1.RegionTargetHTTPProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regiontargethttpproxies").
...
func (c *regionTargetHTTPProxies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *regionTargetHTTPProxies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *regionTargetHTTPProxies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegionTargetHTTPProxy, err error) {
	result = &v1alpha1.RegionTargetHTTPProxy{}
