...
// RegionURLMapsGetter has a method to return a RegionURLMapInterface.
...
// regionURLMaps implements RegionURLMapInterface
type regionURLMaps struct {
	client rest.Interface
	ns     string
}

// newRegionURLMaps returns a RegionURLMaps
func newRegionURLMaps(c *ComputeV1alpha1Client, namespace string) *regionURLMaps {
...
func (c *regionURLMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegionURLMap, err error) {
	result = &v1alpha1.RegionURLMap{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *regionURLMaps) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegionURLMapList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RegionURLMapList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("regionurlmaps").
...
func (c *regionURLMaps) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *regionURLMaps) Create(ctx context.Context, regionURLMap *v1alpha1.RegionURLMap, opts v1.CreateOptions) (result *v1alpha1.RegionURLMap, err error) {
	result = &v1alpha1.RegionURLMap{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("regionurlmaps").
...
func (c *regionURLMaps) Update(ctx context.Context, regionURLMap *v1alpha1.RegionURLMap, opts v1.UpdateOptions) (result *v1alpha1.RegionURLMap, err error) {
	result = &v1alpha1.RegionURLMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regionurlmaps").
		Name(regionURLMap.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionURLMap).
		Do(ctx).
		Into(result)
...
func (c *regionURLMaps) UpdateStatus(ctx context.Context, regionURLMap *v1alpha1.RegionURLMap, opts v1.UpdateOptions) (result *v1alpha1.RegionURLMap, err error) {
	result = &v1alpha1.RegionURLMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regionurlmaps").
...
func (c *regionURLMaps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *regionURLMaps) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *regionURLMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegionURLMap, err error) {
	result = &v1alpha1.RegionURLMap{}
