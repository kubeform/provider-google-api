...
// NetworkPeeringRoutesConfigsGetter has a method to return a NetworkPeeringRoutesConfigInterface.
...
// networkPeeringRoutesConfigs implements NetworkPeeringRoutesConfigInterface
type networkPeeringRoutesConfigs struct {
	client rest.Interface
	ns     string
}

// newNetworkPeeringRoutesConfigs returns a NetworkPeeringRoutesConfigs
func newNetworkPeeringRoutesConfigs(c *ComputeV1alpha1Client, namespace string) *networkPeeringRoutesConfigs {
	return &networkPeeringRoutesConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *networkPeeringRoutesConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkPeeringRoutesConfig, err error) {
	result = &v1alpha1.NetworkPeeringRoutesConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkPeeringRoutesConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkPeeringRoutesConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NetworkPeeringRoutesConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkpeeringroutesconfigs").
...
func (c *networkPeeringRoutesConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkPeeringRoutesConfigs) Create(ctx context.Context, networkPeeringRoutesConfig *v1alpha1.NetworkPeeringRoutesConfig, opts v1.CreateOptions) (result *v1alpha1.NetworkPeeringRoutesConfig, err error) {
	result = &v1alpha1.NetworkPeeringRoutesConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkpeeringroutesconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkPeeringRoutesConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *networkPeeringRoutesConfigs) Update(ctx context.Context, networkPeeringRoutesConfig *v1alpha1.NetworkPeeringRoutesConfig, opts v1.UpdateOptions) (result *v1alpha1.NetworkPeeringRoutesConfig, err error) {
	result = &v1alpha1.NetworkPeeringRoutesConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkpeeringroutesconfigs").
		Name(networkPeeringRoutesConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkPeeringRoutesConfig).
		Do(ctx).
		Into(result)
...
func (c *networkPeeringRoutesConfigs) UpdateStatus(ctx context.Context, networkPeeringRoutesConfig *v1alpha1.NetworkPeeringRoutesConfig, opts v1.UpdateOptions) (result *v1alpha1.NetworkPeeringRoutesConfig, err error) {
	result = &v1alpha1.NetworkPeeringRoutesConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkpeeringroutesconfigs").
...
func (c *networkPeeringRoutesConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkPeeringRoutesConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkPeeringRoutesConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkPeeringRoutesConfig, err error) {
	result = &v1alpha1.NetworkPeeringRoutesConfig{}
