...
// TargetPoolsGetter has a method to return a TargetPoolInterface.
...
// targetPools implements TargetPoolInterface
type targetPools struct {
	client rest.Interface
	ns     string
}

// newTargetPools returns a TargetPools
func newTargetPools(c *ComputeV1alpha1Client, namespace string) *targetPools {
	return &targetPools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *targetPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TargetPool, err error) {
	result = &v1alpha1.TargetPool{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *targetPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TargetPoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TargetPoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("targetpools").
...
func (c *targetPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *targetPools) Create(ctx context.Context, targetPool *v1alpha1.TargetPool, opts v1.CreateOptions) (result *v1alpha1.TargetPool, err error) {
	result = &v1alpha1.TargetPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("targetpools").
...
func (c *targetPools) Update(ctx context.Context, targetPool *v1alpha1.TargetPool, opts v1.UpdateOptions) (result *v1alpha1.TargetPool, err error) {
	result = &v1alpha1.TargetPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targetpools").
...
func (c *targetPools) UpdateStatus(ctx context.Context, targetPool *v1alpha1.TargetPool, opts v1.UpdateOptions) (result *v1alpha1.TargetPool, err error) {
	result = &v1alpha1.TargetPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targetpools").
...
func (c *targetPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *targetPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *targetPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TargetPool, err error) {
	result = &v1alpha1.TargetPool{}
