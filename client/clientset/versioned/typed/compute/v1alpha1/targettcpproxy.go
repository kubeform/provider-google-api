...
// TargetTcpProxiesGetter has a method to return a TargetTcpProxyInterface.
...
// targetTcpProxies implements TargetTcpProxyInterface
type targetTcpProxies struct {
	client rest.Interface
	ns     string
}

// newTargetTcpProxies returns a TargetTcpProxies
func newTargetTcpProxies(c *ComputeV1alpha1Client, namespace string) *targetTcpProxies {
...
func (c *targetTcpProxies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TargetTcpProxy, err error) {
	result = &v1alpha1.TargetTcpProxy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *targetTcpProxies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TargetTcpProxyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TargetTcpProxyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("targettcpproxies").
...
func (c *targetTcpProxies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *targetTcpProxies) Create(ctx context.Context, targetTcpProxy *v1alpha1.TargetTcpProxy, opts v1.CreateOptions) (result *v1alpha1.TargetTcpProxy, err error) {
	result = &v1alpha1.TargetTcpProxy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("targettcpproxies").
...
func (c *targetTcpProxies) Update(ctx context.Context, targetTcpProxy *v1alpha1.TargetTcpProxy, opts v1.UpdateOptions) (result *v1alpha1.TargetTcpProxy, err error) {
	result = &v1alpha1.TargetTcpProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targettcpproxies").
...
func (c *targetTcpProxies) UpdateStatus(ctx context.Context, targetTcpProxy *v1alpha1.TargetTcpProxy, opts v1.UpdateOptions) (result *v1alpha1.TargetTcpProxy, err error) {
	result = &v1alpha1.TargetTcpProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targettcpproxies").
...
func (c *targetTcpProxies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *targetTcpProxies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *targetTcpProxies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TargetTcpProxy, err error) {
	result = &v1alpha1.TargetTcpProxy{}
