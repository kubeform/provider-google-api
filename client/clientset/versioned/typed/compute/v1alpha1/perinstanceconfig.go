...
// PerInstanceConfigsGetter has a method to return a PerInstanceConfigInterface.
...
// perInstanceConfigs implements PerInstanceConfigInterface
type perInstanceConfigs struct {
	client rest.Interface
	ns     string
}

// newPerInstanceConfigs returns a PerInstanceConfigs
func newPerInstanceConfigs(c *ComputeV1alpha1Client, namespace string) *perInstanceConfigs {
...
func (c *perInstanceConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PerInstanceConfig, err error) {
	result = &v1alpha1.PerInstanceConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *perInstanceConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PerInstanceConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PerInstanceConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("perinstanceconfigs").
...
func (c *perInstanceConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *perInstanceConfigs) Create(ctx context.Context, perInstanceConfig *v1alpha1.PerInstanceConfig, opts v1.CreateOptions) (result *v1alpha1.PerInstanceConfig, err error) {
	result = &v1alpha1.PerInstanceConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("perinstanceconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(perInstanceConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *perInstanceConfigs) Update(ctx context.Context, perInstanceConfig *v1alpha1.PerInstanceConfig, opts v1.UpdateOptions) (result *v1alpha1.PerInstanceConfig, err error) {
	result = &v1alpha1.PerInstanceConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("perinstanceconfigs").
		Name(perInstanceConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(perInstanceConfig).
		Do(ctx).
		Into(result)
...
func (c *perInstanceConfigs) UpdateStatus(ctx context.Context, perInstanceConfig *v1alpha1.PerInstanceConfig, opts v1.UpdateOptions) (result *v1alpha1.PerInstanceConfig, err error) {
	result = &v1alpha1.PerInstanceConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("perinstanceconfigs").
...
func (c *perInstanceConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *perInstanceConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *perInstanceConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PerInstanceConfig, err error) {
	result = &v1alpha1.PerInstanceConfig{}
