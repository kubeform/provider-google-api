...
// InstanceGroupManagersGetter has a method to return a InstanceGroupManagerInterface.
...
// instanceGroupManagers implements InstanceGroupManagerInterface
type instanceGroupManagers struct {
	client rest.Interface
	ns     string
}

// newInstanceGroupManagers returns a InstanceGroupManagers
func newInstanceGroupManagers(c *ComputeV1alpha1Client, namespace string) *instanceGroupManagers {
...
func (c *instanceGroupManagers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InstanceGroupManager, err error) {
	result = &v1alpha1.InstanceGroupManager{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *instanceGroupManagers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InstanceGroupManagerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InstanceGroupManagerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("instancegroupmanagers").
...
func (c *instanceGroupManagers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *instanceGroupManagers) Create(ctx context.Context, instanceGroupManager *v1alpha1.InstanceGroupManager, opts v1.CreateOptions) (result *v1alpha1.InstanceGroupManager, err error) {
	result = &v1alpha1.InstanceGroupManager{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancegroupmanagers").
...
func (c *instanceGroupManagers) Update(ctx context.Context, instanceGroupManager *v1alpha1.InstanceGroupManager, opts v1.UpdateOptions) (result *v1alpha1.InstanceGroupManager, err error) {
	result = &v1alpha1.InstanceGroupManager{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancegroupmanagers").
...
func (c *instanceGroupManagers) UpdateStatus(ctx context.Context, instanceGroupManager *v1alpha1.InstanceGroupManager, opts v1.UpdateOptions) (result *v1alpha1.InstanceGroupManager, err error) {
	result = &v1alpha1.InstanceGroupManager{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancegroupmanagers").
...
func (c *instanceGroupManagers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *instanceGroupManagers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *instanceGroupManagers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InstanceGroupManager, err error) {
	result = &v1alpha1.InstanceGroupManager{}
