...
// DiskIamMembersGetter has a method to return a DiskIamMemberInterface.
...
// diskIamMembers implements DiskIamMemberInterface
type diskIamMembers struct {
	client rest.Interface
	ns     string
}

// newDiskIamMembers returns a DiskIamMembers
func newDiskIamMembers(c *ComputeV1alpha1Client, namespace string) *diskIamMembers {
	return &diskIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *diskIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DiskIamMember, err error) {
	result = &v1alpha1.DiskIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *diskIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DiskIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DiskIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("diskiammembers").
...
func (c *diskIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *diskIamMembers) Create(ctx context.Context, diskIamMember *v1alpha1.DiskIamMember, opts v1.CreateOptions) (result *v1alpha1.DiskIamMember, err error) {
	result = &v1alpha1.DiskIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("diskiammembers").
...
func (c *diskIamMembers) Update(ctx context.Context, diskIamMember *v1alpha1.DiskIamMember, opts v1.UpdateOptions) (result *v1alpha1.DiskIamMember, err error) {
	result = &v1alpha1.DiskIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskiammembers").
		Name(diskIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(diskIamMember).
		Do(ctx).
		Into(result)
...
func (c *diskIamMembers) UpdateStatus(ctx context.Context, diskIamMember *v1alpha1.DiskIamMember, opts v1.UpdateOptions) (result *v1alpha1.DiskIamMember, err error) {
	result = &v1alpha1.DiskIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskiammembers").
...
func (c *diskIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *diskIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *diskIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DiskIamMember, err error) {
	result = &v1alpha1.DiskIamMember{}
