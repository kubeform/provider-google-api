...
// ImageIamPoliciesGetter has a method to return a ImageIamPolicyInterface.
...
// imageIamPolicies implements ImageIamPolicyInterface
type imageIamPolicies struct {
	client rest.Interface
	ns     string
}

// newImageIamPolicies returns a ImageIamPolicies
func newImageIamPolicies(c *ComputeV1alpha1Client, namespace string) *imageIamPolicies {
	return &imageIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *imageIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ImageIamPolicy, err error) {
	result = &v1alpha1.ImageIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *imageIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ImageIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ImageIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("imageiampolicies").
...
func (c *imageIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *imageIamPolicies) Create(ctx context.Context, imageIamPolicy *v1alpha1.ImageIamPolicy, opts v1.CreateOptions) (result *v1alpha1.ImageIamPolicy, err error) {
	result = &v1alpha1.ImageIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("imageiampolicies").
...
func (c *imageIamPolicies) Update(ctx context.Context, imageIamPolicy *v1alpha1.ImageIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.ImageIamPolicy, err error) {
	result = &v1alpha1.ImageIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imageiampolicies").
		Name(imageIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(imageIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *imageIamPolicies) UpdateStatus(ctx context.Context, imageIamPolicy *v1alpha1.ImageIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.ImageIamPolicy, err error) {
	result = &v1alpha1.ImageIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imageiampolicies").
...
func (c *imageIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *imageIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *imageIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ImageIamPolicy, err error) {
	result = &v1alpha1.ImageIamPolicy{}
