...
func newResourcePolicies(c *ComputeV1alpha1Client, namespace string) *resourcePolicies {
...
func (c *resourcePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResourcePolicy, err error) {
...
func (c *resourcePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourcePolicyList, err error) {
...
func (c *resourcePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *resourcePolicies) Create(ctx context.Context, resourcePolicy *v1alpha1.ResourcePolicy, opts v1.CreateOptions) (result *v1alpha1.ResourcePolicy, err error) {
	result = &v1alpha1.ResourcePolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourcepolicies").
...
func (c *resourcePolicies) Update(ctx context.Context, resourcePolicy *v1alpha1.ResourcePolicy, opts v1.UpdateOptions) (result *v1alpha1.ResourcePolicy, err error) {
	result = &v1alpha1.ResourcePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcepolicies").
...
func (c *resourcePolicies) UpdateStatus(ctx context.Context, resourcePolicy *v1alpha1.ResourcePolicy, opts v1.UpdateOptions) (result *v1alpha1.ResourcePolicy, err error) {
	result = &v1alpha1.ResourcePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcepolicies").
...
func (c *resourcePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *resourcePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *resourcePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourcePolicy, err error) {
	result = &v1alpha1.ResourcePolicy{}
