...
// UrlMapsGetter has a method to return a UrlMapInterface.
...
// urlMaps implements UrlMapInterface
type urlMaps struct {
	client rest.Interface
	ns     string
}

// newUrlMaps returns a UrlMaps
func newUrlMaps(c *ComputeV1alpha1Client, namespace string) *urlMaps {
	return &urlMaps{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *urlMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UrlMap, err error) {
	result = &v1alpha1.UrlMap{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("urlmaps").
		Name(name).
...
func (c *urlMaps) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UrlMapList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UrlMapList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("urlmaps").
...
func (c *urlMaps) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *urlMaps) Create(ctx context.Context, urlMap *v1alpha1.UrlMap, opts v1.CreateOptions) (result *v1alpha1.UrlMap, err error) {
	result = &v1alpha1.UrlMap{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("urlmaps").
...
func (c *urlMaps) Update(ctx context.Context, urlMap *v1alpha1.UrlMap, opts v1.UpdateOptions) (result *v1alpha1.UrlMap, err error) {
	result = &v1alpha1.UrlMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("urlmaps").
...
func (c *urlMaps) UpdateStatus(ctx context.Context, urlMap *v1alpha1.UrlMap, opts v1.UpdateOptions) (result *v1alpha1.UrlMap, err error) {
	result = &v1alpha1.UrlMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("urlmaps").
...
func (c *urlMaps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *urlMaps) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *urlMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UrlMap, err error) {
	result = &v1alpha1.UrlMap{}
