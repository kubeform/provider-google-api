...
var targetpoolsResource = schema.GroupVersionResource{Group: "compute.google.kubeform.com", Version: "v1alpha1", Resource: "targetpools"}

var targetpoolsKind = schema.GroupVersionKind{Group: "compute.google.kubeform.com", Version: "v1alpha1", Kind: "TargetPool"}
...
func (c *FakeTargetPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TargetPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(targetpoolsResource, c.ns, name), &v1alpha1.TargetPool{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TargetPool), err
}
...
func (c *FakeTargetPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TargetPoolList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(targetpoolsResource, targetpoolsKind, c.ns, opts), &v1alpha1.TargetPoolList{})
	...
	list := &v1alpha1.TargetPoolList{ListMeta: obj.(*v1alpha1.TargetPoolList).ListMeta}
	for _, item := range obj.(*v1alpha1.TargetPoolList).Items {
...
func (c *FakeTargetPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(targetpoolsResource, c.ns, opts))
...
func (c *FakeTargetPools) Create(ctx context.Context, targetPool *v1alpha1.TargetPool, opts v1.CreateOptions) (result *v1alpha1.TargetPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(targetpoolsResource, c.ns, targetPool), &v1alpha1.TargetPool{})
...
func (c *FakeTargetPools) Update(ctx context.Context, targetPool *v1alpha1.TargetPool, opts v1.UpdateOptions) (result *v1alpha1.TargetPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(targetpoolsResource, c.ns, targetPool), &v1alpha1.TargetPool{})
...
func (c *FakeTargetPools) UpdateStatus(ctx context.Context, targetPool *v1alpha1.TargetPool, opts v1.UpdateOptions) (*v1alpha1.TargetPool, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(targetpoolsResource, "status", c.ns, targetPool), &v1alpha1.TargetPool{})
...
func (c *FakeTargetPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(targetpoolsResource, c.ns, name), &v1alpha1.TargetPool{})
...
func (c *FakeTargetPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(targetpoolsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TargetPoolList{})
	return err
}
...
func (c *FakeTargetPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TargetPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(targetpoolsResource, c.ns, name, pt, data, subresources...), &v1alpha1.TargetPool{})
