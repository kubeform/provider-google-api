...
var diskiammembersResource = schema.GroupVersionResource{Group: "compute.google.kubeform.com", Version: "v1alpha1", Resource: "diskiammembers"}

var diskiammembersKind = schema.GroupVersionKind{Group: "compute.google.kubeform.com", Version: "v1alpha1", Kind: "DiskIamMember"}
...
func (c *FakeDiskIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DiskIamMember, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(diskiammembersResource, c.ns, name), &v1alpha1.DiskIamMember{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DiskIamMember), err
}
...
func (c *FakeDiskIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DiskIamMemberList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(diskiammembersResource, diskiammembersKind, c.ns, opts), &v1alpha1.DiskIamMemberList{})
	...
	list := &v1alpha1.DiskIamMemberList{ListMeta: obj.(*v1alpha1.DiskIamMemberList).ListMeta}
	for _, item := range obj.(*v1alpha1.DiskIamMemberList).Items {
...
func (c *FakeDiskIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(diskiammembersResource, c.ns, opts))
...
func (c *FakeDiskIamMembers) Create(ctx context.Context, diskIamMember *v1alpha1.DiskIamMember, opts v1.CreateOptions) (result *v1alpha1.DiskIamMember, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(diskiammembersResource, c.ns, diskIamMember), &v1alpha1.DiskIamMember{})
...
func (c *FakeDiskIamMembers) Update(ctx context.Context, diskIamMember *v1alpha1.DiskIamMember, opts v1.UpdateOptions) (result *v1alpha1.DiskIamMember, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(diskiammembersResource, c.ns, diskIamMember), &v1alpha1.DiskIamMember{})
...
func (c *FakeDiskIamMembers) UpdateStatus(ctx context.Context, diskIamMember *v1alpha1.DiskIamMember, opts v1.UpdateOptions) (*v1alpha1.DiskIamMember, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(diskiammembersResource, "status", c.ns, diskIamMember), &v1alpha1.DiskIamMember{})
...
func (c *FakeDiskIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(diskiammembersResource, c.ns, name), &v1alpha1.DiskIamMember{})
...
func (c *FakeDiskIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(diskiammembersResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.DiskIamMemberList{})
	return err
}
...
func (c *FakeDiskIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DiskIamMember, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(diskiammembersResource, c.ns, name, pt, data, subresources...), &v1alpha1.DiskIamMember{})
