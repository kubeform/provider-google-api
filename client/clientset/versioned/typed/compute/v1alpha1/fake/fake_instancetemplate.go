...
var instancetemplatesResource = schema.GroupVersionResource{Group: "compute.google.kubeform.com", Version: "v1alpha1", Resource: "instancetemplates"}

var instancetemplatesKind = schema.GroupVersionKind{Group: "compute.google.kubeform.com", Version: "v1alpha1", Kind: "InstanceTemplate"}
...
func (c *FakeInstanceTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InstanceTemplateList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.InstanceTemplateList{ListMeta: obj.(*v1alpha1.InstanceTemplateList).ListMeta}
...
func (c *FakeInstanceTemplates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeInstanceTemplates) UpdateStatus(ctx context.Context, instanceTemplate *v1alpha1.InstanceTemplate, opts v1.UpdateOptions) (*v1alpha1.InstanceTemplate, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(instancetemplatesResource, "status", c.ns, instanceTemplate), &v1alpha1.InstanceTemplate{})
...
func (c *FakeInstanceTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(instancetemplatesResource, c.ns, listOpts)
...
func (c *FakeInstanceTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InstanceTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(instancetemplatesResource, c.ns, name, pt, data, subresources...), &v1alpha1.InstanceTemplate{})
