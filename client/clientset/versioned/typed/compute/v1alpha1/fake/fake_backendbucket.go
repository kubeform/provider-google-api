...
var backendbucketsResource = schema.GroupVersionResource{Group: "compute.google.kubeform.com", Version: "v1alpha1", Resource: "backendbuckets"}

var backendbucketsKind = schema.GroupVersionKind{Group: "compute.google.kubeform.com", Version: "v1alpha1", Kind: "BackendBucket"}
...
func (c *FakeBackendBuckets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BackendBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(backendbucketsResource, c.ns, name), &v1alpha1.BackendBucket{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.BackendBucket), err
}
...
func (c *FakeBackendBuckets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BackendBucketList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(backendbucketsResource, backendbucketsKind, c.ns, opts), &v1alpha1.BackendBucketList{})
	...
	list := &v1alpha1.BackendBucketList{ListMeta: obj.(*v1alpha1.BackendBucketList).ListMeta}
	for _, item := range obj.(*v1alpha1.BackendBucketList).Items {
...
func (c *FakeBackendBuckets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(backendbucketsResource, c.ns, opts))
...
func (c *FakeBackendBuckets) Create(ctx context.Context, backendBucket *v1alpha1.BackendBucket, opts v1.CreateOptions) (result *v1alpha1.BackendBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(backendbucketsResource, c.ns, backendBucket), &v1alpha1.BackendBucket{})
...
func (c *FakeBackendBuckets) Update(ctx context.Context, backendBucket *v1alpha1.BackendBucket, opts v1.UpdateOptions) (result *v1alpha1.BackendBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(backendbucketsResource, c.ns, backendBucket), &v1alpha1.BackendBucket{})
...
func (c *FakeBackendBuckets) UpdateStatus(ctx context.Context, backendBucket *v1alpha1.BackendBucket, opts v1.UpdateOptions) (*v1alpha1.BackendBucket, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(backendbucketsResource, "status", c.ns, backendBucket), &v1alpha1.BackendBucket{})
...
func (c *FakeBackendBuckets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(backendbucketsResource, c.ns, name), &v1alpha1.BackendBucket{})
...
func (c *FakeBackendBuckets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(backendbucketsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.BackendBucketList{})
	return err
}
...
func (c *FakeBackendBuckets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BackendBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(backendbucketsResource, c.ns, name, pt, data, subresources...), &v1alpha1.BackendBucket{})
