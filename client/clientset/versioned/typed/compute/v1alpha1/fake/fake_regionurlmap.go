...
var regionurlmapsResource = schema.GroupVersionResource{Group: "compute.google.kubeform.com", Version: "v1alpha1", Resource: "regionurlmaps"}

var regionurlmapsKind = schema.GroupVersionKind{Group: "compute.google.kubeform.com", Version: "v1alpha1", Kind: "RegionURLMap"}
...
func (c *FakeRegionURLMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegionURLMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(regionurlmapsResource, c.ns, name), &v1alpha1.RegionURLMap{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.RegionURLMap), err
}
...
func (c *FakeRegionURLMaps) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegionURLMapList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(regionurlmapsResource, regionurlmapsKind, c.ns, opts), &v1alpha1.RegionURLMapList{})
	...
	list := &v1alpha1.RegionURLMapList{ListMeta: obj.(*v1alpha1.RegionURLMapList).ListMeta}
	for _, item := range obj.(*v1alpha1.RegionURLMapList).Items {
...
func (c *FakeRegionURLMaps) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(regionurlmapsResource, c.ns, opts))
...
func (c *FakeRegionURLMaps) Create(ctx context.Context, regionURLMap *v1alpha1.RegionURLMap, opts v1.CreateOptions) (result *v1alpha1.RegionURLMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(regionurlmapsResource, c.ns, regionURLMap), &v1alpha1.RegionURLMap{})
...
func (c *FakeRegionURLMaps) Update(ctx context.Context, regionURLMap *v1alpha1.RegionURLMap, opts v1.UpdateOptions) (result *v1alpha1.RegionURLMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(regionurlmapsResource, c.ns, regionURLMap), &v1alpha1.RegionURLMap{})
...
func (c *FakeRegionURLMaps) UpdateStatus(ctx context.Context, regionURLMap *v1alpha1.RegionURLMap, opts v1.UpdateOptions) (*v1alpha1.RegionURLMap, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(regionurlmapsResource, "status", c.ns, regionURLMap), &v1alpha1.RegionURLMap{})
...
func (c *FakeRegionURLMaps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(regionurlmapsResource, c.ns, name), &v1alpha1.RegionURLMap{})
...
func (c *FakeRegionURLMaps) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(regionurlmapsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.RegionURLMapList{})
	return err
}
...
func (c *FakeRegionURLMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegionURLMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(regionurlmapsResource, c.ns, name, pt, data, subresources...), &v1alpha1.RegionURLMap{})
