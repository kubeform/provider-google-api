...
var vpntunnelsResource = schema.GroupVersionResource{Group: "compute.google.kubeform.com", Version: "v1alpha1", Resource: "vpntunnels"}

var vpntunnelsKind = schema.GroupVersionKind{Group: "compute.google.kubeform.com", Version: "v1alpha1", Kind: "VpnTunnel"}
...
func (c *FakeVpnTunnels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpnTunnel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(vpntunnelsResource, c.ns, name), &v1alpha1.VpnTunnel{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VpnTunnel), err
}
...
func (c *FakeVpnTunnels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpnTunnelList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(vpntunnelsResource, vpntunnelsKind, c.ns, opts), &v1alpha1.VpnTunnelList{})
	...
	list := &v1alpha1.VpnTunnelList{ListMeta: obj.(*v1alpha1.VpnTunnelList).ListMeta}
	for _, item := range obj.(*v1alpha1.VpnTunnelList).Items {
...
func (c *FakeVpnTunnels) Create(ctx context.Context, vpnTunnel *v1alpha1.VpnTunnel, opts v1.CreateOptions) (result *v1alpha1.VpnTunnel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(vpntunnelsResource, c.ns, vpnTunnel), &v1alpha1.VpnTunnel{})
...
func (c *FakeVpnTunnels) Update(ctx context.Context, vpnTunnel *v1alpha1.VpnTunnel, opts v1.UpdateOptions) (result *v1alpha1.VpnTunnel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(vpntunnelsResource, c.ns, vpnTunnel), &v1alpha1.VpnTunnel{})
...
func (c *FakeVpnTunnels) UpdateStatus(ctx context.Context, vpnTunnel *v1alpha1.VpnTunnel, opts v1.UpdateOptions) (*v1alpha1.VpnTunnel, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(vpntunnelsResource, "status", c.ns, vpnTunnel), &v1alpha1.VpnTunnel{})
...
func (c *FakeVpnTunnels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(vpntunnelsResource, c.ns, name), &v1alpha1.VpnTunnel{})
...
func (c *FakeVpnTunnels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.VpnTunnelList{})
	return err
}
...
func (c *FakeVpnTunnels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpnTunnel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(vpntunnelsResource, c.ns, name, pt, data, subresources...), &v1alpha1.VpnTunnel{})
