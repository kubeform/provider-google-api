...
// HttpHealthChecksGetter has a method to return a HttpHealthCheckInterface.
...
// httpHealthChecks implements HttpHealthCheckInterface
type httpHealthChecks struct {
	client rest.Interface
	ns     string
}

// newHttpHealthChecks returns a HttpHealthChecks
func newHttpHealthChecks(c *ComputeV1alpha1Client, namespace string) *httpHealthChecks {
...
func (c *httpHealthChecks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HttpHealthCheck, err error) {
	result = &v1alpha1.HttpHealthCheck{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *httpHealthChecks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HttpHealthCheckList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HttpHealthCheckList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httphealthchecks").
...
func (c *httpHealthChecks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *httpHealthChecks) Create(ctx context.Context, httpHealthCheck *v1alpha1.HttpHealthCheck, opts v1.CreateOptions) (result *v1alpha1.HttpHealthCheck, err error) {
	result = &v1alpha1.HttpHealthCheck{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("httphealthchecks").
...
func (c *httpHealthChecks) Update(ctx context.Context, httpHealthCheck *v1alpha1.HttpHealthCheck, opts v1.UpdateOptions) (result *v1alpha1.HttpHealthCheck, err error) {
	result = &v1alpha1.HttpHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httphealthchecks").
...
func (c *httpHealthChecks) UpdateStatus(ctx context.Context, httpHealthCheck *v1alpha1.HttpHealthCheck, opts v1.UpdateOptions) (result *v1alpha1.HttpHealthCheck, err error) {
	result = &v1alpha1.HttpHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httphealthchecks").
...
func (c *httpHealthChecks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *httpHealthChecks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *httpHealthChecks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HttpHealthCheck, err error) {
	result = &v1alpha1.HttpHealthCheck{}
