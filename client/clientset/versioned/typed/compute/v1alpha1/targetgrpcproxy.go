...
// TargetGrpcProxiesGetter has a method to return a TargetGrpcProxyInterface.
...
// targetGrpcProxies implements TargetGrpcProxyInterface
type targetGrpcProxies struct {
	client rest.Interface
	ns     string
}

// newTargetGrpcProxies returns a TargetGrpcProxies
func newTargetGrpcProxies(c *ComputeV1alpha1Client, namespace string) *targetGrpcProxies {
...
func (c *targetGrpcProxies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TargetGrpcProxy, err error) {
	result = &v1alpha1.TargetGrpcProxy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *targetGrpcProxies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TargetGrpcProxyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TargetGrpcProxyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("targetgrpcproxies").
...
func (c *targetGrpcProxies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *targetGrpcProxies) Create(ctx context.Context, targetGrpcProxy *v1alpha1.TargetGrpcProxy, opts v1.CreateOptions) (result *v1alpha1.TargetGrpcProxy, err error) {
	result = &v1alpha1.TargetGrpcProxy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("targetgrpcproxies").
...
func (c *targetGrpcProxies) Update(ctx context.Context, targetGrpcProxy *v1alpha1.TargetGrpcProxy, opts v1.UpdateOptions) (result *v1alpha1.TargetGrpcProxy, err error) {
	result = &v1alpha1.TargetGrpcProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targetgrpcproxies").
		Name(targetGrpcProxy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(targetGrpcProxy).
		Do(ctx).
		Into(result)
...
func (c *targetGrpcProxies) UpdateStatus(ctx context.Context, targetGrpcProxy *v1alpha1.TargetGrpcProxy, opts v1.UpdateOptions) (result *v1alpha1.TargetGrpcProxy, err error) {
	result = &v1alpha1.TargetGrpcProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targetgrpcproxies").
...
func (c *targetGrpcProxies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *targetGrpcProxies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *targetGrpcProxies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TargetGrpcProxy, err error) {
	result = &v1alpha1.TargetGrpcProxy{}
