...
func newInstanceTemplates(c *ComputeV1alpha1Client, namespace string) *instanceTemplates {
...
func (c *instanceTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InstanceTemplate, err error) {
...
func (c *instanceTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InstanceTemplateList, err error) {
...
func (c *instanceTemplates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *instanceTemplates) Create(ctx context.Context, instanceTemplate *v1alpha1.InstanceTemplate, opts v1.CreateOptions) (result *v1alpha1.InstanceTemplate, err error) {
	result = &v1alpha1.InstanceTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancetemplates").
...
func (c *instanceTemplates) Update(ctx context.Context, instanceTemplate *v1alpha1.InstanceTemplate, opts v1.UpdateOptions) (result *v1alpha1.InstanceTemplate, err error) {
	result = &v1alpha1.InstanceTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancetemplates").
...
func (c *instanceTemplates) UpdateStatus(ctx context.Context, instanceTemplate *v1alpha1.InstanceTemplate, opts v1.UpdateOptions) (result *v1alpha1.InstanceTemplate, err error) {
	result = &v1alpha1.InstanceTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancetemplates").
...
func (c *instanceTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *instanceTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *instanceTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InstanceTemplate, err error) {
	result = &v1alpha1.InstanceTemplate{}
