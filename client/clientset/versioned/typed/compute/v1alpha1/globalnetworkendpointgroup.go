...
// GlobalNetworkEndpointGroupsGetter has a method to return a GlobalNetworkEndpointGroupInterface.
...
// globalNetworkEndpointGroups implements GlobalNetworkEndpointGroupInterface
type globalNetworkEndpointGroups struct {
	client rest.Interface
	ns     string
}

// newGlobalNetworkEndpointGroups returns a GlobalNetworkEndpointGroups
func newGlobalNetworkEndpointGroups(c *ComputeV1alpha1Client, namespace string) *globalNetworkEndpointGroups {
	return &globalNetworkEndpointGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *globalNetworkEndpointGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlobalNetworkEndpointGroup, err error) {
	result = &v1alpha1.GlobalNetworkEndpointGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *globalNetworkEndpointGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlobalNetworkEndpointGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.GlobalNetworkEndpointGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("globalnetworkendpointgroups").
...
func (c *globalNetworkEndpointGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *globalNetworkEndpointGroups) Create(ctx context.Context, globalNetworkEndpointGroup *v1alpha1.GlobalNetworkEndpointGroup, opts v1.CreateOptions) (result *v1alpha1.GlobalNetworkEndpointGroup, err error) {
	result = &v1alpha1.GlobalNetworkEndpointGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("globalnetworkendpointgroups").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(globalNetworkEndpointGroup).
		Do(ctx).
		Into(result)
	return
}
...
func (c *globalNetworkEndpointGroups) Update(ctx context.Context, globalNetworkEndpointGroup *v1alpha1.GlobalNetworkEndpointGroup, opts v1.UpdateOptions) (result *v1alpha1.GlobalNetworkEndpointGroup, err error) {
	result = &v1alpha1.GlobalNetworkEndpointGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("globalnetworkendpointgroups").
		Name(globalNetworkEndpointGroup.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(globalNetworkEndpointGroup).
		Do(ctx).
		Into(result)
...
func (c *globalNetworkEndpointGroups) UpdateStatus(ctx context.Context, globalNetworkEndpointGroup *v1alpha1.GlobalNetworkEndpointGroup, opts v1.UpdateOptions) (result *v1alpha1.GlobalNetworkEndpointGroup, err error) {
	result = &v1alpha1.GlobalNetworkEndpointGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("globalnetworkendpointgroups").
...
func (c *globalNetworkEndpointGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *globalNetworkEndpointGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *globalNetworkEndpointGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlobalNetworkEndpointGroup, err error) {
	result = &v1alpha1.GlobalNetworkEndpointGroup{}
