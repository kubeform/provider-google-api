...
// DiskIamBindingsGetter has a method to return a DiskIamBindingInterface.
...
// diskIamBindings implements DiskIamBindingInterface
type diskIamBindings struct {
	client rest.Interface
	ns     string
}

// newDiskIamBindings returns a DiskIamBindings
func newDiskIamBindings(c *ComputeV1alpha1Client, namespace string) *diskIamBindings {
	return &diskIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *diskIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DiskIamBinding, err error) {
	result = &v1alpha1.DiskIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *diskIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DiskIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DiskIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("diskiambindings").
...
func (c *diskIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *diskIamBindings) Create(ctx context.Context, diskIamBinding *v1alpha1.DiskIamBinding, opts v1.CreateOptions) (result *v1alpha1.DiskIamBinding, err error) {
	result = &v1alpha1.DiskIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("diskiambindings").
...
func (c *diskIamBindings) Update(ctx context.Context, diskIamBinding *v1alpha1.DiskIamBinding, opts v1.UpdateOptions) (result *v1alpha1.DiskIamBinding, err error) {
	result = &v1alpha1.DiskIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskiambindings").
		Name(diskIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(diskIamBinding).
		Do(ctx).
		Into(result)
...
func (c *diskIamBindings) UpdateStatus(ctx context.Context, diskIamBinding *v1alpha1.DiskIamBinding, opts v1.UpdateOptions) (result *v1alpha1.DiskIamBinding, err error) {
	result = &v1alpha1.DiskIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskiambindings").
...
func (c *diskIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *diskIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *diskIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DiskIamBinding, err error) {
	result = &v1alpha1.DiskIamBinding{}
