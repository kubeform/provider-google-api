...
// SubnetworkIamBindingsGetter has a method to return a SubnetworkIamBindingInterface.
...
// subnetworkIamBindings implements SubnetworkIamBindingInterface
type subnetworkIamBindings struct {
	client rest.Interface
	ns     string
}

// newSubnetworkIamBindings returns a SubnetworkIamBindings
func newSubnetworkIamBindings(c *ComputeV1alpha1Client, namespace string) *subnetworkIamBindings {
	return &subnetworkIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *subnetworkIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SubnetworkIamBinding, err error) {
	result = &v1alpha1.SubnetworkIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *subnetworkIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SubnetworkIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SubnetworkIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("subnetworkiambindings").
...
func (c *subnetworkIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *subnetworkIamBindings) Create(ctx context.Context, subnetworkIamBinding *v1alpha1.SubnetworkIamBinding, opts v1.CreateOptions) (result *v1alpha1.SubnetworkIamBinding, err error) {
	result = &v1alpha1.SubnetworkIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("subnetworkiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(subnetworkIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *subnetworkIamBindings) Update(ctx context.Context, subnetworkIamBinding *v1alpha1.SubnetworkIamBinding, opts v1.UpdateOptions) (result *v1alpha1.SubnetworkIamBinding, err error) {
	result = &v1alpha1.SubnetworkIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subnetworkiambindings").
		Name(subnetworkIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(subnetworkIamBinding).
		Do(ctx).
		Into(result)
...
func (c *subnetworkIamBindings) UpdateStatus(ctx context.Context, subnetworkIamBinding *v1alpha1.SubnetworkIamBinding, opts v1.UpdateOptions) (result *v1alpha1.SubnetworkIamBinding, err error) {
	result = &v1alpha1.SubnetworkIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subnetworkiambindings").
...
func (c *subnetworkIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *subnetworkIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *subnetworkIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SubnetworkIamBinding, err error) {
	result = &v1alpha1.SubnetworkIamBinding{}
