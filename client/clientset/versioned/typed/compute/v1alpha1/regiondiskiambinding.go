...
// RegionDiskIamBindingsGetter has a method to return a RegionDiskIamBindingInterface.
...
// regionDiskIamBindings implements RegionDiskIamBindingInterface
type regionDiskIamBindings struct {
	client rest.Interface
	ns     string
}

// newRegionDiskIamBindings returns a RegionDiskIamBindings
func newRegionDiskIamBindings(c *ComputeV1alpha1Client, namespace string) *regionDiskIamBindings {
	return &regionDiskIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *regionDiskIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegionDiskIamBinding, err error) {
	result = &v1alpha1.RegionDiskIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *regionDiskIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegionDiskIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RegionDiskIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("regiondiskiambindings").
...
func (c *regionDiskIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *regionDiskIamBindings) Create(ctx context.Context, regionDiskIamBinding *v1alpha1.RegionDiskIamBinding, opts v1.CreateOptions) (result *v1alpha1.RegionDiskIamBinding, err error) {
	result = &v1alpha1.RegionDiskIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("regiondiskiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionDiskIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *regionDiskIamBindings) Update(ctx context.Context, regionDiskIamBinding *v1alpha1.RegionDiskIamBinding, opts v1.UpdateOptions) (result *v1alpha1.RegionDiskIamBinding, err error) {
	result = &v1alpha1.RegionDiskIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regiondiskiambindings").
		Name(regionDiskIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(regionDiskIamBinding).
		Do(ctx).
		Into(result)
...
func (c *regionDiskIamBindings) UpdateStatus(ctx context.Context, regionDiskIamBinding *v1alpha1.RegionDiskIamBinding, opts v1.UpdateOptions) (result *v1alpha1.RegionDiskIamBinding, err error) {
	result = &v1alpha1.RegionDiskIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regiondiskiambindings").
...
func (c *regionDiskIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *regionDiskIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *regionDiskIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegionDiskIamBinding, err error) {
	result = &v1alpha1.RegionDiskIamBinding{}
