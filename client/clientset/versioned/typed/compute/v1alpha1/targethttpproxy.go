...
// TargetHTTPProxiesGetter has a method to return a TargetHTTPProxyInterface.
...
// targetHTTPProxies implements TargetHTTPProxyInterface
type targetHTTPProxies struct {
	client rest.Interface
	ns     string
}

// newTargetHTTPProxies returns a TargetHTTPProxies
func newTargetHTTPProxies(c *ComputeV1alpha1Client, namespace string) *targetHTTPProxies {
...
func (c *targetHTTPProxies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TargetHTTPProxy, err error) {
	result = &v1alpha1.TargetHTTPProxy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *targetHTTPProxies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TargetHTTPProxyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TargetHTTPProxyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("targethttpproxies").
...
func (c *targetHTTPProxies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *targetHTTPProxies) Create(ctx context.Context, targetHTTPProxy *v1alpha1.TargetHTTPProxy, opts v1.CreateOptions) (result *v1alpha1.TargetHTTPProxy, err error) {
	result = &v1alpha1.TargetHTTPProxy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("targethttpproxies").
...
func (c *targetHTTPProxies) Update(ctx context.Context, targetHTTPProxy *v1alpha1.TargetHTTPProxy, opts v1.UpdateOptions) (result *v1alpha1.TargetHTTPProxy, err error) {
	result = &v1alpha1.TargetHTTPProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targethttpproxies").
...
func (c *targetHTTPProxies) UpdateStatus(ctx context.Context, targetHTTPProxy *v1alpha1.TargetHTTPProxy, opts v1.UpdateOptions) (result *v1alpha1.TargetHTTPProxy, err error) {
	result = &v1alpha1.TargetHTTPProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targethttpproxies").
...
func (c *targetHTTPProxies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *targetHTTPProxies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *targetHTTPProxies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TargetHTTPProxy, err error) {
	result = &v1alpha1.TargetHTTPProxy{}
