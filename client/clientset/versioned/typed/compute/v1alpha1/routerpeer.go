...
// RouterPeersGetter has a method to return a RouterPeerInterface.
...
// routerPeers implements RouterPeerInterface
type routerPeers struct {
	client rest.Interface
	ns     string
}

// newRouterPeers returns a RouterPeers
func newRouterPeers(c *ComputeV1alpha1Client, namespace string) *routerPeers {
	return &routerPeers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *routerPeers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RouterPeer, err error) {
	result = &v1alpha1.RouterPeer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *routerPeers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RouterPeerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RouterPeerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("routerpeers").
...
func (c *routerPeers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *routerPeers) Create(ctx context.Context, routerPeer *v1alpha1.RouterPeer, opts v1.CreateOptions) (result *v1alpha1.RouterPeer, err error) {
	result = &v1alpha1.RouterPeer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("routerpeers").
...
func (c *routerPeers) Update(ctx context.Context, routerPeer *v1alpha1.RouterPeer, opts v1.UpdateOptions) (result *v1alpha1.RouterPeer, err error) {
	result = &v1alpha1.RouterPeer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routerpeers").
		Name(routerPeer.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(routerPeer).
		Do(ctx).
		Into(result)
...
func (c *routerPeers) UpdateStatus(ctx context.Context, routerPeer *v1alpha1.RouterPeer, opts v1.UpdateOptions) (result *v1alpha1.RouterPeer, err error) {
	result = &v1alpha1.RouterPeer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routerpeers").
...
func (c *routerPeers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *routerPeers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *routerPeers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RouterPeer, err error) {
	result = &v1alpha1.RouterPeer{}
