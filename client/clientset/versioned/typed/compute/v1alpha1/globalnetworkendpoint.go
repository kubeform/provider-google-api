...
// GlobalNetworkEndpointsGetter has a method to return a GlobalNetworkEndpointInterface.
...
// globalNetworkEndpoints implements GlobalNetworkEndpointInterface
type globalNetworkEndpoints struct {
	client rest.Interface
	ns     string
}

// newGlobalNetworkEndpoints returns a GlobalNetworkEndpoints
func newGlobalNetworkEndpoints(c *ComputeV1alpha1Client, namespace string) *globalNetworkEndpoints {
	return &globalNetworkEndpoints{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *globalNetworkEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GlobalNetworkEndpoint, err error) {
	result = &v1alpha1.GlobalNetworkEndpoint{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *globalNetworkEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GlobalNetworkEndpointList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.GlobalNetworkEndpointList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("globalnetworkendpoints").
...
func (c *globalNetworkEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *globalNetworkEndpoints) Create(ctx context.Context, globalNetworkEndpoint *v1alpha1.GlobalNetworkEndpoint, opts v1.CreateOptions) (result *v1alpha1.GlobalNetworkEndpoint, err error) {
	result = &v1alpha1.GlobalNetworkEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("globalnetworkendpoints").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(globalNetworkEndpoint).
		Do(ctx).
		Into(result)
	return
}
...
func (c *globalNetworkEndpoints) Update(ctx context.Context, globalNetworkEndpoint *v1alpha1.GlobalNetworkEndpoint, opts v1.UpdateOptions) (result *v1alpha1.GlobalNetworkEndpoint, err error) {
	result = &v1alpha1.GlobalNetworkEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("globalnetworkendpoints").
		Name(globalNetworkEndpoint.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(globalNetworkEndpoint).
		Do(ctx).
		Into(result)
...
func (c *globalNetworkEndpoints) UpdateStatus(ctx context.Context, globalNetworkEndpoint *v1alpha1.GlobalNetworkEndpoint, opts v1.UpdateOptions) (result *v1alpha1.GlobalNetworkEndpoint, err error) {
	result = &v1alpha1.GlobalNetworkEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("globalnetworkendpoints").
...
func (c *globalNetworkEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *globalNetworkEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *globalNetworkEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GlobalNetworkEndpoint, err error) {
	result = &v1alpha1.GlobalNetworkEndpoint{}
