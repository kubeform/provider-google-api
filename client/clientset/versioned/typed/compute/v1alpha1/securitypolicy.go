...
func newSecurityPolicies(c *ComputeV1alpha1Client, namespace string) *securityPolicies {
...
func (c *securityPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SecurityPolicyList, err error) {
