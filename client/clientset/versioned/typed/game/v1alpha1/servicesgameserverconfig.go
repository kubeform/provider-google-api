...
// ServicesGameServerConfigsGetter has a method to return a ServicesGameServerConfigInterface.
...
// servicesGameServerConfigs implements ServicesGameServerConfigInterface
type servicesGameServerConfigs struct {
	client rest.Interface
	ns     string
}

// newServicesGameServerConfigs returns a ServicesGameServerConfigs
func newServicesGameServerConfigs(c *GameV1alpha1Client, namespace string) *servicesGameServerConfigs {
	return &servicesGameServerConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *servicesGameServerConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicesGameServerConfig, err error) {
	result = &v1alpha1.ServicesGameServerConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *servicesGameServerConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicesGameServerConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServicesGameServerConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicesgameserverconfigs").
...
func (c *servicesGameServerConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicesGameServerConfigs) Create(ctx context.Context, servicesGameServerConfig *v1alpha1.ServicesGameServerConfig, opts v1.CreateOptions) (result *v1alpha1.ServicesGameServerConfig, err error) {
	result = &v1alpha1.ServicesGameServerConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicesgameserverconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicesGameServerConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *servicesGameServerConfigs) Update(ctx context.Context, servicesGameServerConfig *v1alpha1.ServicesGameServerConfig, opts v1.UpdateOptions) (result *v1alpha1.ServicesGameServerConfig, err error) {
	result = &v1alpha1.ServicesGameServerConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicesgameserverconfigs").
		Name(servicesGameServerConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicesGameServerConfig).
		Do(ctx).
		Into(result)
...
func (c *servicesGameServerConfigs) UpdateStatus(ctx context.Context, servicesGameServerConfig *v1alpha1.ServicesGameServerConfig, opts v1.UpdateOptions) (result *v1alpha1.ServicesGameServerConfig, err error) {
	result = &v1alpha1.ServicesGameServerConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicesgameserverconfigs").
...
func (c *servicesGameServerConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *servicesGameServerConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicesGameServerConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicesGameServerConfig, err error) {
	result = &v1alpha1.ServicesGameServerConfig{}
