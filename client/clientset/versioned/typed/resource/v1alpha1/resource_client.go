...
// ResourceV1alpha1Client is used to interact with features provided by the resource.google.kubeform.com group.
type ResourceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ResourceV1alpha1Client) ManagerLiens(namespace string) ManagerLienInterface {
	return newManagerLiens(c, namespace)
}
