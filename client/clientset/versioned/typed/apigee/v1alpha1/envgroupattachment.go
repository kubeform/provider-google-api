...
// EnvgroupAttachmentsGetter has a method to return a EnvgroupAttachmentInterface.
...
// envgroupAttachments implements EnvgroupAttachmentInterface
type envgroupAttachments struct {
	client rest.Interface
	ns     string
}

// newEnvgroupAttachments returns a EnvgroupAttachments
func newEnvgroupAttachments(c *ApigeeV1alpha1Client, namespace string) *envgroupAttachments {
	return &envgroupAttachments{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *envgroupAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EnvgroupAttachment, err error) {
	result = &v1alpha1.EnvgroupAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *envgroupAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EnvgroupAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EnvgroupAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("envgroupattachments").
...
func (c *envgroupAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *envgroupAttachments) Create(ctx context.Context, envgroupAttachment *v1alpha1.EnvgroupAttachment, opts v1.CreateOptions) (result *v1alpha1.EnvgroupAttachment, err error) {
	result = &v1alpha1.EnvgroupAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("envgroupattachments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(envgroupAttachment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *envgroupAttachments) Update(ctx context.Context, envgroupAttachment *v1alpha1.EnvgroupAttachment, opts v1.UpdateOptions) (result *v1alpha1.EnvgroupAttachment, err error) {
	result = &v1alpha1.EnvgroupAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("envgroupattachments").
		Name(envgroupAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(envgroupAttachment).
		Do(ctx).
		Into(result)
...
func (c *envgroupAttachments) UpdateStatus(ctx context.Context, envgroupAttachment *v1alpha1.EnvgroupAttachment, opts v1.UpdateOptions) (result *v1alpha1.EnvgroupAttachment, err error) {
	result = &v1alpha1.EnvgroupAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("envgroupattachments").
...
func (c *envgroupAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *envgroupAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *envgroupAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EnvgroupAttachment, err error) {
	result = &v1alpha1.EnvgroupAttachment{}
