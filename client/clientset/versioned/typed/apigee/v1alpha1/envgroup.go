...
// EnvgroupsGetter has a method to return a EnvgroupInterface.
...
// envgroups implements EnvgroupInterface
type envgroups struct {
	client rest.Interface
	ns     string
}

// newEnvgroups returns a Envgroups
func newEnvgroups(c *ApigeeV1alpha1Client, namespace string) *envgroups {
	return &envgroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *envgroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Envgroup, err error) {
	result = &v1alpha1.Envgroup{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("envgroups").
		Name(name).
...
func (c *envgroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EnvgroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EnvgroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("envgroups").
...
func (c *envgroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *envgroups) Create(ctx context.Context, envgroup *v1alpha1.Envgroup, opts v1.CreateOptions) (result *v1alpha1.Envgroup, err error) {
	result = &v1alpha1.Envgroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("envgroups").
...
func (c *envgroups) Update(ctx context.Context, envgroup *v1alpha1.Envgroup, opts v1.UpdateOptions) (result *v1alpha1.Envgroup, err error) {
	result = &v1alpha1.Envgroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("envgroups").
...
func (c *envgroups) UpdateStatus(ctx context.Context, envgroup *v1alpha1.Envgroup, opts v1.UpdateOptions) (result *v1alpha1.Envgroup, err error) {
	result = &v1alpha1.Envgroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("envgroups").
...
func (c *envgroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *envgroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *envgroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Envgroup, err error) {
	result = &v1alpha1.Envgroup{}
