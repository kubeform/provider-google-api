...
// BillingAccountExclusionsGetter has a method to return a BillingAccountExclusionInterface.
...
// billingAccountExclusions implements BillingAccountExclusionInterface
type billingAccountExclusions struct {
	client rest.Interface
	ns     string
}

// newBillingAccountExclusions returns a BillingAccountExclusions
func newBillingAccountExclusions(c *LoggingV1alpha1Client, namespace string) *billingAccountExclusions {
	return &billingAccountExclusions{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *billingAccountExclusions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BillingAccountExclusion, err error) {
	result = &v1alpha1.BillingAccountExclusion{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *billingAccountExclusions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BillingAccountExclusionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BillingAccountExclusionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("billingaccountexclusions").
...
func (c *billingAccountExclusions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *billingAccountExclusions) Create(ctx context.Context, billingAccountExclusion *v1alpha1.BillingAccountExclusion, opts v1.CreateOptions) (result *v1alpha1.BillingAccountExclusion, err error) {
	result = &v1alpha1.BillingAccountExclusion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("billingaccountexclusions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(billingAccountExclusion).
		Do(ctx).
		Into(result)
	return
}
...
func (c *billingAccountExclusions) Update(ctx context.Context, billingAccountExclusion *v1alpha1.BillingAccountExclusion, opts v1.UpdateOptions) (result *v1alpha1.BillingAccountExclusion, err error) {
	result = &v1alpha1.BillingAccountExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("billingaccountexclusions").
		Name(billingAccountExclusion.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(billingAccountExclusion).
		Do(ctx).
		Into(result)
...
func (c *billingAccountExclusions) UpdateStatus(ctx context.Context, billingAccountExclusion *v1alpha1.BillingAccountExclusion, opts v1.UpdateOptions) (result *v1alpha1.BillingAccountExclusion, err error) {
	result = &v1alpha1.BillingAccountExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("billingaccountexclusions").
...
func (c *billingAccountExclusions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *billingAccountExclusions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *billingAccountExclusions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BillingAccountExclusion, err error) {
	result = &v1alpha1.BillingAccountExclusion{}
