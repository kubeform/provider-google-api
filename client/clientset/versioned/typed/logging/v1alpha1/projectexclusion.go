...
// ProjectExclusionsGetter has a method to return a ProjectExclusionInterface.
...
// projectExclusions implements ProjectExclusionInterface
type projectExclusions struct {
	client rest.Interface
	ns     string
}

// newProjectExclusions returns a ProjectExclusions
func newProjectExclusions(c *LoggingV1alpha1Client, namespace string) *projectExclusions {
...
func (c *projectExclusions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProjectExclusion, err error) {
	result = &v1alpha1.ProjectExclusion{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *projectExclusions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectExclusionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProjectExclusionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projectexclusions").
...
func (c *projectExclusions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectExclusions) Create(ctx context.Context, projectExclusion *v1alpha1.ProjectExclusion, opts v1.CreateOptions) (result *v1alpha1.ProjectExclusion, err error) {
	result = &v1alpha1.ProjectExclusion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectexclusions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectExclusion).
		Do(ctx).
		Into(result)
	return
}
...
func (c *projectExclusions) Update(ctx context.Context, projectExclusion *v1alpha1.ProjectExclusion, opts v1.UpdateOptions) (result *v1alpha1.ProjectExclusion, err error) {
	result = &v1alpha1.ProjectExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectexclusions").
		Name(projectExclusion.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectExclusion).
		Do(ctx).
		Into(result)
...
func (c *projectExclusions) UpdateStatus(ctx context.Context, projectExclusion *v1alpha1.ProjectExclusion, opts v1.UpdateOptions) (result *v1alpha1.ProjectExclusion, err error) {
	result = &v1alpha1.ProjectExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectexclusions").
...
func (c *projectExclusions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *projectExclusions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectExclusions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProjectExclusion, err error) {
	result = &v1alpha1.ProjectExclusion{}
