...
// OrganizationSinksGetter has a method to return a OrganizationSinkInterface.
...
// organizationSinks implements OrganizationSinkInterface
type organizationSinks struct {
	client rest.Interface
	ns     string
}

// newOrganizationSinks returns a OrganizationSinks
func newOrganizationSinks(c *LoggingV1alpha1Client, namespace string) *organizationSinks {
	return &organizationSinks{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *organizationSinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OrganizationSink, err error) {
	result = &v1alpha1.OrganizationSink{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *organizationSinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OrganizationSinkList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.OrganizationSinkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("organizationsinks").
...
func (c *organizationSinks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *organizationSinks) Create(ctx context.Context, organizationSink *v1alpha1.OrganizationSink, opts v1.CreateOptions) (result *v1alpha1.OrganizationSink, err error) {
	result = &v1alpha1.OrganizationSink{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("organizationsinks").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(organizationSink).
		Do(ctx).
		Into(result)
	return
}
...
func (c *organizationSinks) Update(ctx context.Context, organizationSink *v1alpha1.OrganizationSink, opts v1.UpdateOptions) (result *v1alpha1.OrganizationSink, err error) {
	result = &v1alpha1.OrganizationSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationsinks").
		Name(organizationSink.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(organizationSink).
		Do(ctx).
		Into(result)
...
func (c *organizationSinks) UpdateStatus(ctx context.Context, organizationSink *v1alpha1.OrganizationSink, opts v1.UpdateOptions) (result *v1alpha1.OrganizationSink, err error) {
	result = &v1alpha1.OrganizationSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationsinks").
...
func (c *organizationSinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *organizationSinks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *organizationSinks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OrganizationSink, err error) {
	result = &v1alpha1.OrganizationSink{}
