...
// OrganizationBucketConfigsGetter has a method to return a OrganizationBucketConfigInterface.
...
// organizationBucketConfigs implements OrganizationBucketConfigInterface
type organizationBucketConfigs struct {
	client rest.Interface
	ns     string
}

// newOrganizationBucketConfigs returns a OrganizationBucketConfigs
func newOrganizationBucketConfigs(c *LoggingV1alpha1Client, namespace string) *organizationBucketConfigs {
	return &organizationBucketConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *organizationBucketConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OrganizationBucketConfig, err error) {
	result = &v1alpha1.OrganizationBucketConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *organizationBucketConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OrganizationBucketConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.OrganizationBucketConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("organizationbucketconfigs").
...
func (c *organizationBucketConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *organizationBucketConfigs) Create(ctx context.Context, organizationBucketConfig *v1alpha1.OrganizationBucketConfig, opts v1.CreateOptions) (result *v1alpha1.OrganizationBucketConfig, err error) {
	result = &v1alpha1.OrganizationBucketConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("organizationbucketconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(organizationBucketConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *organizationBucketConfigs) Update(ctx context.Context, organizationBucketConfig *v1alpha1.OrganizationBucketConfig, opts v1.UpdateOptions) (result *v1alpha1.OrganizationBucketConfig, err error) {
	result = &v1alpha1.OrganizationBucketConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationbucketconfigs").
		Name(organizationBucketConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(organizationBucketConfig).
		Do(ctx).
		Into(result)
...
func (c *organizationBucketConfigs) UpdateStatus(ctx context.Context, organizationBucketConfig *v1alpha1.OrganizationBucketConfig, opts v1.UpdateOptions) (result *v1alpha1.OrganizationBucketConfig, err error) {
	result = &v1alpha1.OrganizationBucketConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationbucketconfigs").
...
func (c *organizationBucketConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *organizationBucketConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *organizationBucketConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OrganizationBucketConfig, err error) {
	result = &v1alpha1.OrganizationBucketConfig{}
