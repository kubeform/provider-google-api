...
// FolderSinksGetter has a method to return a FolderSinkInterface.
...
// folderSinks implements FolderSinkInterface
type folderSinks struct {
	client rest.Interface
	ns     string
}

// newFolderSinks returns a FolderSinks
func newFolderSinks(c *LoggingV1alpha1Client, namespace string) *folderSinks {
	return &folderSinks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *folderSinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FolderSink, err error) {
	result = &v1alpha1.FolderSink{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *folderSinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FolderSinkList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FolderSinkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foldersinks").
...
func (c *folderSinks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *folderSinks) Create(ctx context.Context, folderSink *v1alpha1.FolderSink, opts v1.CreateOptions) (result *v1alpha1.FolderSink, err error) {
	result = &v1alpha1.FolderSink{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foldersinks").
...
func (c *folderSinks) Update(ctx context.Context, folderSink *v1alpha1.FolderSink, opts v1.UpdateOptions) (result *v1alpha1.FolderSink, err error) {
	result = &v1alpha1.FolderSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foldersinks").
		Name(folderSink.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(folderSink).
		Do(ctx).
		Into(result)
...
func (c *folderSinks) UpdateStatus(ctx context.Context, folderSink *v1alpha1.FolderSink, opts v1.UpdateOptions) (result *v1alpha1.FolderSink, err error) {
	result = &v1alpha1.FolderSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foldersinks").
...
func (c *folderSinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *folderSinks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *folderSinks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FolderSink, err error) {
	result = &v1alpha1.FolderSink{}
