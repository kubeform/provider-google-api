...
// ProjectBucketConfigsGetter has a method to return a ProjectBucketConfigInterface.
...
// projectBucketConfigs implements ProjectBucketConfigInterface
type projectBucketConfigs struct {
	client rest.Interface
	ns     string
}

// newProjectBucketConfigs returns a ProjectBucketConfigs
func newProjectBucketConfigs(c *LoggingV1alpha1Client, namespace string) *projectBucketConfigs {
	return &projectBucketConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *projectBucketConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProjectBucketConfig, err error) {
	result = &v1alpha1.ProjectBucketConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *projectBucketConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectBucketConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProjectBucketConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projectbucketconfigs").
...
func (c *projectBucketConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectBucketConfigs) Create(ctx context.Context, projectBucketConfig *v1alpha1.ProjectBucketConfig, opts v1.CreateOptions) (result *v1alpha1.ProjectBucketConfig, err error) {
	result = &v1alpha1.ProjectBucketConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectbucketconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectBucketConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *projectBucketConfigs) Update(ctx context.Context, projectBucketConfig *v1alpha1.ProjectBucketConfig, opts v1.UpdateOptions) (result *v1alpha1.ProjectBucketConfig, err error) {
	result = &v1alpha1.ProjectBucketConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectbucketconfigs").
		Name(projectBucketConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectBucketConfig).
		Do(ctx).
		Into(result)
...
func (c *projectBucketConfigs) UpdateStatus(ctx context.Context, projectBucketConfig *v1alpha1.ProjectBucketConfig, opts v1.UpdateOptions) (result *v1alpha1.ProjectBucketConfig, err error) {
	result = &v1alpha1.ProjectBucketConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectbucketconfigs").
...
func (c *projectBucketConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *projectBucketConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectBucketConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProjectBucketConfig, err error) {
	result = &v1alpha1.ProjectBucketConfig{}
