...
// BillingAccountSinksGetter has a method to return a BillingAccountSinkInterface.
...
// billingAccountSinks implements BillingAccountSinkInterface
type billingAccountSinks struct {
	client rest.Interface
	ns     string
}

// newBillingAccountSinks returns a BillingAccountSinks
func newBillingAccountSinks(c *LoggingV1alpha1Client, namespace string) *billingAccountSinks {
	return &billingAccountSinks{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *billingAccountSinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BillingAccountSink, err error) {
	result = &v1alpha1.BillingAccountSink{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *billingAccountSinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BillingAccountSinkList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BillingAccountSinkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("billingaccountsinks").
...
func (c *billingAccountSinks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *billingAccountSinks) Create(ctx context.Context, billingAccountSink *v1alpha1.BillingAccountSink, opts v1.CreateOptions) (result *v1alpha1.BillingAccountSink, err error) {
	result = &v1alpha1.BillingAccountSink{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("billingaccountsinks").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(billingAccountSink).
		Do(ctx).
		Into(result)
	return
}
...
func (c *billingAccountSinks) Update(ctx context.Context, billingAccountSink *v1alpha1.BillingAccountSink, opts v1.UpdateOptions) (result *v1alpha1.BillingAccountSink, err error) {
	result = &v1alpha1.BillingAccountSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("billingaccountsinks").
		Name(billingAccountSink.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(billingAccountSink).
		Do(ctx).
		Into(result)
...
func (c *billingAccountSinks) UpdateStatus(ctx context.Context, billingAccountSink *v1alpha1.BillingAccountSink, opts v1.UpdateOptions) (result *v1alpha1.BillingAccountSink, err error) {
	result = &v1alpha1.BillingAccountSink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("billingaccountsinks").
...
func (c *billingAccountSinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *billingAccountSinks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *billingAccountSinks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BillingAccountSink, err error) {
	result = &v1alpha1.BillingAccountSink{}
