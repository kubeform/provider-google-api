...
// OrganizationExclusionsGetter has a method to return a OrganizationExclusionInterface.
...
// organizationExclusions implements OrganizationExclusionInterface
type organizationExclusions struct {
	client rest.Interface
	ns     string
}

// newOrganizationExclusions returns a OrganizationExclusions
func newOrganizationExclusions(c *LoggingV1alpha1Client, namespace string) *organizationExclusions {
	return &organizationExclusions{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *organizationExclusions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OrganizationExclusion, err error) {
	result = &v1alpha1.OrganizationExclusion{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *organizationExclusions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OrganizationExclusionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.OrganizationExclusionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("organizationexclusions").
...
func (c *organizationExclusions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *organizationExclusions) Create(ctx context.Context, organizationExclusion *v1alpha1.OrganizationExclusion, opts v1.CreateOptions) (result *v1alpha1.OrganizationExclusion, err error) {
	result = &v1alpha1.OrganizationExclusion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("organizationexclusions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(organizationExclusion).
		Do(ctx).
		Into(result)
	return
}
...
func (c *organizationExclusions) Update(ctx context.Context, organizationExclusion *v1alpha1.OrganizationExclusion, opts v1.UpdateOptions) (result *v1alpha1.OrganizationExclusion, err error) {
	result = &v1alpha1.OrganizationExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationexclusions").
		Name(organizationExclusion.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(organizationExclusion).
		Do(ctx).
		Into(result)
...
func (c *organizationExclusions) UpdateStatus(ctx context.Context, organizationExclusion *v1alpha1.OrganizationExclusion, opts v1.UpdateOptions) (result *v1alpha1.OrganizationExclusion, err error) {
	result = &v1alpha1.OrganizationExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationexclusions").
...
func (c *organizationExclusions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *organizationExclusions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *organizationExclusions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OrganizationExclusion, err error) {
	result = &v1alpha1.OrganizationExclusion{}
