...
var servicesedgecacheservicesResource = schema.GroupVersionResource{Group: "network.google.kubeform.com", Version: "v1alpha1", Resource: "servicesedgecacheservices"}

var servicesedgecacheservicesKind = schema.GroupVersionKind{Group: "network.google.kubeform.com", Version: "v1alpha1", Kind: "ServicesEdgeCacheService"}
...
func (c *FakeServicesEdgeCacheServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicesEdgeCacheService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(servicesedgecacheservicesResource, c.ns, name), &v1alpha1.ServicesEdgeCacheService{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ServicesEdgeCacheService), err
}
...
func (c *FakeServicesEdgeCacheServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicesEdgeCacheServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(servicesedgecacheservicesResource, servicesedgecacheservicesKind, c.ns, opts), &v1alpha1.ServicesEdgeCacheServiceList{})
	...
	list := &v1alpha1.ServicesEdgeCacheServiceList{ListMeta: obj.(*v1alpha1.ServicesEdgeCacheServiceList).ListMeta}
	for _, item := range obj.(*v1alpha1.ServicesEdgeCacheServiceList).Items {
...
func (c *FakeServicesEdgeCacheServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(servicesedgecacheservicesResource, c.ns, opts))
...
func (c *FakeServicesEdgeCacheServices) Create(ctx context.Context, servicesEdgeCacheService *v1alpha1.ServicesEdgeCacheService, opts v1.CreateOptions) (result *v1alpha1.ServicesEdgeCacheService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(servicesedgecacheservicesResource, c.ns, servicesEdgeCacheService), &v1alpha1.ServicesEdgeCacheService{})
...
func (c *FakeServicesEdgeCacheServices) Update(ctx context.Context, servicesEdgeCacheService *v1alpha1.ServicesEdgeCacheService, opts v1.UpdateOptions) (result *v1alpha1.ServicesEdgeCacheService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(servicesedgecacheservicesResource, c.ns, servicesEdgeCacheService), &v1alpha1.ServicesEdgeCacheService{})
...
func (c *FakeServicesEdgeCacheServices) UpdateStatus(ctx context.Context, servicesEdgeCacheService *v1alpha1.ServicesEdgeCacheService, opts v1.UpdateOptions) (*v1alpha1.ServicesEdgeCacheService, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(servicesedgecacheservicesResource, "status", c.ns, servicesEdgeCacheService), &v1alpha1.ServicesEdgeCacheService{})
...
func (c *FakeServicesEdgeCacheServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(servicesedgecacheservicesResource, c.ns, name), &v1alpha1.ServicesEdgeCacheService{})
...
func (c *FakeServicesEdgeCacheServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(servicesedgecacheservicesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.ServicesEdgeCacheServiceList{})
	return err
}
...
func (c *FakeServicesEdgeCacheServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicesEdgeCacheService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(servicesedgecacheservicesResource, c.ns, name, pt, data, subresources...), &v1alpha1.ServicesEdgeCacheService{})
