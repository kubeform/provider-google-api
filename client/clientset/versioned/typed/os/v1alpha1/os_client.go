...
func NewForConfig(c *rest.Config) (*OsV1alpha1Client, error) {
	...
	return &OsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new OsV1alpha1Client for the given config and
