...
// ServiceIamMembersGetter has a method to return a ServiceIamMemberInterface.
...
// serviceIamMembers implements ServiceIamMemberInterface
type serviceIamMembers struct {
	client rest.Interface
	ns     string
}

// newServiceIamMembers returns a ServiceIamMembers
func newServiceIamMembers(c *EndpointsV1alpha1Client, namespace string) *serviceIamMembers {
	return &serviceIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *serviceIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceIamMember, err error) {
	result = &v1alpha1.ServiceIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *serviceIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServiceIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceiammembers").
...
func (c *serviceIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *serviceIamMembers) Create(ctx context.Context, serviceIamMember *v1alpha1.ServiceIamMember, opts v1.CreateOptions) (result *v1alpha1.ServiceIamMember, err error) {
	result = &v1alpha1.ServiceIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceiammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *serviceIamMembers) Update(ctx context.Context, serviceIamMember *v1alpha1.ServiceIamMember, opts v1.UpdateOptions) (result *v1alpha1.ServiceIamMember, err error) {
	result = &v1alpha1.ServiceIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceiammembers").
		Name(serviceIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceIamMember).
		Do(ctx).
		Into(result)
...
func (c *serviceIamMembers) UpdateStatus(ctx context.Context, serviceIamMember *v1alpha1.ServiceIamMember, opts v1.UpdateOptions) (result *v1alpha1.ServiceIamMember, err error) {
	result = &v1alpha1.ServiceIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceiammembers").
...
func (c *serviceIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *serviceIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *serviceIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceIamMember, err error) {
	result = &v1alpha1.ServiceIamMember{}
