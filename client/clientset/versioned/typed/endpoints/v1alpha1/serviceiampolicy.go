...
// ServiceIamPoliciesGetter has a method to return a ServiceIamPolicyInterface.
...
// serviceIamPolicies implements ServiceIamPolicyInterface
type serviceIamPolicies struct {
	client rest.Interface
	ns     string
}

// newServiceIamPolicies returns a ServiceIamPolicies
func newServiceIamPolicies(c *EndpointsV1alpha1Client, namespace string) *serviceIamPolicies {
	return &serviceIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *serviceIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceIamPolicy, err error) {
	result = &v1alpha1.ServiceIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *serviceIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServiceIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceiampolicies").
...
func (c *serviceIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *serviceIamPolicies) Create(ctx context.Context, serviceIamPolicy *v1alpha1.ServiceIamPolicy, opts v1.CreateOptions) (result *v1alpha1.ServiceIamPolicy, err error) {
	result = &v1alpha1.ServiceIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceiampolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceIamPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *serviceIamPolicies) Update(ctx context.Context, serviceIamPolicy *v1alpha1.ServiceIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.ServiceIamPolicy, err error) {
	result = &v1alpha1.ServiceIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceiampolicies").
		Name(serviceIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *serviceIamPolicies) UpdateStatus(ctx context.Context, serviceIamPolicy *v1alpha1.ServiceIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.ServiceIamPolicy, err error) {
	result = &v1alpha1.ServiceIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceiampolicies").
...
func (c *serviceIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *serviceIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *serviceIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceIamPolicy, err error) {
	result = &v1alpha1.ServiceIamPolicy{}
