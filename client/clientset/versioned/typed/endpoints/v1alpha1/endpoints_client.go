...
func NewForConfig(c *rest.Config) (*EndpointsV1alpha1Client, error) {
	...
	return &EndpointsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EndpointsV1alpha1Client for the given config and
...
func New(c rest.Interface) *EndpointsV1alpha1Client {
	return &EndpointsV1alpha1Client{c}
}
