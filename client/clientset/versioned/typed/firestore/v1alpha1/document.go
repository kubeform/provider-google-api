...
func newDocuments(c *FirestoreV1alpha1Client, namespace string) *documents {
	return &documents{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *documents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Document, err error) {
...
func (c *documents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DocumentList, err error) {
...
func (c *documents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *documents) Create(ctx context.Context, document *v1alpha1.Document, opts v1.CreateOptions) (result *v1alpha1.Document, err error) {
	result = &v1alpha1.Document{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("documents").
...
func (c *documents) Update(ctx context.Context, document *v1alpha1.Document, opts v1.UpdateOptions) (result *v1alpha1.Document, err error) {
	result = &v1alpha1.Document{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("documents").
...
func (c *documents) UpdateStatus(ctx context.Context, document *v1alpha1.Document, opts v1.UpdateOptions) (result *v1alpha1.Document, err error) {
	result = &v1alpha1.Document{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("documents").
...
func (c *documents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *documents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *documents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Document, err error) {
	result = &v1alpha1.Document{}
