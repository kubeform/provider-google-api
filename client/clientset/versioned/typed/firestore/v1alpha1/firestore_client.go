...
func NewForConfig(c *rest.Config) (*FirestoreV1alpha1Client, error) {
	...
	return &FirestoreV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new FirestoreV1alpha1Client for the given config and
...
func New(c rest.Interface) *FirestoreV1alpha1Client {
	return &FirestoreV1alpha1Client{c}
}
