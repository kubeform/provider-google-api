...
func NewForConfig(c *rest.Config) (*EventarcV1alpha1Client, error) {
	...
	return &EventarcV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EventarcV1alpha1Client for the given config and
...
func New(c rest.Interface) *EventarcV1alpha1Client {
	return &EventarcV1alpha1Client{c}
}
