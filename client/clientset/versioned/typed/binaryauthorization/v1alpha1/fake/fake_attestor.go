...
var attestorsResource = schema.GroupVersionResource{Group: "binaryauthorization.google.kubeform.com", Version: "v1alpha1", Resource: "attestors"}

var attestorsKind = schema.GroupVersionKind{Group: "binaryauthorization.google.kubeform.com", Version: "v1alpha1", Kind: "Attestor"}
...
func (c *FakeAttestors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Attestor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(attestorsResource, c.ns, name), &v1alpha1.Attestor{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Attestor), err
}
...
func (c *FakeAttestors) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AttestorList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(attestorsResource, attestorsKind, c.ns, opts), &v1alpha1.AttestorList{})
	...
	list := &v1alpha1.AttestorList{ListMeta: obj.(*v1alpha1.AttestorList).ListMeta}
	for _, item := range obj.(*v1alpha1.AttestorList).Items {
...
func (c *FakeAttestors) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAttestors) Create(ctx context.Context, attestor *v1alpha1.Attestor, opts v1.CreateOptions) (result *v1alpha1.Attestor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(attestorsResource, c.ns, attestor), &v1alpha1.Attestor{})
...
func (c *FakeAttestors) Update(ctx context.Context, attestor *v1alpha1.Attestor, opts v1.UpdateOptions) (result *v1alpha1.Attestor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(attestorsResource, c.ns, attestor), &v1alpha1.Attestor{})
...
func (c *FakeAttestors) UpdateStatus(ctx context.Context, attestor *v1alpha1.Attestor, opts v1.UpdateOptions) (*v1alpha1.Attestor, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(attestorsResource, "status", c.ns, attestor), &v1alpha1.Attestor{})
...
func (c *FakeAttestors) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(attestorsResource, c.ns, name), &v1alpha1.Attestor{})
...
func (c *FakeAttestors) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(attestorsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.AttestorList{})
	return err
}
...
func (c *FakeAttestors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Attestor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(attestorsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Attestor{})
