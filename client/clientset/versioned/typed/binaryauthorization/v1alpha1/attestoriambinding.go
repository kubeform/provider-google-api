...
// AttestorIamBindingsGetter has a method to return a AttestorIamBindingInterface.
...
// attestorIamBindings implements AttestorIamBindingInterface
type attestorIamBindings struct {
	client rest.Interface
	ns     string
}

// newAttestorIamBindings returns a AttestorIamBindings
func newAttestorIamBindings(c *BinaryauthorizationV1alpha1Client, namespace string) *attestorIamBindings {
	return &attestorIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *attestorIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AttestorIamBinding, err error) {
	result = &v1alpha1.AttestorIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *attestorIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AttestorIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AttestorIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("attestoriambindings").
...
func (c *attestorIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *attestorIamBindings) Create(ctx context.Context, attestorIamBinding *v1alpha1.AttestorIamBinding, opts v1.CreateOptions) (result *v1alpha1.AttestorIamBinding, err error) {
	result = &v1alpha1.AttestorIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("attestoriambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(attestorIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *attestorIamBindings) Update(ctx context.Context, attestorIamBinding *v1alpha1.AttestorIamBinding, opts v1.UpdateOptions) (result *v1alpha1.AttestorIamBinding, err error) {
	result = &v1alpha1.AttestorIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("attestoriambindings").
		Name(attestorIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(attestorIamBinding).
		Do(ctx).
		Into(result)
...
func (c *attestorIamBindings) UpdateStatus(ctx context.Context, attestorIamBinding *v1alpha1.AttestorIamBinding, opts v1.UpdateOptions) (result *v1alpha1.AttestorIamBinding, err error) {
	result = &v1alpha1.AttestorIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("attestoriambindings").
...
func (c *attestorIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *attestorIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *attestorIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AttestorIamBinding, err error) {
	result = &v1alpha1.AttestorIamBinding{}
