...
// AttestorIamPoliciesGetter has a method to return a AttestorIamPolicyInterface.
...
// attestorIamPolicies implements AttestorIamPolicyInterface
type attestorIamPolicies struct {
	client rest.Interface
	ns     string
}

// newAttestorIamPolicies returns a AttestorIamPolicies
func newAttestorIamPolicies(c *BinaryauthorizationV1alpha1Client, namespace string) *attestorIamPolicies {
	return &attestorIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *attestorIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AttestorIamPolicy, err error) {
	result = &v1alpha1.AttestorIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *attestorIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AttestorIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AttestorIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("attestoriampolicies").
...
func (c *attestorIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *attestorIamPolicies) Create(ctx context.Context, attestorIamPolicy *v1alpha1.AttestorIamPolicy, opts v1.CreateOptions) (result *v1alpha1.AttestorIamPolicy, err error) {
	result = &v1alpha1.AttestorIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("attestoriampolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(attestorIamPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *attestorIamPolicies) Update(ctx context.Context, attestorIamPolicy *v1alpha1.AttestorIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.AttestorIamPolicy, err error) {
	result = &v1alpha1.AttestorIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("attestoriampolicies").
		Name(attestorIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(attestorIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *attestorIamPolicies) UpdateStatus(ctx context.Context, attestorIamPolicy *v1alpha1.AttestorIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.AttestorIamPolicy, err error) {
	result = &v1alpha1.AttestorIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("attestoriampolicies").
...
func (c *attestorIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *attestorIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *attestorIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AttestorIamPolicy, err error) {
	result = &v1alpha1.AttestorIamPolicy{}
