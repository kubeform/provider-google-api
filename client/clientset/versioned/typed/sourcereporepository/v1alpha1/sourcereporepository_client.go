...
func (c *SourcereporepositoryV1alpha1Client) IamBindings(namespace string) IamBindingInterface {
	return newIamBindings(c, namespace)
}

func (c *SourcereporepositoryV1alpha1Client) IamMembers(namespace string) IamMemberInterface {
	return newIamMembers(c, namespace)
}

func (c *SourcereporepositoryV1alpha1Client) IamPolicies(namespace string) IamPolicyInterface {
...
func NewForConfig(c *rest.Config) (*SourcereporepositoryV1alpha1Client, error) {
	config := *c
	...
	return &SourcereporepositoryV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SourcereporepositoryV1alpha1Client for the given config and
...
func New(c rest.Interface) *SourcereporepositoryV1alpha1Client {
	return &SourcereporepositoryV1alpha1Client{c}
}
...
func (c *SourcereporepositoryV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
