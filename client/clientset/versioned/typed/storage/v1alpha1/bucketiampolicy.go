...
// BucketIamPoliciesGetter has a method to return a BucketIamPolicyInterface.
...
// bucketIamPolicies implements BucketIamPolicyInterface
type bucketIamPolicies struct {
	client rest.Interface
	ns     string
}

// newBucketIamPolicies returns a BucketIamPolicies
func newBucketIamPolicies(c *StorageV1alpha1Client, namespace string) *bucketIamPolicies {
	return &bucketIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *bucketIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BucketIamPolicy, err error) {
	result = &v1alpha1.BucketIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *bucketIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BucketIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BucketIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bucketiampolicies").
...
func (c *bucketIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *bucketIamPolicies) Create(ctx context.Context, bucketIamPolicy *v1alpha1.BucketIamPolicy, opts v1.CreateOptions) (result *v1alpha1.BucketIamPolicy, err error) {
	result = &v1alpha1.BucketIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bucketiampolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bucketIamPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *bucketIamPolicies) Update(ctx context.Context, bucketIamPolicy *v1alpha1.BucketIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.BucketIamPolicy, err error) {
	result = &v1alpha1.BucketIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketiampolicies").
		Name(bucketIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bucketIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *bucketIamPolicies) UpdateStatus(ctx context.Context, bucketIamPolicy *v1alpha1.BucketIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.BucketIamPolicy, err error) {
	result = &v1alpha1.BucketIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketiampolicies").
...
func (c *bucketIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *bucketIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *bucketIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BucketIamPolicy, err error) {
	result = &v1alpha1.BucketIamPolicy{}
