...
// ObjectACLsGetter has a method to return a ObjectACLInterface.
...
// objectACLs implements ObjectACLInterface
type objectACLs struct {
	client rest.Interface
	ns     string
}

// newObjectACLs returns a ObjectACLs
func newObjectACLs(c *StorageV1alpha1Client, namespace string) *objectACLs {
	return &objectACLs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *objectACLs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ObjectACL, err error) {
	result = &v1alpha1.ObjectACL{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("objectacls").
		Name(name).
...
func (c *objectACLs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ObjectACLList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ObjectACLList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("objectacls").
...
func (c *objectACLs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *objectACLs) Create(ctx context.Context, objectACL *v1alpha1.ObjectACL, opts v1.CreateOptions) (result *v1alpha1.ObjectACL, err error) {
	result = &v1alpha1.ObjectACL{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("objectacls").
...
func (c *objectACLs) Update(ctx context.Context, objectACL *v1alpha1.ObjectACL, opts v1.UpdateOptions) (result *v1alpha1.ObjectACL, err error) {
	result = &v1alpha1.ObjectACL{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectacls").
...
func (c *objectACLs) UpdateStatus(ctx context.Context, objectACL *v1alpha1.ObjectACL, opts v1.UpdateOptions) (result *v1alpha1.ObjectACL, err error) {
	result = &v1alpha1.ObjectACL{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectacls").
...
func (c *objectACLs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *objectACLs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *objectACLs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ObjectACL, err error) {
	result = &v1alpha1.ObjectACL{}
