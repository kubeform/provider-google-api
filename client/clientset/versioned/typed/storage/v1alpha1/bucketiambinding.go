...
// BucketIamBindingsGetter has a method to return a BucketIamBindingInterface.
...
// bucketIamBindings implements BucketIamBindingInterface
type bucketIamBindings struct {
	client rest.Interface
	ns     string
}

// newBucketIamBindings returns a BucketIamBindings
func newBucketIamBindings(c *StorageV1alpha1Client, namespace string) *bucketIamBindings {
	return &bucketIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *bucketIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BucketIamBinding, err error) {
	result = &v1alpha1.BucketIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *bucketIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BucketIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BucketIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bucketiambindings").
...
func (c *bucketIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *bucketIamBindings) Create(ctx context.Context, bucketIamBinding *v1alpha1.BucketIamBinding, opts v1.CreateOptions) (result *v1alpha1.BucketIamBinding, err error) {
	result = &v1alpha1.BucketIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bucketiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bucketIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *bucketIamBindings) Update(ctx context.Context, bucketIamBinding *v1alpha1.BucketIamBinding, opts v1.UpdateOptions) (result *v1alpha1.BucketIamBinding, err error) {
	result = &v1alpha1.BucketIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketiambindings").
		Name(bucketIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bucketIamBinding).
		Do(ctx).
		Into(result)
...
func (c *bucketIamBindings) UpdateStatus(ctx context.Context, bucketIamBinding *v1alpha1.BucketIamBinding, opts v1.UpdateOptions) (result *v1alpha1.BucketIamBinding, err error) {
	result = &v1alpha1.BucketIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketiambindings").
...
func (c *bucketIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *bucketIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *bucketIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BucketIamBinding, err error) {
	result = &v1alpha1.BucketIamBinding{}
