...
// ObjectAccessControlsGetter has a method to return a ObjectAccessControlInterface.
...
// objectAccessControls implements ObjectAccessControlInterface
type objectAccessControls struct {
	client rest.Interface
	ns     string
}

// newObjectAccessControls returns a ObjectAccessControls
func newObjectAccessControls(c *StorageV1alpha1Client, namespace string) *objectAccessControls {
...
func (c *objectAccessControls) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ObjectAccessControl, err error) {
	result = &v1alpha1.ObjectAccessControl{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *objectAccessControls) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ObjectAccessControlList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ObjectAccessControlList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("objectaccesscontrols").
...
func (c *objectAccessControls) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *objectAccessControls) Create(ctx context.Context, objectAccessControl *v1alpha1.ObjectAccessControl, opts v1.CreateOptions) (result *v1alpha1.ObjectAccessControl, err error) {
	result = &v1alpha1.ObjectAccessControl{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("objectaccesscontrols").
...
func (c *objectAccessControls) Update(ctx context.Context, objectAccessControl *v1alpha1.ObjectAccessControl, opts v1.UpdateOptions) (result *v1alpha1.ObjectAccessControl, err error) {
	result = &v1alpha1.ObjectAccessControl{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectaccesscontrols").
		Name(objectAccessControl.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(objectAccessControl).
		Do(ctx).
		Into(result)
...
func (c *objectAccessControls) UpdateStatus(ctx context.Context, objectAccessControl *v1alpha1.ObjectAccessControl, opts v1.UpdateOptions) (result *v1alpha1.ObjectAccessControl, err error) {
	result = &v1alpha1.ObjectAccessControl{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectaccesscontrols").
...
func (c *objectAccessControls) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *objectAccessControls) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *objectAccessControls) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ObjectAccessControl, err error) {
	result = &v1alpha1.ObjectAccessControl{}
