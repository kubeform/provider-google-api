...
// TransferJobsGetter has a method to return a TransferJobInterface.
...
// transferJobs implements TransferJobInterface
type transferJobs struct {
	client rest.Interface
	ns     string
}

// newTransferJobs returns a TransferJobs
func newTransferJobs(c *StorageV1alpha1Client, namespace string) *transferJobs {
	return &transferJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *transferJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TransferJob, err error) {
	result = &v1alpha1.TransferJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *transferJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TransferJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TransferJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("transferjobs").
...
func (c *transferJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *transferJobs) Create(ctx context.Context, transferJob *v1alpha1.TransferJob, opts v1.CreateOptions) (result *v1alpha1.TransferJob, err error) {
	result = &v1alpha1.TransferJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("transferjobs").
...
func (c *transferJobs) Update(ctx context.Context, transferJob *v1alpha1.TransferJob, opts v1.UpdateOptions) (result *v1alpha1.TransferJob, err error) {
	result = &v1alpha1.TransferJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transferjobs").
...
func (c *transferJobs) UpdateStatus(ctx context.Context, transferJob *v1alpha1.TransferJob, opts v1.UpdateOptions) (result *v1alpha1.TransferJob, err error) {
	result = &v1alpha1.TransferJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transferjobs").
...
func (c *transferJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *transferJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *transferJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TransferJob, err error) {
	result = &v1alpha1.TransferJob{}
