...
// HmacKeysGetter has a method to return a HmacKeyInterface.
...
// hmacKeys implements HmacKeyInterface
type hmacKeys struct {
	client rest.Interface
	ns     string
}

// newHmacKeys returns a HmacKeys
func newHmacKeys(c *StorageV1alpha1Client, namespace string) *hmacKeys {
	return &hmacKeys{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *hmacKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HmacKey, err error) {
	result = &v1alpha1.HmacKey{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hmackeys").
		Name(name).
...
func (c *hmacKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HmacKeyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HmacKeyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hmackeys").
...
func (c *hmacKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hmacKeys) Create(ctx context.Context, hmacKey *v1alpha1.HmacKey, opts v1.CreateOptions) (result *v1alpha1.HmacKey, err error) {
	result = &v1alpha1.HmacKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hmackeys").
...
func (c *hmacKeys) Update(ctx context.Context, hmacKey *v1alpha1.HmacKey, opts v1.UpdateOptions) (result *v1alpha1.HmacKey, err error) {
	result = &v1alpha1.HmacKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hmackeys").
...
func (c *hmacKeys) UpdateStatus(ctx context.Context, hmacKey *v1alpha1.HmacKey, opts v1.UpdateOptions) (result *v1alpha1.HmacKey, err error) {
	result = &v1alpha1.HmacKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hmackeys").
...
func (c *hmacKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hmacKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hmacKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HmacKey, err error) {
	result = &v1alpha1.HmacKey{}
