...
// BucketIamMembersGetter has a method to return a BucketIamMemberInterface.
...
// bucketIamMembers implements BucketIamMemberInterface
type bucketIamMembers struct {
	client rest.Interface
	ns     string
}

// newBucketIamMembers returns a BucketIamMembers
func newBucketIamMembers(c *StorageV1alpha1Client, namespace string) *bucketIamMembers {
	return &bucketIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *bucketIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BucketIamMember, err error) {
	result = &v1alpha1.BucketIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *bucketIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BucketIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BucketIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bucketiammembers").
...
func (c *bucketIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *bucketIamMembers) Create(ctx context.Context, bucketIamMember *v1alpha1.BucketIamMember, opts v1.CreateOptions) (result *v1alpha1.BucketIamMember, err error) {
	result = &v1alpha1.BucketIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bucketiammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bucketIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *bucketIamMembers) Update(ctx context.Context, bucketIamMember *v1alpha1.BucketIamMember, opts v1.UpdateOptions) (result *v1alpha1.BucketIamMember, err error) {
	result = &v1alpha1.BucketIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketiammembers").
		Name(bucketIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bucketIamMember).
		Do(ctx).
		Into(result)
...
func (c *bucketIamMembers) UpdateStatus(ctx context.Context, bucketIamMember *v1alpha1.BucketIamMember, opts v1.UpdateOptions) (result *v1alpha1.BucketIamMember, err error) {
	result = &v1alpha1.BucketIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketiammembers").
...
func (c *bucketIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *bucketIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *bucketIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BucketIamMember, err error) {
	result = &v1alpha1.BucketIamMember{}
