...
var objectaclsResource = schema.GroupVersionResource{Group: "storage.google.kubeform.com", Version: "v1alpha1", Resource: "objectacls"}

var objectaclsKind = schema.GroupVersionKind{Group: "storage.google.kubeform.com", Version: "v1alpha1", Kind: "ObjectACL"}
...
func (c *FakeObjectACLs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ObjectACL, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(objectaclsResource, c.ns, name), &v1alpha1.ObjectACL{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ObjectACL), err
}
...
func (c *FakeObjectACLs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ObjectACLList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(objectaclsResource, objectaclsKind, c.ns, opts), &v1alpha1.ObjectACLList{})
	...
	list := &v1alpha1.ObjectACLList{ListMeta: obj.(*v1alpha1.ObjectACLList).ListMeta}
	for _, item := range obj.(*v1alpha1.ObjectACLList).Items {
...
func (c *FakeObjectACLs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(objectaclsResource, c.ns, opts))
...
func (c *FakeObjectACLs) Create(ctx context.Context, objectACL *v1alpha1.ObjectACL, opts v1.CreateOptions) (result *v1alpha1.ObjectACL, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(objectaclsResource, c.ns, objectACL), &v1alpha1.ObjectACL{})
...
func (c *FakeObjectACLs) Update(ctx context.Context, objectACL *v1alpha1.ObjectACL, opts v1.UpdateOptions) (result *v1alpha1.ObjectACL, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(objectaclsResource, c.ns, objectACL), &v1alpha1.ObjectACL{})
...
func (c *FakeObjectACLs) UpdateStatus(ctx context.Context, objectACL *v1alpha1.ObjectACL, opts v1.UpdateOptions) (*v1alpha1.ObjectACL, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(objectaclsResource, "status", c.ns, objectACL), &v1alpha1.ObjectACL{})
...
func (c *FakeObjectACLs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(objectaclsResource, c.ns, name), &v1alpha1.ObjectACL{})
...
func (c *FakeObjectACLs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(objectaclsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.ObjectACLList{})
	return err
}
...
func (c *FakeObjectACLs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ObjectACL, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(objectaclsResource, c.ns, name, pt, data, subresources...), &v1alpha1.ObjectACL{})
