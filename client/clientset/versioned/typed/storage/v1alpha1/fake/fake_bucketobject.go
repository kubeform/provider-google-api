...
var bucketobjectsResource = schema.GroupVersionResource{Group: "storage.google.kubeform.com", Version: "v1alpha1", Resource: "bucketobjects"}

var bucketobjectsKind = schema.GroupVersionKind{Group: "storage.google.kubeform.com", Version: "v1alpha1", Kind: "BucketObject"}
...
func (c *FakeBucketObjects) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BucketObject, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(bucketobjectsResource, c.ns, name), &v1alpha1.BucketObject{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.BucketObject), err
}
...
func (c *FakeBucketObjects) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BucketObjectList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(bucketobjectsResource, bucketobjectsKind, c.ns, opts), &v1alpha1.BucketObjectList{})
	...
	list := &v1alpha1.BucketObjectList{ListMeta: obj.(*v1alpha1.BucketObjectList).ListMeta}
	for _, item := range obj.(*v1alpha1.BucketObjectList).Items {
...
func (c *FakeBucketObjects) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(bucketobjectsResource, c.ns, opts))
...
func (c *FakeBucketObjects) Create(ctx context.Context, bucketObject *v1alpha1.BucketObject, opts v1.CreateOptions) (result *v1alpha1.BucketObject, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(bucketobjectsResource, c.ns, bucketObject), &v1alpha1.BucketObject{})
...
func (c *FakeBucketObjects) Update(ctx context.Context, bucketObject *v1alpha1.BucketObject, opts v1.UpdateOptions) (result *v1alpha1.BucketObject, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(bucketobjectsResource, c.ns, bucketObject), &v1alpha1.BucketObject{})
...
func (c *FakeBucketObjects) UpdateStatus(ctx context.Context, bucketObject *v1alpha1.BucketObject, opts v1.UpdateOptions) (*v1alpha1.BucketObject, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(bucketobjectsResource, "status", c.ns, bucketObject), &v1alpha1.BucketObject{})
...
func (c *FakeBucketObjects) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(bucketobjectsResource, c.ns, name), &v1alpha1.BucketObject{})
...
func (c *FakeBucketObjects) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(bucketobjectsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.BucketObjectList{})
	return err
}
...
func (c *FakeBucketObjects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BucketObject, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(bucketobjectsResource, c.ns, name, pt, data, subresources...), &v1alpha1.BucketObject{})
