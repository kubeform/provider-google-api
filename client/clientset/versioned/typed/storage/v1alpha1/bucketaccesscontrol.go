...
// BucketAccessControlsGetter has a method to return a BucketAccessControlInterface.
...
// bucketAccessControls implements BucketAccessControlInterface
type bucketAccessControls struct {
	client rest.Interface
	ns     string
}

// newBucketAccessControls returns a BucketAccessControls
func newBucketAccessControls(c *StorageV1alpha1Client, namespace string) *bucketAccessControls {
...
func (c *bucketAccessControls) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BucketAccessControl, err error) {
	result = &v1alpha1.BucketAccessControl{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *bucketAccessControls) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BucketAccessControlList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BucketAccessControlList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bucketaccesscontrols").
...
func (c *bucketAccessControls) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *bucketAccessControls) Create(ctx context.Context, bucketAccessControl *v1alpha1.BucketAccessControl, opts v1.CreateOptions) (result *v1alpha1.BucketAccessControl, err error) {
	result = &v1alpha1.BucketAccessControl{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bucketaccesscontrols").
...
func (c *bucketAccessControls) Update(ctx context.Context, bucketAccessControl *v1alpha1.BucketAccessControl, opts v1.UpdateOptions) (result *v1alpha1.BucketAccessControl, err error) {
	result = &v1alpha1.BucketAccessControl{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketaccesscontrols").
		Name(bucketAccessControl.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bucketAccessControl).
		Do(ctx).
		Into(result)
...
func (c *bucketAccessControls) UpdateStatus(ctx context.Context, bucketAccessControl *v1alpha1.BucketAccessControl, opts v1.UpdateOptions) (result *v1alpha1.BucketAccessControl, err error) {
	result = &v1alpha1.BucketAccessControl{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketaccesscontrols").
...
func (c *bucketAccessControls) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *bucketAccessControls) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *bucketAccessControls) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BucketAccessControl, err error) {
	result = &v1alpha1.BucketAccessControl{}
