...
// KeyRingIamPoliciesGetter has a method to return a KeyRingIamPolicyInterface.
...
// keyRingIamPolicies implements KeyRingIamPolicyInterface
type keyRingIamPolicies struct {
	client rest.Interface
	ns     string
}

// newKeyRingIamPolicies returns a KeyRingIamPolicies
func newKeyRingIamPolicies(c *KmsV1alpha1Client, namespace string) *keyRingIamPolicies {
	return &keyRingIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *keyRingIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KeyRingIamPolicy, err error) {
	result = &v1alpha1.KeyRingIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *keyRingIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KeyRingIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KeyRingIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("keyringiampolicies").
...
func (c *keyRingIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *keyRingIamPolicies) Create(ctx context.Context, keyRingIamPolicy *v1alpha1.KeyRingIamPolicy, opts v1.CreateOptions) (result *v1alpha1.KeyRingIamPolicy, err error) {
	result = &v1alpha1.KeyRingIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("keyringiampolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(keyRingIamPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *keyRingIamPolicies) Update(ctx context.Context, keyRingIamPolicy *v1alpha1.KeyRingIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.KeyRingIamPolicy, err error) {
	result = &v1alpha1.KeyRingIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyringiampolicies").
		Name(keyRingIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(keyRingIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *keyRingIamPolicies) UpdateStatus(ctx context.Context, keyRingIamPolicy *v1alpha1.KeyRingIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.KeyRingIamPolicy, err error) {
	result = &v1alpha1.KeyRingIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyringiampolicies").
...
func (c *keyRingIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *keyRingIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *keyRingIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KeyRingIamPolicy, err error) {
	result = &v1alpha1.KeyRingIamPolicy{}
