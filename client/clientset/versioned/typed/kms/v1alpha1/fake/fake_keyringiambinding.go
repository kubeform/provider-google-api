...
var keyringiambindingsResource = schema.GroupVersionResource{Group: "kms.google.kubeform.com", Version: "v1alpha1", Resource: "keyringiambindings"}

var keyringiambindingsKind = schema.GroupVersionKind{Group: "kms.google.kubeform.com", Version: "v1alpha1", Kind: "KeyRingIamBinding"}
...
func (c *FakeKeyRingIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KeyRingIamBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(keyringiambindingsResource, c.ns, name), &v1alpha1.KeyRingIamBinding{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.KeyRingIamBinding), err
}
...
func (c *FakeKeyRingIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KeyRingIamBindingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(keyringiambindingsResource, keyringiambindingsKind, c.ns, opts), &v1alpha1.KeyRingIamBindingList{})
	...
	list := &v1alpha1.KeyRingIamBindingList{ListMeta: obj.(*v1alpha1.KeyRingIamBindingList).ListMeta}
	for _, item := range obj.(*v1alpha1.KeyRingIamBindingList).Items {
...
func (c *FakeKeyRingIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(keyringiambindingsResource, c.ns, opts))
...
func (c *FakeKeyRingIamBindings) Create(ctx context.Context, keyRingIamBinding *v1alpha1.KeyRingIamBinding, opts v1.CreateOptions) (result *v1alpha1.KeyRingIamBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(keyringiambindingsResource, c.ns, keyRingIamBinding), &v1alpha1.KeyRingIamBinding{})
...
func (c *FakeKeyRingIamBindings) Update(ctx context.Context, keyRingIamBinding *v1alpha1.KeyRingIamBinding, opts v1.UpdateOptions) (result *v1alpha1.KeyRingIamBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(keyringiambindingsResource, c.ns, keyRingIamBinding), &v1alpha1.KeyRingIamBinding{})
...
func (c *FakeKeyRingIamBindings) UpdateStatus(ctx context.Context, keyRingIamBinding *v1alpha1.KeyRingIamBinding, opts v1.UpdateOptions) (*v1alpha1.KeyRingIamBinding, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(keyringiambindingsResource, "status", c.ns, keyRingIamBinding), &v1alpha1.KeyRingIamBinding{})
...
func (c *FakeKeyRingIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(keyringiambindingsResource, c.ns, name), &v1alpha1.KeyRingIamBinding{})
...
func (c *FakeKeyRingIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(keyringiambindingsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.KeyRingIamBindingList{})
	return err
}
...
func (c *FakeKeyRingIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KeyRingIamBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(keyringiambindingsResource, c.ns, name, pt, data, subresources...), &v1alpha1.KeyRingIamBinding{})
