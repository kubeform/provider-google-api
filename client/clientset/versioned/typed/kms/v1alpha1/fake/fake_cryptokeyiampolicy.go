...
var cryptokeyiampoliciesResource = schema.GroupVersionResource{Group: "kms.google.kubeform.com", Version: "v1alpha1", Resource: "cryptokeyiampolicies"}

var cryptokeyiampoliciesKind = schema.GroupVersionKind{Group: "kms.google.kubeform.com", Version: "v1alpha1", Kind: "CryptoKeyIamPolicy"}
...
func (c *FakeCryptoKeyIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CryptoKeyIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(cryptokeyiampoliciesResource, c.ns, name), &v1alpha1.CryptoKeyIamPolicy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CryptoKeyIamPolicy), err
}
...
func (c *FakeCryptoKeyIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CryptoKeyIamPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(cryptokeyiampoliciesResource, cryptokeyiampoliciesKind, c.ns, opts), &v1alpha1.CryptoKeyIamPolicyList{})
	...
	list := &v1alpha1.CryptoKeyIamPolicyList{ListMeta: obj.(*v1alpha1.CryptoKeyIamPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.CryptoKeyIamPolicyList).Items {
...
func (c *FakeCryptoKeyIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(cryptokeyiampoliciesResource, c.ns, opts))
...
func (c *FakeCryptoKeyIamPolicies) Create(ctx context.Context, cryptoKeyIamPolicy *v1alpha1.CryptoKeyIamPolicy, opts v1.CreateOptions) (result *v1alpha1.CryptoKeyIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(cryptokeyiampoliciesResource, c.ns, cryptoKeyIamPolicy), &v1alpha1.CryptoKeyIamPolicy{})
...
func (c *FakeCryptoKeyIamPolicies) Update(ctx context.Context, cryptoKeyIamPolicy *v1alpha1.CryptoKeyIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.CryptoKeyIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(cryptokeyiampoliciesResource, c.ns, cryptoKeyIamPolicy), &v1alpha1.CryptoKeyIamPolicy{})
...
func (c *FakeCryptoKeyIamPolicies) UpdateStatus(ctx context.Context, cryptoKeyIamPolicy *v1alpha1.CryptoKeyIamPolicy, opts v1.UpdateOptions) (*v1alpha1.CryptoKeyIamPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(cryptokeyiampoliciesResource, "status", c.ns, cryptoKeyIamPolicy), &v1alpha1.CryptoKeyIamPolicy{})
...
func (c *FakeCryptoKeyIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(cryptokeyiampoliciesResource, c.ns, name), &v1alpha1.CryptoKeyIamPolicy{})
...
func (c *FakeCryptoKeyIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(cryptokeyiampoliciesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.CryptoKeyIamPolicyList{})
	return err
}
...
func (c *FakeCryptoKeyIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CryptoKeyIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(cryptokeyiampoliciesResource, c.ns, name, pt, data, subresources...), &v1alpha1.CryptoKeyIamPolicy{})
