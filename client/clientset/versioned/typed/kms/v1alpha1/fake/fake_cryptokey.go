...
var cryptokeysResource = schema.GroupVersionResource{Group: "kms.google.kubeform.com", Version: "v1alpha1", Resource: "cryptokeys"}

var cryptokeysKind = schema.GroupVersionKind{Group: "kms.google.kubeform.com", Version: "v1alpha1", Kind: "CryptoKey"}
...
func (c *FakeCryptoKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CryptoKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(cryptokeysResource, c.ns, name), &v1alpha1.CryptoKey{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CryptoKey), err
}
...
func (c *FakeCryptoKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CryptoKeyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(cryptokeysResource, cryptokeysKind, c.ns, opts), &v1alpha1.CryptoKeyList{})
	...
	list := &v1alpha1.CryptoKeyList{ListMeta: obj.(*v1alpha1.CryptoKeyList).ListMeta}
	for _, item := range obj.(*v1alpha1.CryptoKeyList).Items {
...
func (c *FakeCryptoKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(cryptokeysResource, c.ns, opts))
...
func (c *FakeCryptoKeys) Create(ctx context.Context, cryptoKey *v1alpha1.CryptoKey, opts v1.CreateOptions) (result *v1alpha1.CryptoKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(cryptokeysResource, c.ns, cryptoKey), &v1alpha1.CryptoKey{})
...
func (c *FakeCryptoKeys) Update(ctx context.Context, cryptoKey *v1alpha1.CryptoKey, opts v1.UpdateOptions) (result *v1alpha1.CryptoKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(cryptokeysResource, c.ns, cryptoKey), &v1alpha1.CryptoKey{})
...
func (c *FakeCryptoKeys) UpdateStatus(ctx context.Context, cryptoKey *v1alpha1.CryptoKey, opts v1.UpdateOptions) (*v1alpha1.CryptoKey, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(cryptokeysResource, "status", c.ns, cryptoKey), &v1alpha1.CryptoKey{})
...
func (c *FakeCryptoKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(cryptokeysResource, c.ns, name), &v1alpha1.CryptoKey{})
...
func (c *FakeCryptoKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(cryptokeysResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.CryptoKeyList{})
	return err
}
...
func (c *FakeCryptoKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CryptoKey, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(cryptokeysResource, c.ns, name, pt, data, subresources...), &v1alpha1.CryptoKey{})
