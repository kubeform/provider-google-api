...
// KeyRingImportJobsGetter has a method to return a KeyRingImportJobInterface.
...
// keyRingImportJobs implements KeyRingImportJobInterface
type keyRingImportJobs struct {
	client rest.Interface
	ns     string
}

// newKeyRingImportJobs returns a KeyRingImportJobs
func newKeyRingImportJobs(c *KmsV1alpha1Client, namespace string) *keyRingImportJobs {
	return &keyRingImportJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *keyRingImportJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KeyRingImportJob, err error) {
	result = &v1alpha1.KeyRingImportJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *keyRingImportJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KeyRingImportJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KeyRingImportJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("keyringimportjobs").
...
func (c *keyRingImportJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *keyRingImportJobs) Create(ctx context.Context, keyRingImportJob *v1alpha1.KeyRingImportJob, opts v1.CreateOptions) (result *v1alpha1.KeyRingImportJob, err error) {
	result = &v1alpha1.KeyRingImportJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("keyringimportjobs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(keyRingImportJob).
		Do(ctx).
		Into(result)
	return
}
...
func (c *keyRingImportJobs) Update(ctx context.Context, keyRingImportJob *v1alpha1.KeyRingImportJob, opts v1.UpdateOptions) (result *v1alpha1.KeyRingImportJob, err error) {
	result = &v1alpha1.KeyRingImportJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyringimportjobs").
		Name(keyRingImportJob.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(keyRingImportJob).
		Do(ctx).
		Into(result)
...
func (c *keyRingImportJobs) UpdateStatus(ctx context.Context, keyRingImportJob *v1alpha1.KeyRingImportJob, opts v1.UpdateOptions) (result *v1alpha1.KeyRingImportJob, err error) {
	result = &v1alpha1.KeyRingImportJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyringimportjobs").
...
func (c *keyRingImportJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *keyRingImportJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *keyRingImportJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KeyRingImportJob, err error) {
	result = &v1alpha1.KeyRingImportJob{}
