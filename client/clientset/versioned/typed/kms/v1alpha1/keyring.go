...
// KeyRingsGetter has a method to return a KeyRingInterface.
...
// keyRings implements KeyRingInterface
type keyRings struct {
	client rest.Interface
	ns     string
}

// newKeyRings returns a KeyRings
func newKeyRings(c *KmsV1alpha1Client, namespace string) *keyRings {
	return &keyRings{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *keyRings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KeyRing, err error) {
	result = &v1alpha1.KeyRing{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("keyrings").
		Name(name).
...
func (c *keyRings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KeyRingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KeyRingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("keyrings").
...
func (c *keyRings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *keyRings) Create(ctx context.Context, keyRing *v1alpha1.KeyRing, opts v1.CreateOptions) (result *v1alpha1.KeyRing, err error) {
	result = &v1alpha1.KeyRing{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("keyrings").
...
func (c *keyRings) Update(ctx context.Context, keyRing *v1alpha1.KeyRing, opts v1.UpdateOptions) (result *v1alpha1.KeyRing, err error) {
	result = &v1alpha1.KeyRing{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyrings").
...
func (c *keyRings) UpdateStatus(ctx context.Context, keyRing *v1alpha1.KeyRing, opts v1.UpdateOptions) (result *v1alpha1.KeyRing, err error) {
	result = &v1alpha1.KeyRing{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyrings").
...
func (c *keyRings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *keyRings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *keyRings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KeyRing, err error) {
	result = &v1alpha1.KeyRing{}
