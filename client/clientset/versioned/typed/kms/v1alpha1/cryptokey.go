...
// CryptoKeysGetter has a method to return a CryptoKeyInterface.
...
// cryptoKeys implements CryptoKeyInterface
type cryptoKeys struct {
	client rest.Interface
	ns     string
}

// newCryptoKeys returns a CryptoKeys
func newCryptoKeys(c *KmsV1alpha1Client, namespace string) *cryptoKeys {
	return &cryptoKeys{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cryptoKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CryptoKey, err error) {
	result = &v1alpha1.CryptoKey{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cryptokeys").
		Name(name).
...
func (c *cryptoKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CryptoKeyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CryptoKeyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cryptokeys").
...
func (c *cryptoKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cryptoKeys) Create(ctx context.Context, cryptoKey *v1alpha1.CryptoKey, opts v1.CreateOptions) (result *v1alpha1.CryptoKey, err error) {
	result = &v1alpha1.CryptoKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cryptokeys").
...
func (c *cryptoKeys) Update(ctx context.Context, cryptoKey *v1alpha1.CryptoKey, opts v1.UpdateOptions) (result *v1alpha1.CryptoKey, err error) {
	result = &v1alpha1.CryptoKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cryptokeys").
...
func (c *cryptoKeys) UpdateStatus(ctx context.Context, cryptoKey *v1alpha1.CryptoKey, opts v1.UpdateOptions) (result *v1alpha1.CryptoKey, err error) {
	result = &v1alpha1.CryptoKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cryptokeys").
...
func (c *cryptoKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cryptoKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cryptoKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CryptoKey, err error) {
	result = &v1alpha1.CryptoKey{}
