...
// KeyRingIamBindingsGetter has a method to return a KeyRingIamBindingInterface.
...
// keyRingIamBindings implements KeyRingIamBindingInterface
type keyRingIamBindings struct {
	client rest.Interface
	ns     string
}

// newKeyRingIamBindings returns a KeyRingIamBindings
func newKeyRingIamBindings(c *KmsV1alpha1Client, namespace string) *keyRingIamBindings {
	return &keyRingIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *keyRingIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KeyRingIamBinding, err error) {
	result = &v1alpha1.KeyRingIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *keyRingIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KeyRingIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KeyRingIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("keyringiambindings").
...
func (c *keyRingIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *keyRingIamBindings) Create(ctx context.Context, keyRingIamBinding *v1alpha1.KeyRingIamBinding, opts v1.CreateOptions) (result *v1alpha1.KeyRingIamBinding, err error) {
	result = &v1alpha1.KeyRingIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("keyringiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(keyRingIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *keyRingIamBindings) Update(ctx context.Context, keyRingIamBinding *v1alpha1.KeyRingIamBinding, opts v1.UpdateOptions) (result *v1alpha1.KeyRingIamBinding, err error) {
	result = &v1alpha1.KeyRingIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyringiambindings").
		Name(keyRingIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(keyRingIamBinding).
		Do(ctx).
		Into(result)
...
func (c *keyRingIamBindings) UpdateStatus(ctx context.Context, keyRingIamBinding *v1alpha1.KeyRingIamBinding, opts v1.UpdateOptions) (result *v1alpha1.KeyRingIamBinding, err error) {
	result = &v1alpha1.KeyRingIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keyringiambindings").
...
func (c *keyRingIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *keyRingIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *keyRingIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KeyRingIamBinding, err error) {
	result = &v1alpha1.KeyRingIamBinding{}
