...
// CryptoKeyIamBindingsGetter has a method to return a CryptoKeyIamBindingInterface.
...
// cryptoKeyIamBindings implements CryptoKeyIamBindingInterface
type cryptoKeyIamBindings struct {
	client rest.Interface
	ns     string
}

// newCryptoKeyIamBindings returns a CryptoKeyIamBindings
func newCryptoKeyIamBindings(c *KmsV1alpha1Client, namespace string) *cryptoKeyIamBindings {
	return &cryptoKeyIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *cryptoKeyIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CryptoKeyIamBinding, err error) {
	result = &v1alpha1.CryptoKeyIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cryptoKeyIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CryptoKeyIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CryptoKeyIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cryptokeyiambindings").
...
func (c *cryptoKeyIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cryptoKeyIamBindings) Create(ctx context.Context, cryptoKeyIamBinding *v1alpha1.CryptoKeyIamBinding, opts v1.CreateOptions) (result *v1alpha1.CryptoKeyIamBinding, err error) {
	result = &v1alpha1.CryptoKeyIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cryptokeyiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cryptoKeyIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *cryptoKeyIamBindings) Update(ctx context.Context, cryptoKeyIamBinding *v1alpha1.CryptoKeyIamBinding, opts v1.UpdateOptions) (result *v1alpha1.CryptoKeyIamBinding, err error) {
	result = &v1alpha1.CryptoKeyIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cryptokeyiambindings").
		Name(cryptoKeyIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cryptoKeyIamBinding).
		Do(ctx).
		Into(result)
...
func (c *cryptoKeyIamBindings) UpdateStatus(ctx context.Context, cryptoKeyIamBinding *v1alpha1.CryptoKeyIamBinding, opts v1.UpdateOptions) (result *v1alpha1.CryptoKeyIamBinding, err error) {
	result = &v1alpha1.CryptoKeyIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cryptokeyiambindings").
...
func (c *cryptoKeyIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cryptoKeyIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cryptoKeyIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CryptoKeyIamBinding, err error) {
	result = &v1alpha1.CryptoKeyIamBinding{}
