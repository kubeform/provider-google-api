...
var runtimesResource = schema.GroupVersionResource{Group: "notebooks.google.kubeform.com", Version: "v1alpha1", Resource: "runtimes"}

var runtimesKind = schema.GroupVersionKind{Group: "notebooks.google.kubeform.com", Version: "v1alpha1", Kind: "Runtime"}
...
func (c *FakeRuntimes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Runtime, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(runtimesResource, c.ns, name), &v1alpha1.Runtime{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Runtime), err
}
...
func (c *FakeRuntimes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RuntimeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(runtimesResource, runtimesKind, c.ns, opts), &v1alpha1.RuntimeList{})
	...
	list := &v1alpha1.RuntimeList{ListMeta: obj.(*v1alpha1.RuntimeList).ListMeta}
	for _, item := range obj.(*v1alpha1.RuntimeList).Items {
...
func (c *FakeRuntimes) Create(ctx context.Context, runtime *v1alpha1.Runtime, opts v1.CreateOptions) (result *v1alpha1.Runtime, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(runtimesResource, c.ns, runtime), &v1alpha1.Runtime{})
...
func (c *FakeRuntimes) Update(ctx context.Context, runtime *v1alpha1.Runtime, opts v1.UpdateOptions) (result *v1alpha1.Runtime, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(runtimesResource, c.ns, runtime), &v1alpha1.Runtime{})
...
func (c *FakeRuntimes) UpdateStatus(ctx context.Context, runtime *v1alpha1.Runtime, opts v1.UpdateOptions) (*v1alpha1.Runtime, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(runtimesResource, "status", c.ns, runtime), &v1alpha1.Runtime{})
...
func (c *FakeRuntimes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(runtimesResource, c.ns, name), &v1alpha1.Runtime{})
...
func (c *FakeRuntimes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.RuntimeList{})
	return err
}
...
func (c *FakeRuntimes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Runtime, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(runtimesResource, c.ns, name, pt, data, subresources...), &v1alpha1.Runtime{})
