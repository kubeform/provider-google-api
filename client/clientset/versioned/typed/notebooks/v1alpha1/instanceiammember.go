...
// InstanceIamMembersGetter has a method to return a InstanceIamMemberInterface.
...
// instanceIamMembers implements InstanceIamMemberInterface
type instanceIamMembers struct {
	client rest.Interface
	ns     string
}

// newInstanceIamMembers returns a InstanceIamMembers
func newInstanceIamMembers(c *NotebooksV1alpha1Client, namespace string) *instanceIamMembers {
	return &instanceIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *instanceIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InstanceIamMember, err error) {
	result = &v1alpha1.InstanceIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *instanceIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InstanceIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InstanceIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("instanceiammembers").
...
func (c *instanceIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *instanceIamMembers) Create(ctx context.Context, instanceIamMember *v1alpha1.InstanceIamMember, opts v1.CreateOptions) (result *v1alpha1.InstanceIamMember, err error) {
	result = &v1alpha1.InstanceIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instanceiammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(instanceIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *instanceIamMembers) Update(ctx context.Context, instanceIamMember *v1alpha1.InstanceIamMember, opts v1.UpdateOptions) (result *v1alpha1.InstanceIamMember, err error) {
	result = &v1alpha1.InstanceIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instanceiammembers").
		Name(instanceIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(instanceIamMember).
		Do(ctx).
		Into(result)
...
func (c *instanceIamMembers) UpdateStatus(ctx context.Context, instanceIamMember *v1alpha1.InstanceIamMember, opts v1.UpdateOptions) (result *v1alpha1.InstanceIamMember, err error) {
	result = &v1alpha1.InstanceIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instanceiammembers").
...
func (c *instanceIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *instanceIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *instanceIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InstanceIamMember, err error) {
	result = &v1alpha1.InstanceIamMember{}
