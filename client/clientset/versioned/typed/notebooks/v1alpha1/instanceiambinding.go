...
// InstanceIamBindingsGetter has a method to return a InstanceIamBindingInterface.
...
// instanceIamBindings implements InstanceIamBindingInterface
type instanceIamBindings struct {
	client rest.Interface
	ns     string
}

// newInstanceIamBindings returns a InstanceIamBindings
func newInstanceIamBindings(c *NotebooksV1alpha1Client, namespace string) *instanceIamBindings {
	return &instanceIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *instanceIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InstanceIamBinding, err error) {
	result = &v1alpha1.InstanceIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *instanceIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InstanceIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InstanceIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("instanceiambindings").
...
func (c *instanceIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *instanceIamBindings) Create(ctx context.Context, instanceIamBinding *v1alpha1.InstanceIamBinding, opts v1.CreateOptions) (result *v1alpha1.InstanceIamBinding, err error) {
	result = &v1alpha1.InstanceIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instanceiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(instanceIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *instanceIamBindings) Update(ctx context.Context, instanceIamBinding *v1alpha1.InstanceIamBinding, opts v1.UpdateOptions) (result *v1alpha1.InstanceIamBinding, err error) {
	result = &v1alpha1.InstanceIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instanceiambindings").
		Name(instanceIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(instanceIamBinding).
		Do(ctx).
		Into(result)
...
func (c *instanceIamBindings) UpdateStatus(ctx context.Context, instanceIamBinding *v1alpha1.InstanceIamBinding, opts v1.UpdateOptions) (result *v1alpha1.InstanceIamBinding, err error) {
	result = &v1alpha1.InstanceIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instanceiambindings").
...
func (c *instanceIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *instanceIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *instanceIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InstanceIamBinding, err error) {
	result = &v1alpha1.InstanceIamBinding{}
