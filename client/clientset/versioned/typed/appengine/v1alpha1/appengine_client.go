...
type AppengineV1alpha1Interface interface {
	RESTClient() rest.Interface
	ApplicationsGetter
	ApplicationURLDispatchRulesesGetter
	DomainMappingsGetter
	FirewallRulesGetter
	FlexibleAppVersionsGetter
	ServiceNetworkSettingsesGetter
	ServiceSplitTrafficsGetter
	StandardAppVersionsGetter
}
...
func (c *AppengineV1alpha1Client) ApplicationURLDispatchRuleses(namespace string) ApplicationURLDispatchRulesInterface {
	return newApplicationURLDispatchRuleses(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*AppengineV1alpha1Client, error) {
	...
	return &AppengineV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AppengineV1alpha1Client for the given config and
...
func New(c rest.Interface) *AppengineV1alpha1Client {
	return &AppengineV1alpha1Client{c}
}
