...
// DatabaseIamBindingsGetter has a method to return a DatabaseIamBindingInterface.
...
// databaseIamBindings implements DatabaseIamBindingInterface
type databaseIamBindings struct {
	client rest.Interface
	ns     string
}

// newDatabaseIamBindings returns a DatabaseIamBindings
func newDatabaseIamBindings(c *SpannerV1alpha1Client, namespace string) *databaseIamBindings {
	return &databaseIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *databaseIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabaseIamBinding, err error) {
	result = &v1alpha1.DatabaseIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *databaseIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabaseIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DatabaseIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("databaseiambindings").
...
func (c *databaseIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *databaseIamBindings) Create(ctx context.Context, databaseIamBinding *v1alpha1.DatabaseIamBinding, opts v1.CreateOptions) (result *v1alpha1.DatabaseIamBinding, err error) {
	result = &v1alpha1.DatabaseIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("databaseiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databaseIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *databaseIamBindings) Update(ctx context.Context, databaseIamBinding *v1alpha1.DatabaseIamBinding, opts v1.UpdateOptions) (result *v1alpha1.DatabaseIamBinding, err error) {
	result = &v1alpha1.DatabaseIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseiambindings").
		Name(databaseIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databaseIamBinding).
		Do(ctx).
		Into(result)
...
func (c *databaseIamBindings) UpdateStatus(ctx context.Context, databaseIamBinding *v1alpha1.DatabaseIamBinding, opts v1.UpdateOptions) (result *v1alpha1.DatabaseIamBinding, err error) {
	result = &v1alpha1.DatabaseIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseiambindings").
...
func (c *databaseIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *databaseIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *databaseIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatabaseIamBinding, err error) {
	result = &v1alpha1.DatabaseIamBinding{}
