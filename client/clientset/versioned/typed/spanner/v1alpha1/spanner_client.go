...
type SpannerV1alpha1Interface interface {
	RESTClient() rest.Interface
	DatabasesGetter
	DatabaseIamBindingsGetter
	DatabaseIamMembersGetter
	DatabaseIamPoliciesGetter
	InstancesGetter
...
func NewForConfig(c *rest.Config) (*SpannerV1alpha1Client, error) {
	...
	return &SpannerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SpannerV1alpha1Client for the given config and
...
func New(c rest.Interface) *SpannerV1alpha1Client {
	return &SpannerV1alpha1Client{c}
}
