...
// DatabaseIamPoliciesGetter has a method to return a DatabaseIamPolicyInterface.
...
// databaseIamPolicies implements DatabaseIamPolicyInterface
type databaseIamPolicies struct {
	client rest.Interface
	ns     string
}

// newDatabaseIamPolicies returns a DatabaseIamPolicies
func newDatabaseIamPolicies(c *SpannerV1alpha1Client, namespace string) *databaseIamPolicies {
	return &databaseIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *databaseIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabaseIamPolicy, err error) {
	result = &v1alpha1.DatabaseIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *databaseIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabaseIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DatabaseIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("databaseiampolicies").
...
func (c *databaseIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *databaseIamPolicies) Create(ctx context.Context, databaseIamPolicy *v1alpha1.DatabaseIamPolicy, opts v1.CreateOptions) (result *v1alpha1.DatabaseIamPolicy, err error) {
	result = &v1alpha1.DatabaseIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("databaseiampolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databaseIamPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *databaseIamPolicies) Update(ctx context.Context, databaseIamPolicy *v1alpha1.DatabaseIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.DatabaseIamPolicy, err error) {
	result = &v1alpha1.DatabaseIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseiampolicies").
		Name(databaseIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databaseIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *databaseIamPolicies) UpdateStatus(ctx context.Context, databaseIamPolicy *v1alpha1.DatabaseIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.DatabaseIamPolicy, err error) {
	result = &v1alpha1.DatabaseIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseiampolicies").
...
func (c *databaseIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *databaseIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *databaseIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatabaseIamPolicy, err error) {
	result = &v1alpha1.DatabaseIamPolicy{}
