...
// DatabaseIamMembersGetter has a method to return a DatabaseIamMemberInterface.
...
// databaseIamMembers implements DatabaseIamMemberInterface
type databaseIamMembers struct {
	client rest.Interface
	ns     string
}

// newDatabaseIamMembers returns a DatabaseIamMembers
func newDatabaseIamMembers(c *SpannerV1alpha1Client, namespace string) *databaseIamMembers {
	return &databaseIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *databaseIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabaseIamMember, err error) {
	result = &v1alpha1.DatabaseIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *databaseIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabaseIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DatabaseIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("databaseiammembers").
...
func (c *databaseIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *databaseIamMembers) Create(ctx context.Context, databaseIamMember *v1alpha1.DatabaseIamMember, opts v1.CreateOptions) (result *v1alpha1.DatabaseIamMember, err error) {
	result = &v1alpha1.DatabaseIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("databaseiammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databaseIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *databaseIamMembers) Update(ctx context.Context, databaseIamMember *v1alpha1.DatabaseIamMember, opts v1.UpdateOptions) (result *v1alpha1.DatabaseIamMember, err error) {
	result = &v1alpha1.DatabaseIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseiammembers").
		Name(databaseIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databaseIamMember).
		Do(ctx).
		Into(result)
...
func (c *databaseIamMembers) UpdateStatus(ctx context.Context, databaseIamMember *v1alpha1.DatabaseIamMember, opts v1.UpdateOptions) (result *v1alpha1.DatabaseIamMember, err error) {
	result = &v1alpha1.DatabaseIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseiammembers").
...
func (c *databaseIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *databaseIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *databaseIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatabaseIamMember, err error) {
	result = &v1alpha1.DatabaseIamMember{}
