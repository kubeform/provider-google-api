...
func newTasksQueues(c *CloudV1alpha1Client, namespace string) *tasksQueues {
	return &tasksQueues{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tasksQueues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TasksQueue, err error) {
	result = &v1alpha1.TasksQueue{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tasksQueues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TasksQueueList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TasksQueueList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tasksqueues").
...
func (c *tasksQueues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tasksQueues) Create(ctx context.Context, tasksQueue *v1alpha1.TasksQueue, opts v1.CreateOptions) (result *v1alpha1.TasksQueue, err error) {
	result = &v1alpha1.TasksQueue{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tasksqueues").
...
func (c *tasksQueues) Update(ctx context.Context, tasksQueue *v1alpha1.TasksQueue, opts v1.UpdateOptions) (result *v1alpha1.TasksQueue, err error) {
	result = &v1alpha1.TasksQueue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tasksqueues").
...
func (c *tasksQueues) UpdateStatus(ctx context.Context, tasksQueue *v1alpha1.TasksQueue, opts v1.UpdateOptions) (result *v1alpha1.TasksQueue, err error) {
	result = &v1alpha1.TasksQueue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tasksqueues").
...
func (c *tasksQueues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tasksQueues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tasksQueues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TasksQueue, err error) {
	result = &v1alpha1.TasksQueue{}
