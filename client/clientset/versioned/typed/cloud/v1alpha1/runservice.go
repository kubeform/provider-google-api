...
func newRunServices(c *CloudV1alpha1Client, namespace string) *runServices {
	return &runServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *runServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RunService, err error) {
	result = &v1alpha1.RunService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *runServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RunServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RunServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("runservices").
...
func (c *runServices) Create(ctx context.Context, runService *v1alpha1.RunService, opts v1.CreateOptions) (result *v1alpha1.RunService, err error) {
	result = &v1alpha1.RunService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("runservices").
...
func (c *runServices) Update(ctx context.Context, runService *v1alpha1.RunService, opts v1.UpdateOptions) (result *v1alpha1.RunService, err error) {
	result = &v1alpha1.RunService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("runservices").
...
func (c *runServices) UpdateStatus(ctx context.Context, runService *v1alpha1.RunService, opts v1.UpdateOptions) (result *v1alpha1.RunService, err error) {
	result = &v1alpha1.RunService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("runservices").
...
func (c *runServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RunService, err error) {
	result = &v1alpha1.RunService{}
