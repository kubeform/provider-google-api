...
// FakeSchedulerJobs implements SchedulerJobInterface
type FakeSchedulerJobs struct {
	Fake *FakeCloudV1alpha1
	ns   string
}

var schedulerjobsResource = schema.GroupVersionResource{Group: "cloud.google.kubeform.com", Version: "v1alpha1", Resource: "schedulerjobs"}

var schedulerjobsKind = schema.GroupVersionKind{Group: "cloud.google.kubeform.com", Version: "v1alpha1", Kind: "SchedulerJob"}
...
func (c *FakeSchedulerJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SchedulerJob, err error) {
	...
	return obj.(*v1alpha1.SchedulerJob), err
}
...
func (c *FakeSchedulerJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SchedulerJobList, err error) {
	...
	list := &v1alpha1.SchedulerJobList{ListMeta: obj.(*v1alpha1.SchedulerJobList).ListMeta}
	for _, item := range obj.(*v1alpha1.SchedulerJobList).Items {
