...
var tasksqueuesResource = schema.GroupVersionResource{Group: "cloud.google.kubeform.com", Version: "v1alpha1", Resource: "tasksqueues"}

var tasksqueuesKind = schema.GroupVersionKind{Group: "cloud.google.kubeform.com", Version: "v1alpha1", Kind: "TasksQueue"}
...
func (c *FakeTasksQueues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(tasksqueuesResource, c.ns, name), &v1alpha1.TasksQueue{})
