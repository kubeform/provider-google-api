...
import (
	...
	v1alpha1 "kubeform.dev/provider-google-api/apis/workflows/v1alpha1"
...
func newWorkflows(c *WorkflowsV1alpha1Client, namespace string) *workflows {
	return &workflows{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *workflows) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Workflow, err error) {
...
func (c *workflows) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WorkflowList, err error) {
...
func (c *workflows) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *workflows) UpdateStatus(ctx context.Context, workflow *v1alpha1.Workflow, opts v1.UpdateOptions) (result *v1alpha1.Workflow, err error) {
	result = &v1alpha1.Workflow{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workflows").
