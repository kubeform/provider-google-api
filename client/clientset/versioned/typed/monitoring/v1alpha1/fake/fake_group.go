...
var groupsResource = schema.GroupVersionResource{Group: "monitoring.google.kubeform.com", Version: "v1alpha1", Resource: "groups"}

var groupsKind = schema.GroupVersionKind{Group: "monitoring.google.kubeform.com", Version: "v1alpha1", Kind: "Group"}
...
func (c *FakeGroups) UpdateStatus(ctx context.Context, group *v1alpha1.Group, opts v1.UpdateOptions) (*v1alpha1.Group, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(groupsResource, "status", c.ns, group), &v1alpha1.Group{})
...
func (c *FakeGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Group, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(groupsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Group{})
