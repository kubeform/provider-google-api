...
type MonitoringV1alpha1Interface interface {
	...
	AlertPoliciesGetter
	CustomServicesGetter
	DashboardsGetter
	GroupsGetter
	MetricDescriptorsGetter
	NotificationChannelsGetter
	SlosGetter
	UptimeCheckConfigsGetter
}
...
func (c *MonitoringV1alpha1Client) MetricDescriptors(namespace string) MetricDescriptorInterface {
	return newMetricDescriptors(c, namespace)
}
