...
// AlertPoliciesGetter has a method to return a AlertPolicyInterface.
...
// alertPolicies implements AlertPolicyInterface
type alertPolicies struct {
	client rest.Interface
	ns     string
}

// newAlertPolicies returns a AlertPolicies
func newAlertPolicies(c *MonitoringV1alpha1Client, namespace string) *alertPolicies {
...
func (c *alertPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AlertPolicy, err error) {
	result = &v1alpha1.AlertPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *alertPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AlertPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AlertPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alertpolicies").
...
func (c *alertPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *alertPolicies) Create(ctx context.Context, alertPolicy *v1alpha1.AlertPolicy, opts v1.CreateOptions) (result *v1alpha1.AlertPolicy, err error) {
	result = &v1alpha1.AlertPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alertpolicies").
...
func (c *alertPolicies) Update(ctx context.Context, alertPolicy *v1alpha1.AlertPolicy, opts v1.UpdateOptions) (result *v1alpha1.AlertPolicy, err error) {
	result = &v1alpha1.AlertPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alertpolicies").
...
func (c *alertPolicies) UpdateStatus(ctx context.Context, alertPolicy *v1alpha1.AlertPolicy, opts v1.UpdateOptions) (result *v1alpha1.AlertPolicy, err error) {
	result = &v1alpha1.AlertPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alertpolicies").
...
func (c *alertPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *alertPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *alertPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AlertPolicy, err error) {
	result = &v1alpha1.AlertPolicy{}
