...
// UptimeCheckConfigsGetter has a method to return a UptimeCheckConfigInterface.
...
// uptimeCheckConfigs implements UptimeCheckConfigInterface
type uptimeCheckConfigs struct {
	client rest.Interface
	ns     string
}

// newUptimeCheckConfigs returns a UptimeCheckConfigs
func newUptimeCheckConfigs(c *MonitoringV1alpha1Client, namespace string) *uptimeCheckConfigs {
...
func (c *uptimeCheckConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UptimeCheckConfig, err error) {
	result = &v1alpha1.UptimeCheckConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *uptimeCheckConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UptimeCheckConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UptimeCheckConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("uptimecheckconfigs").
...
func (c *uptimeCheckConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *uptimeCheckConfigs) Create(ctx context.Context, uptimeCheckConfig *v1alpha1.UptimeCheckConfig, opts v1.CreateOptions) (result *v1alpha1.UptimeCheckConfig, err error) {
	result = &v1alpha1.UptimeCheckConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("uptimecheckconfigs").
...
func (c *uptimeCheckConfigs) Update(ctx context.Context, uptimeCheckConfig *v1alpha1.UptimeCheckConfig, opts v1.UpdateOptions) (result *v1alpha1.UptimeCheckConfig, err error) {
	result = &v1alpha1.UptimeCheckConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("uptimecheckconfigs").
		Name(uptimeCheckConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(uptimeCheckConfig).
		Do(ctx).
		Into(result)
...
func (c *uptimeCheckConfigs) UpdateStatus(ctx context.Context, uptimeCheckConfig *v1alpha1.UptimeCheckConfig, opts v1.UpdateOptions) (result *v1alpha1.UptimeCheckConfig, err error) {
	result = &v1alpha1.UptimeCheckConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("uptimecheckconfigs").
...
func (c *uptimeCheckConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *uptimeCheckConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *uptimeCheckConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UptimeCheckConfig, err error) {
	result = &v1alpha1.UptimeCheckConfig{}
