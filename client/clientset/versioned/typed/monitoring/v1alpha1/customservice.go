...
// CustomServicesGetter has a method to return a CustomServiceInterface.
...
// customServices implements CustomServiceInterface
type customServices struct {
	client rest.Interface
	ns     string
}

// newCustomServices returns a CustomServices
func newCustomServices(c *MonitoringV1alpha1Client, namespace string) *customServices {
...
func (c *customServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CustomService, err error) {
	result = &v1alpha1.CustomService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *customServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CustomServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CustomServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("customservices").
...
func (c *customServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *customServices) Create(ctx context.Context, customService *v1alpha1.CustomService, opts v1.CreateOptions) (result *v1alpha1.CustomService, err error) {
	result = &v1alpha1.CustomService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("customservices").
...
func (c *customServices) Update(ctx context.Context, customService *v1alpha1.CustomService, opts v1.UpdateOptions) (result *v1alpha1.CustomService, err error) {
	result = &v1alpha1.CustomService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customservices").
...
func (c *customServices) UpdateStatus(ctx context.Context, customService *v1alpha1.CustomService, opts v1.UpdateOptions) (result *v1alpha1.CustomService, err error) {
	result = &v1alpha1.CustomService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customservices").
...
func (c *customServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *customServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *customServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CustomService, err error) {
	result = &v1alpha1.CustomService{}
