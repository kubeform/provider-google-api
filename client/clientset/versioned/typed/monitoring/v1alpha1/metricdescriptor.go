...
// MetricDescriptorsGetter has a method to return a MetricDescriptorInterface.
...
// metricDescriptors implements MetricDescriptorInterface
type metricDescriptors struct {
	client rest.Interface
	ns     string
}

// newMetricDescriptors returns a MetricDescriptors
func newMetricDescriptors(c *MonitoringV1alpha1Client, namespace string) *metricDescriptors {
...
func (c *metricDescriptors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MetricDescriptor, err error) {
	result = &v1alpha1.MetricDescriptor{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *metricDescriptors) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MetricDescriptorList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MetricDescriptorList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("metricdescriptors").
...
func (c *metricDescriptors) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *metricDescriptors) Create(ctx context.Context, metricDescriptor *v1alpha1.MetricDescriptor, opts v1.CreateOptions) (result *v1alpha1.MetricDescriptor, err error) {
	result = &v1alpha1.MetricDescriptor{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("metricdescriptors").
...
func (c *metricDescriptors) Update(ctx context.Context, metricDescriptor *v1alpha1.MetricDescriptor, opts v1.UpdateOptions) (result *v1alpha1.MetricDescriptor, err error) {
	result = &v1alpha1.MetricDescriptor{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("metricdescriptors").
...
func (c *metricDescriptors) UpdateStatus(ctx context.Context, metricDescriptor *v1alpha1.MetricDescriptor, opts v1.UpdateOptions) (result *v1alpha1.MetricDescriptor, err error) {
	result = &v1alpha1.MetricDescriptor{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("metricdescriptors").
...
func (c *metricDescriptors) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *metricDescriptors) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *metricDescriptors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MetricDescriptor, err error) {
	result = &v1alpha1.MetricDescriptor{}
