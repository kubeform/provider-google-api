...
// SlosGetter has a method to return a SloInterface.
...
// slos implements SloInterface
type slos struct {
	client rest.Interface
	ns     string
}

// newSlos returns a Slos
func newSlos(c *MonitoringV1alpha1Client, namespace string) *slos {
	return &slos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *slos) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Slo, err error) {
	result = &v1alpha1.Slo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("slos").
...
func (c *slos) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SloList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SloList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("slos").
...
func (c *slos) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *slos) Create(ctx context.Context, slo *v1alpha1.Slo, opts v1.CreateOptions) (result *v1alpha1.Slo, err error) {
	result = &v1alpha1.Slo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("slos").
...
func (c *slos) Update(ctx context.Context, slo *v1alpha1.Slo, opts v1.UpdateOptions) (result *v1alpha1.Slo, err error) {
	result = &v1alpha1.Slo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("slos").
...
func (c *slos) UpdateStatus(ctx context.Context, slo *v1alpha1.Slo, opts v1.UpdateOptions) (result *v1alpha1.Slo, err error) {
	result = &v1alpha1.Slo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("slos").
...
func (c *slos) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *slos) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *slos) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Slo, err error) {
	result = &v1alpha1.Slo{}
