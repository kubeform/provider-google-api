...
type DeploymentV1alpha1Interface interface {
	...
	ManagerDeploymentsGetter
}

// DeploymentV1alpha1Client is used to interact with features provided by the deployment.google.kubeform.com group.
type DeploymentV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DeploymentV1alpha1Client) ManagerDeployments(namespace string) ManagerDeploymentInterface {
	return newManagerDeployments(c, namespace)
}
