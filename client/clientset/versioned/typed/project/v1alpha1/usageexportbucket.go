...
// UsageExportBucketsGetter has a method to return a UsageExportBucketInterface.
...
// usageExportBuckets implements UsageExportBucketInterface
type usageExportBuckets struct {
	client rest.Interface
	ns     string
}

// newUsageExportBuckets returns a UsageExportBuckets
func newUsageExportBuckets(c *ProjectV1alpha1Client, namespace string) *usageExportBuckets {
	return &usageExportBuckets{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *usageExportBuckets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UsageExportBucket, err error) {
	result = &v1alpha1.UsageExportBucket{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *usageExportBuckets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UsageExportBucketList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UsageExportBucketList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("usageexportbuckets").
...
func (c *usageExportBuckets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *usageExportBuckets) Create(ctx context.Context, usageExportBucket *v1alpha1.UsageExportBucket, opts v1.CreateOptions) (result *v1alpha1.UsageExportBucket, err error) {
	result = &v1alpha1.UsageExportBucket{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("usageexportbuckets").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(usageExportBucket).
		Do(ctx).
		Into(result)
	return
}
...
func (c *usageExportBuckets) Update(ctx context.Context, usageExportBucket *v1alpha1.UsageExportBucket, opts v1.UpdateOptions) (result *v1alpha1.UsageExportBucket, err error) {
	result = &v1alpha1.UsageExportBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usageexportbuckets").
		Name(usageExportBucket.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(usageExportBucket).
		Do(ctx).
		Into(result)
...
func (c *usageExportBuckets) UpdateStatus(ctx context.Context, usageExportBucket *v1alpha1.UsageExportBucket, opts v1.UpdateOptions) (result *v1alpha1.UsageExportBucket, err error) {
	result = &v1alpha1.UsageExportBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usageexportbuckets").
...
func (c *usageExportBuckets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *usageExportBuckets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *usageExportBuckets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UsageExportBucket, err error) {
	result = &v1alpha1.UsageExportBucket{}
