...
func newClusterIamPolicies(c *DataprocV1alpha1Client, namespace string) *clusterIamPolicies {
...
func (c *clusterIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterIamPolicy, err error) {
	result = &v1alpha1.ClusterIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *clusterIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClusterIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusteriampolicies").
...
func (c *clusterIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterIamPolicies) Create(ctx context.Context, clusterIamPolicy *v1alpha1.ClusterIamPolicy, opts v1.CreateOptions) (result *v1alpha1.ClusterIamPolicy, err error) {
	result = &v1alpha1.ClusterIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusteriampolicies").
...
func (c *clusterIamPolicies) Update(ctx context.Context, clusterIamPolicy *v1alpha1.ClusterIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.ClusterIamPolicy, err error) {
	result = &v1alpha1.ClusterIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusteriampolicies").
...
func (c *clusterIamPolicies) UpdateStatus(ctx context.Context, clusterIamPolicy *v1alpha1.ClusterIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.ClusterIamPolicy, err error) {
	result = &v1alpha1.ClusterIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusteriampolicies").
...
func (c *clusterIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterIamPolicy, err error) {
	result = &v1alpha1.ClusterIamPolicy{}
