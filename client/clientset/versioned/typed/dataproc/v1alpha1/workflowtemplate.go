...
func newWorkflowTemplates(c *DataprocV1alpha1Client, namespace string) *workflowTemplates {
...
func (c *workflowTemplates) UpdateStatus(ctx context.Context, workflowTemplate *v1alpha1.WorkflowTemplate, opts v1.UpdateOptions) (result *v1alpha1.WorkflowTemplate, err error) {
	result = &v1alpha1.WorkflowTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workflowtemplates").
