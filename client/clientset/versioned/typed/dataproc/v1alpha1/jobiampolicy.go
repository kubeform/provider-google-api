...
// JobIamPoliciesGetter has a method to return a JobIamPolicyInterface.
...
// jobIamPolicies implements JobIamPolicyInterface
type jobIamPolicies struct {
	client rest.Interface
	ns     string
}

// newJobIamPolicies returns a JobIamPolicies
func newJobIamPolicies(c *DataprocV1alpha1Client, namespace string) *jobIamPolicies {
	return &jobIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *jobIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.JobIamPolicy, err error) {
	result = &v1alpha1.JobIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *jobIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.JobIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.JobIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("jobiampolicies").
...
func (c *jobIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *jobIamPolicies) Create(ctx context.Context, jobIamPolicy *v1alpha1.JobIamPolicy, opts v1.CreateOptions) (result *v1alpha1.JobIamPolicy, err error) {
	result = &v1alpha1.JobIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("jobiampolicies").
...
func (c *jobIamPolicies) Update(ctx context.Context, jobIamPolicy *v1alpha1.JobIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.JobIamPolicy, err error) {
	result = &v1alpha1.JobIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jobiampolicies").
		Name(jobIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(jobIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *jobIamPolicies) UpdateStatus(ctx context.Context, jobIamPolicy *v1alpha1.JobIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.JobIamPolicy, err error) {
	result = &v1alpha1.JobIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jobiampolicies").
...
func (c *jobIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *jobIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *jobIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.JobIamPolicy, err error) {
	result = &v1alpha1.JobIamPolicy{}
