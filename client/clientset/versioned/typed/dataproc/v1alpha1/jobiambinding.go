...
// JobIamBindingsGetter has a method to return a JobIamBindingInterface.
...
// jobIamBindings implements JobIamBindingInterface
type jobIamBindings struct {
	client rest.Interface
	ns     string
}

// newJobIamBindings returns a JobIamBindings
func newJobIamBindings(c *DataprocV1alpha1Client, namespace string) *jobIamBindings {
	return &jobIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *jobIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.JobIamBinding, err error) {
	result = &v1alpha1.JobIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *jobIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.JobIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.JobIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("jobiambindings").
...
func (c *jobIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *jobIamBindings) Create(ctx context.Context, jobIamBinding *v1alpha1.JobIamBinding, opts v1.CreateOptions) (result *v1alpha1.JobIamBinding, err error) {
	result = &v1alpha1.JobIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("jobiambindings").
...
func (c *jobIamBindings) Update(ctx context.Context, jobIamBinding *v1alpha1.JobIamBinding, opts v1.UpdateOptions) (result *v1alpha1.JobIamBinding, err error) {
	result = &v1alpha1.JobIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jobiambindings").
		Name(jobIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(jobIamBinding).
		Do(ctx).
		Into(result)
...
func (c *jobIamBindings) UpdateStatus(ctx context.Context, jobIamBinding *v1alpha1.JobIamBinding, opts v1.UpdateOptions) (result *v1alpha1.JobIamBinding, err error) {
	result = &v1alpha1.JobIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jobiambindings").
...
func (c *jobIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *jobIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *jobIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.JobIamBinding, err error) {
	result = &v1alpha1.JobIamBinding{}
