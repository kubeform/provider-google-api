...
// ClusterIamMembersGetter has a method to return a ClusterIamMemberInterface.
...
// clusterIamMembers implements ClusterIamMemberInterface
type clusterIamMembers struct {
	client rest.Interface
	ns     string
}

// newClusterIamMembers returns a ClusterIamMembers
func newClusterIamMembers(c *DataprocV1alpha1Client, namespace string) *clusterIamMembers {
	return &clusterIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *clusterIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterIamMember, err error) {
	result = &v1alpha1.ClusterIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *clusterIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClusterIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusteriammembers").
...
func (c *clusterIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterIamMembers) Create(ctx context.Context, clusterIamMember *v1alpha1.ClusterIamMember, opts v1.CreateOptions) (result *v1alpha1.ClusterIamMember, err error) {
	result = &v1alpha1.ClusterIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusteriammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *clusterIamMembers) Update(ctx context.Context, clusterIamMember *v1alpha1.ClusterIamMember, opts v1.UpdateOptions) (result *v1alpha1.ClusterIamMember, err error) {
	result = &v1alpha1.ClusterIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusteriammembers").
		Name(clusterIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterIamMember).
		Do(ctx).
		Into(result)
...
func (c *clusterIamMembers) UpdateStatus(ctx context.Context, clusterIamMember *v1alpha1.ClusterIamMember, opts v1.UpdateOptions) (result *v1alpha1.ClusterIamMember, err error) {
	result = &v1alpha1.ClusterIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusteriammembers").
...
func (c *clusterIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterIamMember, err error) {
	result = &v1alpha1.ClusterIamMember{}
