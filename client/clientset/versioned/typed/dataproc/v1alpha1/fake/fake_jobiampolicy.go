...
var jobiampoliciesResource = schema.GroupVersionResource{Group: "dataproc.google.kubeform.com", Version: "v1alpha1", Resource: "jobiampolicies"}

var jobiampoliciesKind = schema.GroupVersionKind{Group: "dataproc.google.kubeform.com", Version: "v1alpha1", Kind: "JobIamPolicy"}
...
func (c *FakeJobIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.JobIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(jobiampoliciesResource, c.ns, name), &v1alpha1.JobIamPolicy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.JobIamPolicy), err
}
...
func (c *FakeJobIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.JobIamPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(jobiampoliciesResource, jobiampoliciesKind, c.ns, opts), &v1alpha1.JobIamPolicyList{})
	...
	list := &v1alpha1.JobIamPolicyList{ListMeta: obj.(*v1alpha1.JobIamPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.JobIamPolicyList).Items {
...
func (c *FakeJobIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(jobiampoliciesResource, c.ns, opts))
...
func (c *FakeJobIamPolicies) Create(ctx context.Context, jobIamPolicy *v1alpha1.JobIamPolicy, opts v1.CreateOptions) (result *v1alpha1.JobIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(jobiampoliciesResource, c.ns, jobIamPolicy), &v1alpha1.JobIamPolicy{})
...
func (c *FakeJobIamPolicies) Update(ctx context.Context, jobIamPolicy *v1alpha1.JobIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.JobIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(jobiampoliciesResource, c.ns, jobIamPolicy), &v1alpha1.JobIamPolicy{})
...
func (c *FakeJobIamPolicies) UpdateStatus(ctx context.Context, jobIamPolicy *v1alpha1.JobIamPolicy, opts v1.UpdateOptions) (*v1alpha1.JobIamPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(jobiampoliciesResource, "status", c.ns, jobIamPolicy), &v1alpha1.JobIamPolicy{})
...
func (c *FakeJobIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(jobiampoliciesResource, c.ns, name), &v1alpha1.JobIamPolicy{})
...
func (c *FakeJobIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(jobiampoliciesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.JobIamPolicyList{})
	return err
}
...
func (c *FakeJobIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.JobIamPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(jobiampoliciesResource, c.ns, name, pt, data, subresources...), &v1alpha1.JobIamPolicy{})
