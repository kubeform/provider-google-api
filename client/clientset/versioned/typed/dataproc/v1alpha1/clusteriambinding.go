...
// ClusterIamBindingsGetter has a method to return a ClusterIamBindingInterface.
...
// clusterIamBindings implements ClusterIamBindingInterface
type clusterIamBindings struct {
	client rest.Interface
	ns     string
}

// newClusterIamBindings returns a ClusterIamBindings
func newClusterIamBindings(c *DataprocV1alpha1Client, namespace string) *clusterIamBindings {
	return &clusterIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *clusterIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterIamBinding, err error) {
	result = &v1alpha1.ClusterIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *clusterIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClusterIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusteriambindings").
...
func (c *clusterIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterIamBindings) Create(ctx context.Context, clusterIamBinding *v1alpha1.ClusterIamBinding, opts v1.CreateOptions) (result *v1alpha1.ClusterIamBinding, err error) {
	result = &v1alpha1.ClusterIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusteriambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *clusterIamBindings) Update(ctx context.Context, clusterIamBinding *v1alpha1.ClusterIamBinding, opts v1.UpdateOptions) (result *v1alpha1.ClusterIamBinding, err error) {
	result = &v1alpha1.ClusterIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusteriambindings").
		Name(clusterIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterIamBinding).
		Do(ctx).
		Into(result)
...
func (c *clusterIamBindings) UpdateStatus(ctx context.Context, clusterIamBinding *v1alpha1.ClusterIamBinding, opts v1.UpdateOptions) (result *v1alpha1.ClusterIamBinding, err error) {
	result = &v1alpha1.ClusterIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusteriambindings").
...
func (c *clusterIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterIamBinding, err error) {
	result = &v1alpha1.ClusterIamBinding{}
