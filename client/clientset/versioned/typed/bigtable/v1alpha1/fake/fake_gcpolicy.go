...
var gcpoliciesResource = schema.GroupVersionResource{Group: "bigtable.google.kubeform.com", Version: "v1alpha1", Resource: "gcpolicies"}

var gcpoliciesKind = schema.GroupVersionKind{Group: "bigtable.google.kubeform.com", Version: "v1alpha1", Kind: "GcPolicy"}
...
func (c *FakeGcPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GcPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(gcpoliciesResource, c.ns, name), &v1alpha1.GcPolicy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GcPolicy), err
}
...
func (c *FakeGcPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GcPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(gcpoliciesResource, gcpoliciesKind, c.ns, opts), &v1alpha1.GcPolicyList{})
	...
	list := &v1alpha1.GcPolicyList{ListMeta: obj.(*v1alpha1.GcPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.GcPolicyList).Items {
...
func (c *FakeGcPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(gcpoliciesResource, c.ns, opts))
...
func (c *FakeGcPolicies) Create(ctx context.Context, gcPolicy *v1alpha1.GcPolicy, opts v1.CreateOptions) (result *v1alpha1.GcPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(gcpoliciesResource, c.ns, gcPolicy), &v1alpha1.GcPolicy{})
...
func (c *FakeGcPolicies) Update(ctx context.Context, gcPolicy *v1alpha1.GcPolicy, opts v1.UpdateOptions) (result *v1alpha1.GcPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(gcpoliciesResource, c.ns, gcPolicy), &v1alpha1.GcPolicy{})
...
func (c *FakeGcPolicies) UpdateStatus(ctx context.Context, gcPolicy *v1alpha1.GcPolicy, opts v1.UpdateOptions) (*v1alpha1.GcPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(gcpoliciesResource, "status", c.ns, gcPolicy), &v1alpha1.GcPolicy{})
...
func (c *FakeGcPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(gcpoliciesResource, c.ns, name), &v1alpha1.GcPolicy{})
...
func (c *FakeGcPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(gcpoliciesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.GcPolicyList{})
	return err
}
...
func (c *FakeGcPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GcPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(gcpoliciesResource, c.ns, name, pt, data, subresources...), &v1alpha1.GcPolicy{})
