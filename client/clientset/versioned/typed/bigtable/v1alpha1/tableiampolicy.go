...
// TableIamPoliciesGetter has a method to return a TableIamPolicyInterface.
...
// tableIamPolicies implements TableIamPolicyInterface
type tableIamPolicies struct {
	client rest.Interface
	ns     string
}

// newTableIamPolicies returns a TableIamPolicies
func newTableIamPolicies(c *BigtableV1alpha1Client, namespace string) *tableIamPolicies {
	return &tableIamPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *tableIamPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TableIamPolicy, err error) {
	result = &v1alpha1.TableIamPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tableIamPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TableIamPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TableIamPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tableiampolicies").
...
func (c *tableIamPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tableIamPolicies) Create(ctx context.Context, tableIamPolicy *v1alpha1.TableIamPolicy, opts v1.CreateOptions) (result *v1alpha1.TableIamPolicy, err error) {
	result = &v1alpha1.TableIamPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tableiampolicies").
...
func (c *tableIamPolicies) Update(ctx context.Context, tableIamPolicy *v1alpha1.TableIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.TableIamPolicy, err error) {
	result = &v1alpha1.TableIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tableiampolicies").
		Name(tableIamPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tableIamPolicy).
		Do(ctx).
		Into(result)
...
func (c *tableIamPolicies) UpdateStatus(ctx context.Context, tableIamPolicy *v1alpha1.TableIamPolicy, opts v1.UpdateOptions) (result *v1alpha1.TableIamPolicy, err error) {
	result = &v1alpha1.TableIamPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tableiampolicies").
...
func (c *tableIamPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tableIamPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tableIamPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TableIamPolicy, err error) {
	result = &v1alpha1.TableIamPolicy{}
