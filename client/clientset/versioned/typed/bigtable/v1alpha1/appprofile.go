...
// AppProfilesGetter has a method to return a AppProfileInterface.
...
// appProfiles implements AppProfileInterface
type appProfiles struct {
	client rest.Interface
	ns     string
}

// newAppProfiles returns a AppProfiles
func newAppProfiles(c *BigtableV1alpha1Client, namespace string) *appProfiles {
	return &appProfiles{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *appProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppProfile, err error) {
	result = &v1alpha1.AppProfile{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *appProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppProfileList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AppProfileList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("appprofiles").
...
func (c *appProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *appProfiles) Create(ctx context.Context, appProfile *v1alpha1.AppProfile, opts v1.CreateOptions) (result *v1alpha1.AppProfile, err error) {
	result = &v1alpha1.AppProfile{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("appprofiles").
...
func (c *appProfiles) Update(ctx context.Context, appProfile *v1alpha1.AppProfile, opts v1.UpdateOptions) (result *v1alpha1.AppProfile, err error) {
	result = &v1alpha1.AppProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appprofiles").
...
func (c *appProfiles) UpdateStatus(ctx context.Context, appProfile *v1alpha1.AppProfile, opts v1.UpdateOptions) (result *v1alpha1.AppProfile, err error) {
	result = &v1alpha1.AppProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appprofiles").
...
func (c *appProfiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *appProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *appProfiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppProfile, err error) {
	result = &v1alpha1.AppProfile{}
