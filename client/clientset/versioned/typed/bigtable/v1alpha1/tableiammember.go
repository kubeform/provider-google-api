...
// TableIamMembersGetter has a method to return a TableIamMemberInterface.
...
// tableIamMembers implements TableIamMemberInterface
type tableIamMembers struct {
	client rest.Interface
	ns     string
}

// newTableIamMembers returns a TableIamMembers
func newTableIamMembers(c *BigtableV1alpha1Client, namespace string) *tableIamMembers {
	return &tableIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *tableIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TableIamMember, err error) {
	result = &v1alpha1.TableIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tableIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TableIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TableIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tableiammembers").
...
func (c *tableIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tableIamMembers) Create(ctx context.Context, tableIamMember *v1alpha1.TableIamMember, opts v1.CreateOptions) (result *v1alpha1.TableIamMember, err error) {
	result = &v1alpha1.TableIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tableiammembers").
...
func (c *tableIamMembers) Update(ctx context.Context, tableIamMember *v1alpha1.TableIamMember, opts v1.UpdateOptions) (result *v1alpha1.TableIamMember, err error) {
	result = &v1alpha1.TableIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tableiammembers").
		Name(tableIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(tableIamMember).
		Do(ctx).
		Into(result)
...
func (c *tableIamMembers) UpdateStatus(ctx context.Context, tableIamMember *v1alpha1.TableIamMember, opts v1.UpdateOptions) (result *v1alpha1.TableIamMember, err error) {
	result = &v1alpha1.TableIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tableiammembers").
...
func (c *tableIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tableIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tableIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TableIamMember, err error) {
	result = &v1alpha1.TableIamMember{}
