...
// IamCustomRolesGetter has a method to return a IamCustomRoleInterface.
...
// iamCustomRoles implements IamCustomRoleInterface
type iamCustomRoles struct {
	client rest.Interface
	ns     string
}

// newIamCustomRoles returns a IamCustomRoles
func newIamCustomRoles(c *OrganizationV1alpha1Client, namespace string) *iamCustomRoles {
	return &iamCustomRoles{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *iamCustomRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamCustomRole, err error) {
	result = &v1alpha1.IamCustomRole{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *iamCustomRoles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamCustomRoleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IamCustomRoleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamcustomroles").
...
func (c *iamCustomRoles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamCustomRoles) Create(ctx context.Context, iamCustomRole *v1alpha1.IamCustomRole, opts v1.CreateOptions) (result *v1alpha1.IamCustomRole, err error) {
	result = &v1alpha1.IamCustomRole{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamcustomroles").
...
func (c *iamCustomRoles) Update(ctx context.Context, iamCustomRole *v1alpha1.IamCustomRole, opts v1.UpdateOptions) (result *v1alpha1.IamCustomRole, err error) {
	result = &v1alpha1.IamCustomRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamcustomroles").
		Name(iamCustomRole.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iamCustomRole).
		Do(ctx).
		Into(result)
...
func (c *iamCustomRoles) UpdateStatus(ctx context.Context, iamCustomRole *v1alpha1.IamCustomRole, opts v1.UpdateOptions) (result *v1alpha1.IamCustomRole, err error) {
	result = &v1alpha1.IamCustomRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamcustomroles").
...
func (c *iamCustomRoles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamCustomRoles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamCustomRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamCustomRole, err error) {
	result = &v1alpha1.IamCustomRole{}
