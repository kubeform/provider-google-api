...
type OrganizationV1alpha1Interface interface {
	RESTClient() rest.Interface
	AccessApprovalSettingsesGetter
...
func (c *OrganizationV1alpha1Client) AccessApprovalSettingses(namespace string) AccessApprovalSettingsInterface {
	return newAccessApprovalSettingses(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*OrganizationV1alpha1Client, error) {
	...
	return &OrganizationV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new OrganizationV1alpha1Client for the given config and
...
func New(c rest.Interface) *OrganizationV1alpha1Client {
	return &OrganizationV1alpha1Client{c}
}
