...
func newIamAuditConfigs(c *OrganizationV1alpha1Client, namespace string) *iamAuditConfigs {
...
func (c *iamAuditConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamAuditConfig, err error) {
	result = &v1alpha1.IamAuditConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *iamAuditConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamAuditConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IamAuditConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamauditconfigs").
...
func (c *iamAuditConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iamAuditConfigs) Create(ctx context.Context, iamAuditConfig *v1alpha1.IamAuditConfig, opts v1.CreateOptions) (result *v1alpha1.IamAuditConfig, err error) {
	result = &v1alpha1.IamAuditConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamauditconfigs").
...
func (c *iamAuditConfigs) Update(ctx context.Context, iamAuditConfig *v1alpha1.IamAuditConfig, opts v1.UpdateOptions) (result *v1alpha1.IamAuditConfig, err error) {
	result = &v1alpha1.IamAuditConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamauditconfigs").
		Name(iamAuditConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iamAuditConfig).
		Do(ctx).
		Into(result)
...
func (c *iamAuditConfigs) UpdateStatus(ctx context.Context, iamAuditConfig *v1alpha1.IamAuditConfig, opts v1.UpdateOptions) (result *v1alpha1.IamAuditConfig, err error) {
	result = &v1alpha1.IamAuditConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamauditconfigs").
...
func (c *iamAuditConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iamAuditConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iamAuditConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamAuditConfig, err error) {
	result = &v1alpha1.IamAuditConfig{}
