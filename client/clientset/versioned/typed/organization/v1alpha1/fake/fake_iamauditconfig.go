...
var iamauditconfigsResource = schema.GroupVersionResource{Group: "organization.google.kubeform.com", Version: "v1alpha1", Resource: "iamauditconfigs"}

var iamauditconfigsKind = schema.GroupVersionKind{Group: "organization.google.kubeform.com", Version: "v1alpha1", Kind: "IamAuditConfig"}
...
func (c *FakeIamAuditConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IamAuditConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(iamauditconfigsResource, c.ns, name), &v1alpha1.IamAuditConfig{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IamAuditConfig), err
}

// List takes label and field selectors, and returns the list of IamAuditConfigs that match those selectors.
func (c *FakeIamAuditConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IamAuditConfigList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(iamauditconfigsResource, iamauditconfigsKind, c.ns, opts), &v1alpha1.IamAuditConfigList{})
	...
	list := &v1alpha1.IamAuditConfigList{ListMeta: obj.(*v1alpha1.IamAuditConfigList).ListMeta}
	for _, item := range obj.(*v1alpha1.IamAuditConfigList).Items {
...
func (c *FakeIamAuditConfigs) Create(ctx context.Context, iamAuditConfig *v1alpha1.IamAuditConfig, opts v1.CreateOptions) (result *v1alpha1.IamAuditConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(iamauditconfigsResource, c.ns, iamAuditConfig), &v1alpha1.IamAuditConfig{})
...
func (c *FakeIamAuditConfigs) Update(ctx context.Context, iamAuditConfig *v1alpha1.IamAuditConfig, opts v1.UpdateOptions) (result *v1alpha1.IamAuditConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(iamauditconfigsResource, c.ns, iamAuditConfig), &v1alpha1.IamAuditConfig{})
...
func (c *FakeIamAuditConfigs) UpdateStatus(ctx context.Context, iamAuditConfig *v1alpha1.IamAuditConfig, opts v1.UpdateOptions) (*v1alpha1.IamAuditConfig, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(iamauditconfigsResource, "status", c.ns, iamAuditConfig), &v1alpha1.IamAuditConfig{})
...
func (c *FakeIamAuditConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(iamauditconfigsResource, c.ns, name), &v1alpha1.IamAuditConfig{})
...
func (c *FakeIamAuditConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.IamAuditConfigList{})
	return err
}
...
func (c *FakeIamAuditConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IamAuditConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(iamauditconfigsResource, c.ns, name, pt, data, subresources...), &v1alpha1.IamAuditConfig{})
