...
type SecretV1alpha1Interface interface {
	RESTClient() rest.Interface
	ManagerSecretsGetter
	ManagerSecretIamBindingsGetter
	ManagerSecretIamMembersGetter
	ManagerSecretIamPoliciesGetter
	ManagerSecretVersionsGetter
}
...
func NewForConfig(c *rest.Config) (*SecretV1alpha1Client, error) {
	...
	return &SecretV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SecretV1alpha1Client for the given config and
...
func New(c rest.Interface) *SecretV1alpha1Client {
	return &SecretV1alpha1Client{c}
}
