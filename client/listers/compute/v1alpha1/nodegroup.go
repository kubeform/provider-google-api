...
// List lists all NodeGroups in the indexer for a given namespace.
func (s nodeGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.NodeGroup, err error) {
...
// Get retrieves the NodeGroup from the indexer for a given namespace and name.
func (s nodeGroupNamespaceLister) Get(name string) (*v1alpha1.NodeGroup, error) {
