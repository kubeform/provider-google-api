...
// List lists all VpnTunnels in the indexer.
func (s *vpnTunnelLister) List(selector labels.Selector) (ret []*v1alpha1.VpnTunnel, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.VpnTunnel))
	})
	return ret, err
}
...
// List lists all VpnTunnels in the indexer for a given namespace.
func (s vpnTunnelNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.VpnTunnel, err error) {
...
// Get retrieves the VpnTunnel from the indexer for a given namespace and name.
func (s vpnTunnelNamespaceLister) Get(name string) (*v1alpha1.VpnTunnel, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("vpntunnel"), name)
	}
	return obj.(*v1alpha1.VpnTunnel), nil
}
